...
class Service : public ServiceBase {
 public:
   ...
   */
  Service(const std::string&     node_name,
 ...
 private:
  ...
  std::function<void(const std::shared_ptr<Request>&, const transport::MessageInfo&)>
                                                    request_callback_;
...
bool Service<Request, Response>::Init() {
  ...
  request_callback_ = std::bind(&Service<Request, Response>::HandleRequest, this,
