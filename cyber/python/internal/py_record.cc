...
PyObject* cyber_new_PyRecordReader(PyObject* self, PyObject* args) {
  ...
  Py_ssize_t len      = 0;
  if (!PyArg_ParseTuple(args, const_cast<char*>("s#:new_PyRecordReader"), &filepath, &len)) {
  ...
  return PyCapsule_New(reader, "apollo_cyber_record_pyrecordfilereader", nullptr);
}

PyObject* cyber_delete_PyRecordReader(PyObject* self, PyObject* args) {
  PyObject* pyobj_rec_reader = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("O:delete_PyRecordReader"), &pyobj_rec_reader)) {
    Py_INCREF(Py_None);
    return Py_None;
  }

  auto* reader = reinterpret_cast<PyRecordReader*>(
      PyCapsule_GetPointer(pyobj_rec_reader, "apollo_cyber_record_pyrecordfilereader"));
  if (nullptr == reader) {
...
PyObject* cyber_PyRecordReader_ReadMessage(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, const_cast<char*>("OKK:PyRecordReader_ReadMessage"), &pyobj_reader,
                        &begin_time, &end_time)) {
    return nullptr;
  }

  auto* reader = reinterpret_cast<PyRecordReader*>(
      PyCapsule_GetPointer(pyobj_reader, "apollo_cyber_record_pyrecordfilereader"));
  if (nullptr == reader) {
...
PyObject* cyber_PyRecordReader_GetMessageNumber(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, const_cast<char*>("Os:PyRecordReader_GetMessageNumber"),
...
PyObject* cyber_PyRecordReader_GetMessageType(PyObject* self, PyObject* args) {
  PyObject* pyobj_reader = nullptr;
  char*     channel_name = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("Os:cyber_PyRecordReader_GetMessageType"),
                        &pyobj_reader, &channel_name)) {
...
PyObject* cyber_PyRecordReader_GetProtoDesc(PyObject* self, PyObject* args) {
  PyObject* pyobj_reader = nullptr;
  char*     channel_name = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("Os:PyRecordReader_GetProtoDesc"), &pyobj_reader,
                        &channel_name)) {
...
PyObject* cyber_PyRecordReader_GetHeaderString(PyObject* self, PyObject* args) {
  PyObject* pyobj_reader = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("O:cyber_PyRecordReader_GetHeaderString"),
                        &pyobj_reader)) {
    return PYOBJECT_NULL_STRING;
  }
...
PyObject* cyber_PyRecordReader_Reset(PyObject* self, PyObject* args) {
  PyObject* pyobj_reader = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("O:cyber_PyRecordReader_Reset"), &pyobj_reader)) {
...
PyObject* cyber_PyRecordReader_GetChannelList(PyObject* self, PyObject* args) {
  PyObject* pyobj_reader = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("O:cyber_PyRecordReader_GetChannelList"),
                        &pyobj_reader)) {
...
PyObject* cyber_new_PyRecordWriter(PyObject* self, PyObject* args) {
  ...
  return PyCapsule_New(writer, "apollo_cyber_record_pyrecordfilewriter", nullptr);
}

PyObject* cyber_delete_PyRecordWriter(PyObject* self, PyObject* args) {
  PyObject* pyobj_rec_writer = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("O:delete_PyRecordWriter"), &pyobj_rec_writer)) {
    Py_INCREF(Py_None);
    return Py_None;
  }

  auto* writer = reinterpret_cast<PyRecordWriter*>(
      PyCapsule_GetPointer(pyobj_rec_writer, "apollo_cyber_record_pyrecordfilewriter"));
  if (nullptr == writer) {
...
PyObject* cyber_PyRecordWriter_Open(PyObject* self, PyObject* args) {
  ...
  char*      path             = nullptr;
  Py_ssize_t len              = 0;
  if (!PyArg_ParseTuple(args, const_cast<char*>("Os#:cyber_PyRecordWriter_Open"), &pyobj_rec_writer,
                        &path, &len)) {
    AERROR << "cyber_PyRecordWriter_Open:PyArg_ParseTuple failed!";
    Py_RETURN_FALSE;
  }

  PyRecordWriter* writer =
      PyObjectToPtr<PyRecordWriter*>(pyobj_rec_writer, "apollo_cyber_record_pyrecordfilewriter");
  ...
  if (!writer->Open(path_str)) { Py_RETURN_FALSE; }
  Py_RETURN_TRUE;
}
...
PyObject* cyber_PyRecordWriter_WriteChannel(PyObject* self, PyObject* args) {
  ...
  Py_ssize_t len              = 0;
  if (!PyArg_ParseTuple(args, const_cast<char*>("Osss#:cyber_PyRecordWriter_WriteChannel"),
  ...
  if (!writer->WriteChannel(channel, type, proto_desc_str)) { Py_RETURN_FALSE; }
  Py_RETURN_TRUE;
}
...
PyObject* cyber_PyRecordWriter_WriteMessage(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, const_cast<char*>("Oss#Ks#:cyber_PyRecordWriter_WriteMessage"),
                        &pyobj_rec_writer, &channel_name, &rawmessage, &len, &time, &proto_desc,
                        &len_desc)) {
...
PyObject* cyber_PyRecordWriter_SetSizeOfFileSegmentation(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args,
                        const_cast<char*>("OK:cyber_PyRecordWriter_SetSizeOfFileSegmentation"),
                        &pyobj_rec_writer, &size_kilobytes)) {
    AERROR << "cyber_PyRecordWriter_SetSizeOfFileSegmentation parsetuple failed!";
    Py_RETURN_FALSE;
  }
  ...
  if (nullptr == writer) {
    AERROR << "cyber_PyRecordWriter_SetSizeOfFileSegmentation:writer ptr is null!";
    Py_RETURN_FALSE;
  }
...
PyObject* cyber_PyRecordWriter_SetIntervalOfFileSegmentation(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args,
                        const_cast<char*>("OK:cyber_PyRecordWriter_SetIntervalOfFileSegmentation"),
...
PyObject* cyber_PyRecordWriter_GetMessageNumber(PyObject* self, PyObject* args) {
  PyObject* pyobj_rec_writer = nullptr;
  char*     channel_name     = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("Os:PyRecordWriter_GetMessageNumber"),
...
PyObject* cyber_PyRecordWriter_GetMessageType(PyObject* self, PyObject* args) {
  PyObject* pyobj_rec_writer = nullptr;
  char*     channel_name     = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("Os:PyRecordWriter_GetMessageType"),
                        &pyobj_rec_writer, &channel_name)) {
...
PyObject* cyber_PyRecordWriter_GetProtoDesc(PyObject* self, PyObject* args) {
  PyObject* pyobj_rec_writer = nullptr;
  char*     channel_name     = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("Os:PyRecordWriter_GetProtoDesc"),
                        &pyobj_rec_writer, &channel_name)) {
...
static PyMethodDef _cyber_record_methods[] = {
    ...
    {"PyRecordReader_ReadMessage", cyber_PyRecordReader_ReadMessage, METH_VARARGS, ""},
    {"PyRecordReader_GetMessageNumber", cyber_PyRecordReader_GetMessageNumber, METH_VARARGS, ""},
    {"PyRecordReader_GetMessageType", cyber_PyRecordReader_GetMessageType, METH_VARARGS, ""},
    {"PyRecordReader_GetProtoDesc", cyber_PyRecordReader_GetProtoDesc, METH_VARARGS, ""},
    {"PyRecordReader_GetHeaderString", cyber_PyRecordReader_GetHeaderString, METH_VARARGS, ""},
    {"PyRecordReader_Reset", cyber_PyRecordReader_Reset, METH_VARARGS, ""},
    {"PyRecordReader_GetChannelList", cyber_PyRecordReader_GetChannelList, METH_VARARGS, ""},
    ...
    {"PyRecordWriter_SetSizeOfFileSegmentation", cyber_PyRecordWriter_SetSizeOfFileSegmentation,
     METH_VARARGS, ""},
    {"PyRecordWriter_SetIntervalOfFileSegmentation",
     cyber_PyRecordWriter_SetIntervalOfFileSegmentation, METH_VARARGS, ""},
    {"PyRecordWriter_GetMessageNumber", cyber_PyRecordWriter_GetMessageNumber, METH_VARARGS, ""},
    {"PyRecordWriter_GetMessageType", cyber_PyRecordWriter_GetMessageType, METH_VARARGS, ""},
    {"PyRecordWriter_GetProtoDesc", cyber_PyRecordWriter_GetProtoDesc, METH_VARARGS, ""},
