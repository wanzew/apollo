...
static PyObject* cyber_py_init(PyObject* self, PyObject* args) {
  char*      data = nullptr;
  Py_ssize_t len  = 0;
  if (!PyArg_ParseTuple(args, const_cast<char*>("s#:cyber_py_init"), &data, &len)) {
...
PyObject* cyber_new_PyWriter(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, const_cast<char*>("ssIO:new_PyWriter"), &channel_name, &data_type,
                        &qos_depth, &node_pyobj)) {
    Py_INCREF(Py_None);
    return Py_None;
  }

  Node* node = reinterpret_cast<Node*>(PyCapsule_GetPointer(node_pyobj, "apollo_cyber_pynode"));
  if (nullptr == node) {
    AERROR << "node is null";
    Py_INCREF(Py_None);
    return Py_None;
  ...
  PyWriter* writer = new PyWriter((std::string const&)*channel_name, (std::string const&)*data_type,
                                  qos_depth, node);
  PyObject* pyobj_writer = PyCapsule_New(writer, "apollo_cyber_pywriter", nullptr);
  return pyobj_writer;
}

PyObject* cyber_delete_PyWriter(PyObject* self, PyObject* args) {
  PyObject* writer_py = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("O:delete_PyWriter"), &writer_py)) {
    Py_INCREF(Py_None);
    return Py_None;
  }

  PyWriter* writer =
      reinterpret_cast<PyWriter*>(PyCapsule_GetPointer(writer_py, "apollo_cyber_pywriter"));
  delete writer;
  Py_INCREF(Py_None);
  return Py_None;
}
...
PyObject* cyber_PyWriter_write(PyObject* self, PyObject* args) {
  ...
  char*      data         = nullptr;
  Py_ssize_t len          = 0;
  if (!PyArg_ParseTuple(args, const_cast<char*>("Os#:cyber_PyWriter_write"), &pyobj_writer, &data,
                        &len)) {
    AERROR << "cyber_PyWriter_write:cyber_PyWriter_write failed!";
    return PyInt_FromLong(1);
  }

  PyWriter* writer = PyObjectToPtr<PyWriter*>(pyobj_writer, "apollo_cyber_pywriter");
...
PyObject* cyber_new_PyReader(PyObject* self, PyObject* args) {
  ...
  char*     data_type    = nullptr;
  PyObject* node_pyobj   = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("ssO:new_PyReader"), &channel_name, &data_type,
                        &node_pyobj)) {
    Py_INCREF(Py_None);
    return Py_None;
  }
  ...
  PyReader* reader =
      new PyReader((std::string const&)*channel_name, (std::string const&)*data_type, node);
...
PyObject* cyber_delete_PyReader(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, const_cast<char*>("O:delete_PyReader"), &reader_py)) {
    Py_INCREF(Py_None);
    return Py_None;
  }

  PyReader* reader =
      reinterpret_cast<PyReader*>(PyCapsule_GetPointer(reader_py, "apollo_cyber_pyreader"));
  delete reader;
  Py_INCREF(Py_None);
  return Py_None;
}
...
PyObject* cyber_PyReader_read(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, const_cast<char*>("OO:cyber_PyReader_read"), &pyobj_reader,
                        &pyobj_iswait)) {
...
PyObject* cyber_PyReader_register_func(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, const_cast<char*>("OO:PyReader_register_func"), &pyobj_reader,
                        &pyobj_regist_fun)) {
    Py_INCREF(Py_None);
    return Py_None;
  }
...
PyObject* cyber_new_PyClient(PyObject* self, PyObject* args) {
  ...
  char*     data_type    = nullptr;
  PyObject* node_pyobj   = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("ssO:new_PyClient"), &channel_name, &data_type,
                        &node_pyobj)) {
    Py_INCREF(Py_None);
    return Py_None;
  }
  ...
  PyClient* client =
      new PyClient((std::string const&)*channel_name, (std::string const&)*data_type, node);
  PyObject* pyobj_client = PyCapsule_New(client, "apollo_cyber_pyclient", nullptr);
  return pyobj_client;
}

PyObject* cyber_delete_PyClient(PyObject* self, PyObject* args) {
  PyObject* client_py = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("O:delete_PyClient"), &client_py)) {
    Py_INCREF(Py_None);
    return Py_None;
  }

  PyClient* client =
      reinterpret_cast<PyClient*>(PyCapsule_GetPointer(client_py, "apollo_cyber_pyclient"));
  delete client;
  Py_INCREF(Py_None);
  return Py_None;
}
...
PyObject* cyber_PyClient_send_request(PyObject* self, PyObject* args) {
  ...
  char*      data         = nullptr;
  Py_ssize_t len          = 0;
  if (!PyArg_ParseTuple(args, const_cast<char*>("Os#:PyClient_send_request"), &pyobj_client, &data,
                        &len)) {
    AERROR << "cyber_PyClient_send_request:PyArg_ParseTuple failed!";
    return PYOBJECT_NULL_STRING;
  }

  PyClient* client = PyObjectToPtr<PyClient*>(pyobj_client, "apollo_cyber_pyclient");
  ...
  const std::string response_str = client->send_request((std::string const&)data_str);
...
PyObject* cyber_new_PyService(PyObject* self, PyObject* args) {
  ...
  char*     data_type    = nullptr;
  PyObject* node_pyobj   = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("ssO:new_PyService"), &channel_name, &data_type,
                        &node_pyobj)) {
    Py_INCREF(Py_None);
    return Py_None;
  }
  ...
  PyService* service =
      new PyService((std::string const&)*channel_name, (std::string const&)*data_type, node);
...
PyObject* cyber_delete_PyService(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, const_cast<char*>("O:delete_PyService"), &pyobj_service)) {
    Py_INCREF(Py_None);
    return Py_None;
  }

  PyService* service =
      reinterpret_cast<PyService*>(PyCapsule_GetPointer(pyobj_service, "apollo_cyber_pyservice"));
  delete service;
  Py_INCREF(Py_None);
  return Py_None;
}
...
PyObject* cyber_PyService_register_func(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, const_cast<char*>("OO:PyService_register_func"), &pyobj_service,
                        &pyobj_regist_fun)) {
    Py_INCREF(Py_None);
    return Py_None;
  }

  PyService* service = PyObjectToPtr<PyService*>(pyobj_service, "apollo_cyber_pyservice");
  callback_fun       = (int (*)(const char* i))PyInt_AsLong(pyobj_regist_fun);
  if (service) {
...
PyObject* cyber_PyService_read(PyObject* self, PyObject* args) {
  PyObject* pyobj_service = nullptr;
  if (!PyArg_ParseTuple(args, const_cast<char*>("O:cyber_PyService_read"), &pyobj_service)) {
...
PyObject* cyber_PyService_write(PyObject* self, PyObject* args) {
  ...
  char*      data          = nullptr;
  Py_ssize_t len           = 0;
  if (!PyArg_ParseTuple(args, const_cast<char*>("Os#:cyber_PyService_write"), &pyobj_service, &data,
                        &len)) {
...
PyObject* cyber_delete_PyNode(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, const_cast<char*>("O:delete_PyNode"), &pyobj_node)) {
    Py_INCREF(Py_None);
    return Py_None;
  }

  PyNode* node = reinterpret_cast<PyNode*>(PyCapsule_GetPointer(pyobj_node, "apollo_cyber_pynode"));
  delete node;
  Py_INCREF(Py_None);
  return Py_None;
}
...
PyObject* cyber_PyNode_create_writer(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, const_cast<char*>("OssI:PyNode_create_writer"), &pyobj_node,
                        &channel_name, &type_name, &qos_depth)) {
  ...
  PyWriter* writer = reinterpret_cast<PyWriter*>((node->create_writer(
      (std::string const&)channel_name, (std::string const&)type_name, qos_depth)));
...
PyObject* cyber_PyNode_create_reader(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, const_cast<char*>("Oss:PyNode_create_reader"), &pyobj_node,
  ...
  PyReader* reader = reinterpret_cast<PyReader*>(
      (node->create_reader((std::string const&)channel_name, (std::string const&)type_name)));
...
PyObject* cyber_PyNode_create_client(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, const_cast<char*>("Oss:PyNode_create_client"), &pyobj_node,
                        &channel_name, &type_name)) {
  ...
  PyClient* client = reinterpret_cast<PyClient*>(
      (node->create_client((std::string const&)channel_name, (std::string const&)type_name)));
  PyObject* pyobj_client = PyCapsule_New(client, "apollo_cyber_pyclient", nullptr);
...
PyObject* cyber_PyNode_create_service(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, const_cast<char*>("Oss:cyber_PyNode_create_service"), &pyobj_node,
                        &channel_name, &type_name)) {
  ...
  PyService* service = reinterpret_cast<PyService*>(
      (node->create_service((std::string const&)channel_name, (std::string const&)type_name)));
  PyObject* pyobj_service = PyCapsule_New(service, "apollo_cyber_pyservice", nullptr);
  return pyobj_service;
}
...
PyObject* cyber_PyNode_shutdown(PyObject* self, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, const_cast<char*>("O:PyNode_shutdown"), &pyobj_node)) {
...
PyObject* cyber_PyNode_register_message(PyObject* self, PyObject* args) {
  ...
  char*     desc       = nullptr;
  int       len        = 0;
  if (!PyArg_ParseTuple(args, const_cast<char*>("Os#:cyber_PyNode_register_message"), &pyobj_node,
                        &desc, &len)) {
...
PyObject* cyber_PyChannelUtils_get_msg_type(PyObject* self, PyObject* args) {
  ...
  const std::string msg_type = PyChannelUtils::get_msgtype_by_channelname(channel, sleep_s);
  return C_STR_TO_PY_BYTES(msg_type);
}

PyObject* cyber_PyChannelUtils_get_debugstring_by_msgtype_rawmsgdata(PyObject* self,
                                                                     PyObject* args) {
  char*      msgtype = nullptr;
  char*      rawdata = nullptr;
  Py_ssize_t len     = 0;
  if (!PyArg_ParseTuple(
          args, const_cast<char*>("ss#:cyber_PyChannelUtils_get_debugstring_by_msgtype_rawmsgdata"),
          &msgtype, &rawdata, &len)) {
    AERROR << "cyber_PyChannelUtils_get_debugstring_by_msgtype_rawmsgdata failed!";
    return PYOBJECT_NULL_STRING;
  }
...
static PyObject* cyber_PyChannelUtils_get_active_channels(PyObject* self, PyObject* args) {
  unsigned char sleep_s = 0;
  if (!PyArg_ParseTuple(args, const_cast<char*>("B:cyber_PyChannelUtils_get_active_channels"),
                        &sleep_s)) {
  ...
  std::vector<std::string> channel_list = PyChannelUtils::get_active_channels(sleep_s);
...
// }
static PyObject* cyber_PyChannelUtils_get_channels_info(PyObject* self, PyObject* args) {
...
PyObject* cyber_PyNodeUtils_get_active_nodes(PyObject* self, PyObject* args) {
  ...
  std::vector<std::string> nodes_name = apollo::cyber::PyNodeUtils::get_active_nodes(sleep_s);
...
PyObject* cyber_PyNodeUtils_get_node_attr(PyObject* self, PyObject* args) {
  ...
  Py_ssize_t    len       = 0;
  unsigned char sleep_s   = 0;
  if (!PyArg_ParseTuple(args, const_cast<char*>("s#B:cyber_PyNodeUtils_get_node_attr"), &node_name,
                        &len, &sleep_s)) {
  ...
  const std::string node_attr = apollo::cyber::PyNodeUtils::get_node_attr(name, sleep_s);
...
PyObject* cyber_PyNodeUtils_get_readersofnode(PyObject* self, PyObject* args) {
  ...
  Py_ssize_t    len       = 0;
  unsigned char sleep_s   = 0;
  if (!PyArg_ParseTuple(args, const_cast<char*>("s#B:cyber_PyNodeUtils_get_readersofnode"),
...
PyObject* cyber_PyNodeUtils_get_writersofnode(PyObject* self, PyObject* args) {
  ...
  Py_ssize_t    len       = 0;
  unsigned char sleep_s   = 0;
  if (!PyArg_ParseTuple(args, const_cast<char*>("s#B:cyber_PyNodeUtils_get_writersofnode"),
                        &node_name, &len, &sleep_s)) {
...
PyObject* cyber_PyServiceUtils_get_active_services(PyObject* self, PyObject* args) {
  unsigned char sleep_s = 0;
  if (!PyArg_ParseTuple(args, const_cast<char*>("B:cyber_PyServiceUtils_get_active_services"),
                        &sleep_s)) {
  ...
  std::vector<std::string> services_name = PyServiceUtils::get_active_services(sleep_s);
...
PyObject* cyber_PyServiceUtils_get_service_attr(PyObject* self, PyObject* args) {
  ...
  Py_ssize_t    len      = 0;
  unsigned char sleep_s  = 0;
  if (!PyArg_ParseTuple(args, const_cast<char*>("s#B:cyber_PyServiceUtils_get_service_attr"),
