...
UnderlayMessageType::UnderlayMessageType() {
  ...
  m_keyBuffer       = (unsigned char*)malloc(UnderlayMessage::getKeyMaxCdrSerializedSize() > 16 ?
...
bool UnderlayMessageType::deserialize(SerializedPayload_t* payload, void* data) {
  UnderlayMessage* p_type =
      reinterpret_cast<UnderlayMessage*>(data);  // Convert DATA to pointer of your type
...
std::function<uint32_t()> UnderlayMessageType::getSerializedSizeProvider(void* data) {
  return [data]() -> uint32_t {
    return (uint32_t)type::getCdrSerializedSize(*static_cast<UnderlayMessage*>(data)) +
           4 /*encapsulation*/;
  };
}
