...
uint32_t ShmConf::GetBlockNum(const uint64_t& ceiling_msg_size) {
  ...
  switch (ceiling_msg_size) {
    case MESSAGE_SIZE_16K: num = BLOCK_NUM_16K; break;
    case MESSAGE_SIZE_128K: num = BLOCK_NUM_128K; break;
    case MESSAGE_SIZE_1M: num = BLOCK_NUM_1M; break;
    case MESSAGE_SIZE_8M: num = BLOCK_NUM_8M; break;
    case MESSAGE_SIZE_16M: num = BLOCK_NUM_16M; break;
    case MESSAGE_SIZE_MORE: num = BLOCK_NUM_MORE; break;
    default: AERROR << "unknown ceiling_msg_size[" << ceiling_msg_size << "]"; break;
  }
  return num;
}
