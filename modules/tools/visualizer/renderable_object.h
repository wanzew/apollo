...
class RenderableObject : protected QOpenGLFunctions {
 public:
  ...
  CreateShaderProgram(const QString& vertexShaderFileName, const QString& fragShaderFileName);
 ...
 protected:
  ...
  virtual void Draw(void) { glDrawArrays(GetPrimitiveType(), 0, vertex_count()); }
