...
DEFINE_double(guardian_cmd_soft_stop_percentage,
              25,
              "Soft stop perceptage when safe mode triggered");

DEFINE_double(guardian_cmd_emergency_stop_percentage,
              50,
              "Emergency stop perceptage when safe mode triggered");

DEFINE_bool(guardian_enabled, false, "Enable guardian, safe mode activation enabled");
