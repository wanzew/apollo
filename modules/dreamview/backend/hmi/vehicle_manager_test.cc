...
class VehicleManagerTest : public ::testing::Test {
 protected:
  VehicleManagerTest() {
    ...
    // kTargetDir.
    FLAGS_vehicle_data_config_filename = absl::StrCat(kTestVehicle, "/vehicle_data.pb.txt");
  }
};
...
TEST_F(VehicleManagerTest, Success) {
  ...
  EXPECT_TRUE(cyber::common::PathExists(absl::StrCat(kTargetDir, "/vehicle_data.pb.txt")));
