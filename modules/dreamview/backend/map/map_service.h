...
class MapService {
 public:
  ...
  bool ConstructLaneWayPointWithHeading(const double           x,
                                        const double           y,
                                        const double           heading,
                                        routing::LaneWaypoint* laneWayPoint) const;

  bool ConstructLaneWayPointWithLaneId(const double           x,
                                       const double           y,
                                       const std::string      id,
                                       routing::LaneWaypoint* laneWayPoint) const;
  ...
  bool CheckRoutingPointLaneId(const double                   x,
                               const double                   y,
 ...
 private:
  ...
  bool GetNearestLaneWithHeading(const double                     x,
                                 const double                     y,
                                 apollo::hdmap::LaneInfoConstPtr* nearest_lane,
                                 double*                          nearest_s,
                                 double*                          nearest_l,
