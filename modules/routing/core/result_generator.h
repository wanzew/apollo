...
class ResultGenerator {
 ...
 private:
  struct PassageInfo {
    ...
    PassageInfo() = default;
    PassageInfo(const std::vector<NodeWithRange>& _nodes, ChangeLaneType _change_lane_type)
        : nodes(_nodes)
        , change_lane_type(_change_lane_type) {}
  };
  ...
  void CreateRoadSegments(const std::vector<PassageInfo>& passages, RoutingResponse* result);
