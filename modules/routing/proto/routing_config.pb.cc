...
PROTOBUF_CONSTEXPR TopicConfig::TopicConfig(
  ...
  , /*decltype(_impl_.routing_response_history_topic_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}} {}
...
static ::_pb::Metadata file_level_metadata_modules_2frouting_2fproto_2frouting_5fconfig_2eproto[2];
...
const uint32_t TableStruct_modules_2frouting_2fproto_2frouting_5fconfig_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::apollo::routing::TopicConfig, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::apollo::routing::TopicConfig, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::apollo::routing::TopicConfig, _impl_.routing_response_topic_),
  PROTOBUF_FIELD_OFFSET(::apollo::routing::TopicConfig, _impl_.routing_response_history_topic_),
  0,
  1,
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::routing::RoutingConfig, _impl_.topic_config_),
  1,
  2,
  3,
  4,
...
static const ::_pb::Message* const file_default_instances[] = {
  &::apollo::routing::_TopicConfig_default_instance_._instance,
...
const ::_pbi::DescriptorTable descriptor_table_modules_2frouting_2fproto_2frouting_5fconfig_2eproto = {
    false, false, 368, descriptor_table_protodef_modules_2frouting_2fproto_2frouting_5fconfig_2eproto,
...
TopicConfig::TopicConfig(const TopicConfig& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.routing_response_history_topic_){}};
  ...
  _impl_.routing_response_history_topic_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.routing_response_history_topic_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_routing_response_history_topic()) {
    _impl_.routing_response_history_topic_.Set(from._internal_routing_response_history_topic(), 
      GetArenaForAllocation());
  }
...
inline void TopicConfig::SharedDtor() {
  ...
  _impl_.routing_response_history_topic_.Destroy();
}
...
// @@protoc_insertion_point(message_clear_start:apollo.routing.TopicConfig)
  ...
  if (cached_has_bits & 0x00000003u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _impl_.routing_response_history_topic_.ClearNonDefaultToEmpty();
    }
  }
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "apollo.routing.TopicConfig.routing_response_topic");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "apollo.routing.TopicConfig.routing_response_history_topic");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
...
void TopicConfig::InternalSwap(TopicConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.routing_response_history_topic_, lhs_arena,
      &other->_impl_.routing_response_history_topic_, rhs_arena
  );
}
...
RoutingConfig::RoutingConfig(const RoutingConfig& from)
  ...
  if (from._internal_has_topic_config()) {
    _impl_.topic_config_ = new ::apollo::routing::TopicConfig(*from._impl_.topic_config_);
  }
...
uint8_t* RoutingConfig::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(7, _Internal::topic_config(this),
...
void RoutingConfig::InternalSwap(RoutingConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(RoutingConfig, _impl_.topic_config_)>(
...
template<> PROTOBUF_NOINLINE ::apollo::routing::TopicConfig*
Arena::CreateMaybeMessage< ::apollo::routing::TopicConfig >(Arena* arena) {
