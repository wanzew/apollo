...
PROTOBUF_CONSTEXPR ParkingInfo::ParkingInfo(
  ...
  , /*decltype(_impl_.parking_point_)*/nullptr
  , /*decltype(_impl_.corner_point_)*/nullptr
  , /*decltype(_impl_.parking_space_type_)*/0} {}
...
PROTOBUF_CONSTEXPR DeadEndInfo::DeadEndInfo(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.target_point_)*/nullptr
  , /*decltype(_impl_.dead_end_routing_type_)*/0} {}
struct DeadEndInfoDefaultTypeInternal {
  PROTOBUF_CONSTEXPR DeadEndInfoDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DeadEndInfoDefaultTypeInternal _DeadEndInfo_default_instance_;
PROTOBUF_CONSTEXPR RoutingRequest::RoutingRequest(
  ...
  , /*decltype(_impl_.parking_space_)*/nullptr
  , /*decltype(_impl_.parking_info_)*/nullptr
  , /*decltype(_impl_.dead_end_info_)*/nullptr
...
static ::_pb::Metadata file_level_metadata_modules_2frouting_2fproto_2frouting_2eproto[9];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_modules_2frouting_2fproto_2frouting_2eproto[3];
...
const uint32_t TableStruct_modules_2frouting_2fproto_2frouting_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::routing::LaneWaypoint, _impl_.heading_),
  0,
  2,
  1,
  3,
  ...
  1,
  2,
  PROTOBUF_FIELD_OFFSET(::apollo::routing::ParkingInfo, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::apollo::routing::ParkingInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::apollo::routing::ParkingInfo, _impl_.parking_space_id_),
  PROTOBUF_FIELD_OFFSET(::apollo::routing::ParkingInfo, _impl_.parking_point_),
  PROTOBUF_FIELD_OFFSET(::apollo::routing::ParkingInfo, _impl_.parking_space_type_),
  PROTOBUF_FIELD_OFFSET(::apollo::routing::ParkingInfo, _impl_.corner_point_),
  0,
  1,
  3,
  2,
  PROTOBUF_FIELD_OFFSET(::apollo::routing::DeadEndInfo, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::apollo::routing::DeadEndInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::apollo::routing::DeadEndInfo, _impl_.dead_end_routing_type_),
  PROTOBUF_FIELD_OFFSET(::apollo::routing::DeadEndInfo, _impl_.target_point_),
  1,
  0,
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::routing::RoutingRequest, _impl_.parking_space_),
  PROTOBUF_FIELD_OFFSET(::apollo::routing::RoutingRequest, _impl_.parking_info_),
  PROTOBUF_FIELD_OFFSET(::apollo::routing::RoutingRequest, _impl_.dead_end_info_),
  0,
  ~0u,
  ~0u,
  ~0u,
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::apollo::routing::_ParkingInfo_default_instance_._instance,
  &::apollo::routing::_DeadEndInfo_default_instance_._instance,
...
const char descriptor_table_protodef_modules_2frouting_2fproto_2frouting_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_modules_2frouting_2fproto_2frouting_2eproto_deps[5] = {
...
const ::_pbi::DescriptorTable descriptor_table_modules_2frouting_2fproto_2frouting_2eproto = {
    false, false, 1798, descriptor_table_protodef_modules_2frouting_2fproto_2frouting_2eproto,
...
LaneWaypoint::LaneWaypoint(const LaneWaypoint& from)
  ...
  ::memcpy(&_impl_.s_, &from._impl_.s_,
    ...
    reinterpret_cast<char*>(&_impl_.s_)) + sizeof(_impl_.heading_));
...
void LaneWaypoint::InternalSwap(LaneWaypoint* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(LaneWaypoint, _impl_.heading_)
      + sizeof(LaneWaypoint::_impl_.heading_)
...
class ParkingInfo::_Internal {
 public:
  using HasBits = decltype(std::declval<ParkingInfo>()._impl_._has_bits_);
...
ParkingInfo::_Internal::parking_point(const ParkingInfo* msg) {
  return *msg->_impl_.parking_point_;
}
const ::apollo::hdmap::Polygon&
ParkingInfo::_Internal::corner_point(const ParkingInfo* msg) {
  return *msg->_impl_.corner_point_;
}
void ParkingInfo::clear_parking_point() {
  if (_impl_.parking_point_ != nullptr) _impl_.parking_point_->Clear();
  _impl_._has_bits_[0] &= ~0x00000002u;
}
void ParkingInfo::clear_corner_point() {
  if (_impl_.corner_point_ != nullptr) _impl_.corner_point_->Clear();
...
ParkingInfo::ParkingInfo(const ParkingInfo& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.parking_point_){nullptr}
    , decltype(_impl_.corner_point_){nullptr}
    , decltype(_impl_.parking_space_type_){}};
  ...
  if (from._internal_has_parking_point()) {
    _impl_.parking_point_ = new ::apollo::common::PointENU(*from._impl_.parking_point_);
  }
  if (from._internal_has_corner_point()) {
    _impl_.corner_point_ = new ::apollo::hdmap::Polygon(*from._impl_.corner_point_);
  }
  _impl_.parking_space_type_ = from._impl_.parking_space_type_;
...
inline void ParkingInfo::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete _impl_.parking_point_;
  if (this != internal_default_instance()) delete _impl_.corner_point_;
}
...
// @@protoc_insertion_point(message_clear_start:apollo.routing.ParkingInfo)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      GOOGLE_DCHECK(_impl_.parking_point_ != nullptr);
      _impl_.parking_point_->Clear();
    }
    if (cached_has_bits & 0x00000004u) {
      GOOGLE_DCHECK(_impl_.corner_point_ != nullptr);
      _impl_.corner_point_->Clear();
    }
  }
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "apollo.routing.ParkingInfo.parking_space_id");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
...
uint8_t* ParkingInfo::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000002u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, _Internal::parking_point(this),
        _Internal::parking_point(this).GetCachedSize(), target, stream);
  }
  ...
  if (cached_has_bits & 0x00000004u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(4, _Internal::corner_point(this),
        _Internal::corner_point(this).GetCachedSize(), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:apollo.routing.ParkingInfo)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(
          *_impl_.corner_point_);
    }

    // optional .apollo.routing.ParkingSpaceType parking_space_type = 3;
    if (cached_has_bits & 0x00000008u) {
      total_size += 1 +
        ::_pbi::WireFormatLite::EnumSize(this->_internal_parking_space_type());
    }
...
void ParkingInfo::InternalSwap(ParkingInfo* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ParkingInfo, _impl_.parking_space_type_)
      + sizeof(ParkingInfo::_impl_.parking_space_type_)
      - PROTOBUF_FIELD_OFFSET(ParkingInfo, _impl_.parking_point_)>(
          reinterpret_cast<char*>(&_impl_.parking_point_),
          reinterpret_cast<char*>(&other->_impl_.parking_point_));
}
...
class DeadEndInfo::_Internal {
 public:
  using HasBits = decltype(std::declval<DeadEndInfo>()._impl_._has_bits_);
...
DeadEndInfo::DeadEndInfo(const DeadEndInfo& from)
  ...
  new (&_impl_) Impl_{
    ...
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.target_point_){nullptr}
    , decltype(_impl_.dead_end_routing_type_){}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  if (from._internal_has_target_point()) {
    _impl_.target_point_ = new ::apollo::common::PointENU(*from._impl_.target_point_);
  }
  _impl_.dead_end_routing_type_ = from._impl_.dead_end_routing_type_;
  // @@protoc_insertion_point(copy_constructor:apollo.routing.DeadEndInfo)
}

inline void DeadEndInfo::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
// @@protoc_insertion_point(message_clear_start:apollo.routing.DeadEndInfo)
  ...
  cached_has_bits = _impl_._has_bits_[0];
  if (cached_has_bits & 0x00000001u) {
    GOOGLE_DCHECK(_impl_.target_point_ != nullptr);
...
const char* DeadEndInfo::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
...
uint8_t* DeadEndInfo::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  ...
  if (cached_has_bits & 0x00000001u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, _Internal::target_point(this),
...
// @@protoc_insertion_point(message_byte_size_start:apollo.routing.DeadEndInfo)
  ...
  if (cached_has_bits & 0x00000003u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      total_size += 1 +
        ::_pbi::WireFormatLite::EnumSize(this->_internal_dead_end_routing_type());
    }
...
void DeadEndInfo::InternalSwap(DeadEndInfo* other) {
  ...
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(DeadEndInfo, _impl_.dead_end_routing_type_)
      + sizeof(DeadEndInfo::_impl_.dead_end_routing_type_)
      - PROTOBUF_FIELD_OFFSET(DeadEndInfo, _impl_.target_point_)>(
...
RoutingRequest::_Internal::parking_space(const RoutingRequest* msg) {
  return *msg->_impl_.parking_space_;
}
...
RoutingRequest::_Internal::dead_end_info(const RoutingRequest* msg) {
  return *msg->_impl_.dead_end_info_;
}
...
void RoutingRequest::clear_parking_space() {
  if (_impl_.parking_space_ != nullptr) _impl_.parking_space_->Clear();
  _impl_._has_bits_[0] &= ~0x00000002u;
}
...
RoutingRequest::RoutingRequest(const RoutingRequest& from)
  ...
  if (from._internal_has_parking_space()) {
    _impl_.parking_space_ = new ::apollo::hdmap::ParkingSpace(*from._impl_.parking_space_);
  }
  ...
  if (from._internal_has_dead_end_info()) {
    _impl_.dead_end_info_ = new ::apollo::routing::DeadEndInfo(*from._impl_.dead_end_info_);
  }
...
inline void RoutingRequest::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete _impl_.parking_space_;
  if (this != internal_default_instance()) delete _impl_.parking_info_;
  if (this != internal_default_instance()) delete _impl_.dead_end_info_;
}
...
// @@protoc_insertion_point(message_clear_start:apollo.routing.RoutingRequest)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      GOOGLE_DCHECK(_impl_.parking_space_ != nullptr);
    ...
    if (cached_has_bits & 0x00000008u) {
      GOOGLE_DCHECK(_impl_.dead_end_info_ != nullptr);
      _impl_.dead_end_info_->Clear();
    }
...
uint8_t* RoutingRequest::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000002u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(6, _Internal::parking_space(this),
        _Internal::parking_space(this).GetCachedSize(), target, stream);
  }

  // optional .apollo.routing.ParkingInfo parking_info = 7;
  if (cached_has_bits & 0x00000004u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(7, _Internal::parking_info(this),
  ...
  if (cached_has_bits & 0x00000008u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(8, _Internal::dead_end_info(this),
        _Internal::dead_end_info(this).GetCachedSize(), target, stream);
  }
...
void RoutingRequest::InternalSwap(RoutingRequest* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RoutingRequest, _impl_.dead_end_info_)
      + sizeof(RoutingRequest::_impl_.dead_end_info_)
      - PROTOBUF_FIELD_OFFSET(RoutingRequest, _impl_.header_)>(
...
template<> PROTOBUF_NOINLINE ::apollo::routing::ParkingInfo*
Arena::CreateMaybeMessage< ::apollo::routing::ParkingInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::apollo::routing::ParkingInfo >(arena);
}
template<> PROTOBUF_NOINLINE ::apollo::routing::DeadEndInfo*
Arena::CreateMaybeMessage< ::apollo::routing::DeadEndInfo >(Arena* arena) {
