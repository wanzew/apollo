...
class TopicConfig final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_routing_response_history_topic(ArgT0&& arg0, ArgT... args);
  std::string* mutable_routing_response_history_topic();
  PROTOBUF_NODISCARD std::string* release_routing_response_history_topic();
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_routing_response_history_topic(const std::string& value);
...
class RoutingConfig final :
 ...
 public:
  ...
  ~RoutingConfig() override;
  explicit PROTOBUF_CONSTEXPR RoutingConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  RoutingConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::apollo::routing::TopicConfig* release_topic_config();
...
inline void TopicConfig::clear_routing_response_history_topic() {
  _impl_.routing_response_history_topic_.ClearToEmpty();
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void TopicConfig::set_routing_response_history_topic(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.routing_response_history_topic_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* TopicConfig::mutable_routing_response_history_topic() {
  std::string* _s = _internal_mutable_routing_response_history_topic();
...
inline const std::string& TopicConfig::_internal_routing_response_history_topic() const {
  return _impl_.routing_response_history_topic_.Get();
}
inline void TopicConfig::_internal_set_routing_response_history_topic(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.routing_response_history_topic_.Set(value, GetArenaForAllocation());
}
inline std::string* TopicConfig::_internal_mutable_routing_response_history_topic() {
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.routing_response_history_topic_.Mutable(GetArenaForAllocation());
}
inline std::string* TopicConfig::release_routing_response_history_topic() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* p = _impl_.routing_response_history_topic_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.routing_response_history_topic_.IsDefault()) {
    _impl_.routing_response_history_topic_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void TopicConfig::set_allocated_routing_response_history_topic(std::string* routing_response_history_topic) {
  ...
  _impl_.routing_response_history_topic_.SetAllocated(routing_response_history_topic, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.routing_response_history_topic_.IsDefault()) {
    _impl_.routing_response_history_topic_.Set("", GetArenaForAllocation());
  }
...
inline void RoutingConfig::_internal_set_left_turn_penalty(double value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.left_turn_penalty_ = value;
}
...
inline void RoutingConfig::_internal_set_right_turn_penalty(double value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.right_turn_penalty_ = value;
}
...
inline void RoutingConfig::_internal_set_base_changing_length(double value) {
  _impl_._has_bits_[0] |= 0x00000040u;
  _impl_.base_changing_length_ = value;
}
...
inline const ::apollo::routing::TopicConfig& RoutingConfig::_internal_topic_config() const {
  const ::apollo::routing::TopicConfig* p = _impl_.topic_config_;
...
inline ::apollo::routing::TopicConfig* RoutingConfig::release_topic_config() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::apollo::routing::TopicConfig* temp = _impl_.topic_config_;
...
inline ::apollo::routing::TopicConfig* RoutingConfig::_internal_mutable_topic_config() {
  ...
  if (_impl_.topic_config_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::routing::TopicConfig>(GetArenaForAllocation());
    _impl_.topic_config_ = p;
  }
  return _impl_.topic_config_;
}
inline ::apollo::routing::TopicConfig* RoutingConfig::mutable_topic_config() {
  ::apollo::routing::TopicConfig* _msg = _internal_mutable_topic_config();
