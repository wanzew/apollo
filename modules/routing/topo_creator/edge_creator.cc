...
void EdgeCreator::GetPbEdge(const Node&                node_from,
                            const Node&                node_to,
...
void EdgeCreator::InitEdgeInfo(const Node&                node_from,
                               const Node&                node_to,
                               const Edge::DirectionType& type,
                               Edge* const                edge,
                               const RoutingConfig*       routing_config) {
...
void EdgeCreator::InitEdgeCost(const Node&                node_from,
                               const Node&                node_to,
                               const Edge::DirectionType& type,
                               Edge* const                edge,
                               const RoutingConfig*       routing_config) {
  ...
  if (type == Edge::LEFT || type == Edge::RIGHT) {
    ...
    double ratio = (changing_area_length >= routing_config->base_changing_length()) ?
