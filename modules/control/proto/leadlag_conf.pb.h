...
class LeadlagConf final :
 ...
 public:
  ...
  ~LeadlagConf() override;
  explicit PROTOBUF_CONSTEXPR LeadlagConf(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  LeadlagConf* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
