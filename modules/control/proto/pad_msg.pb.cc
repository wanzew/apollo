...
static ::_pb::Metadata file_level_metadata_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto[1];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto[1];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto = nullptr;

const uint32_t TableStruct_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::apollo::control::PadMessage, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::apollo::control::PadMessage, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::apollo::control::PadMessage, _impl_.header_),
  PROTOBUF_FIELD_OFFSET(::apollo::control::PadMessage, _impl_.driving_mode_),
  PROTOBUF_FIELD_OFFSET(::apollo::control::PadMessage, _impl_.action_),
  0,
  1,
  2,
};
...
static const ::_pb::Message* const file_default_instances[] = {
  &::apollo::control::_PadMessage_default_instance_._instance,
};
...
const char descriptor_table_protodef_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\001\022\t\n\005RESET\020\002"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto_deps[2] = {
  &::descriptor_table_modules_2fcanbus_2fproto_2fchassis_2eproto,
  &::descriptor_table_modules_2fcommon_2fproto_2fheader_2eproto,
};
static ::_pbi::once_flag descriptor_table_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto = {
    false, false, 332, descriptor_table_protodef_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto,
    ...
    file_level_metadata_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto, file_level_enum_descriptors_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto,
    file_level_service_descriptors_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto_getter() {
  return &descriptor_table_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto(&descriptor_table_modules_2fcontrol_2fproto_2fpad_5fmsg_2eproto);
namespace apollo {
namespace control {
...
PadMessage::PadMessage(const PadMessage& from)
  ...
  ::memcpy(&_impl_.driving_mode_, &from._impl_.driving_mode_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.action_) -
    reinterpret_cast<char*>(&_impl_.driving_mode_)) + sizeof(_impl_.action_));
...
// @@protoc_insertion_point(message_clear_start:apollo.control.PadMessage)
  ...
  if (cached_has_bits & 0x00000006u) {
    ::memset(&_impl_.driving_mode_, 0, static_cast<size_t>(
...
template<> PROTOBUF_NOINLINE ::apollo::control::PadMessage*
Arena::CreateMaybeMessage< ::apollo::control::PadMessage >(Arena* arena) {
