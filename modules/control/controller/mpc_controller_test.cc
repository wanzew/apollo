...
class MPCControllerTest : public ::testing::Test, MPCController {
 public:
  virtual void SetupTestCase() {
    ...
    ACHECK(cyber::common::GetProtoFromFile(FLAGS_control_conf_file, &control_conf));
  ...
  void ComputeLateralErrors(const double              x,
    ...
    MPCController::ComputeLateralErrors(x, y, theta, linear_v, angular_v, linear_a,
...
TEST_F(MPCControllerTest, ComputeLateralErrors) {
  auto localization_pb = LoadLocalizaionPb("/apollo/modules//control/testdata/mpc_controller_test/"
                                           "1_localization.pb.txt");
  auto chassis_pb =
      LoadChassisPb("/apollo/modules/control/testdata/mpc_controller_test/1_chassis.pb.txt");
  ...
  auto planning_trajectory_pb =
      LoadPlanningTrajectoryPb("/apollo/modules//control/testdata/mpc_controller_test/"
                               "1_planning.pb.txt");
