...
class LatControllerTest : public ::testing::Test, LatController {
 public:
  ...
  void ComputeLateralErrors(const double              x,
    ...
    LatController::ComputeLateralErrors(x, y, theta, linear_v, angular_v, trajectory_analyzer,
                                        debug);
  }
...
TEST_F(LatControllerTest, ComputeLateralErrors) {
  auto localization_pb = LoadLocalizaionPb("modules/control/testdata/lateral_controller_test/"
                                           "1_localization.pb.txt");
  auto chassis_pb =
      LoadChassisPb("modules/control/testdata/lateral_controller_test/1_chassis.pb.txt");
  ...
  auto planning_trajectory_pb =
      LoadPlanningTrajectoryPb("modules/control/testdata/lateral_controller_test/"
                               "1_planning.pb.txt");
