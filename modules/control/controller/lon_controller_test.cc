...
const char data_path[] = "/apollo/modules//control/testdata/longitudinal_controller_test/";
...
class LonControllerTest : public ::testing::Test, LonController {
 public:
  ...
  void ComputeLongitudinalErrors(const TrajectoryAnalyzer* trajectory,
    ...
    LonController::ComputeLongitudinalErrors(trajectory, preview_time, ts, debug);
  }
