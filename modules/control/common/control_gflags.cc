...
DEFINE_string(control_adapter_config_filename,
              "modules/control/conf/adapter.conf",
...
DEFINE_bool(enable_input_timestamp_check, true, "True to enable input timestamp delay check");
...
DEFINE_bool(enable_navigation_mode_handlilng, false, "Enable special handling for navigation mode");
