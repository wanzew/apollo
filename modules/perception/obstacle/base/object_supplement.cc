...
RadarFrameSupplement& RadarFrameSupplement::operator=(const RadarFrameSupplement& rhs) {
  return (*this);
}
...
CameraFrameSupplement& CameraFrameSupplement::operator=(const CameraFrameSupplement& rhs) {
  rhs.depth_map.copyTo(depth_map);
  rhs.label_map.copyTo(label_map);
  rhs.lane_map.copyTo(lane_map);
  return (*this);
