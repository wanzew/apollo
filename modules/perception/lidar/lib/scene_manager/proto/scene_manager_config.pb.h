...
class SceneManagerConfig final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR SceneManagerConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  SceneManagerConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
