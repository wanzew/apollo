...
class PointCloudPreprocessorConfig final :
 ...
 public:
  inline PointCloudPreprocessorConfig() : PointCloudPreprocessorConfig(nullptr) {}
  ~PointCloudPreprocessorConfig() override;
  explicit PROTOBUF_CONSTEXPR PointCloudPreprocessorConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(PointCloudPreprocessorConfig* other) {
    if (other == this) return;
  ...
  PointCloudPreprocessorConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit PointCloudPreprocessorConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
inline bool PointCloudPreprocessorConfig::_internal_filter_naninf_points() const {
  return _impl_.filter_naninf_points_;
}
...
inline void PointCloudPreprocessorConfig::_internal_set_filter_naninf_points(bool value) {
  _impl_._has_bits_[0] |= 0x00000040u;
  _impl_.filter_naninf_points_ = value;
}
...
inline void PointCloudPreprocessorConfig::_internal_set_filter_nearby_box_points(bool value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.filter_nearby_box_points_ = value;
}
...
inline void PointCloudPreprocessorConfig::_internal_set_filter_high_z_points(bool value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.filter_high_z_points_ = value;
}
