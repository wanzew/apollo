...
class Params {
 public:
  ...
  static std::vector<std::vector<float>> AnchorDxSizes() {
    return std::vector<std::vector<float>>{std::vector<float>{2.08, 0.84, 0.84}};
  }

  static std::vector<std::vector<float>> AnchorDySizes() {
    return std::vector<std::vector<float>>{std::vector<float>{4.73, 1.81, 0.91}};
  }

  static std::vector<std::vector<float>> AnchorDzSizes() {
    return std::vector<std::vector<float>>{std::vector<float>{1.77, 1.77, 1.74}};
  }

  static std::vector<std::vector<float>> AnchorZCoors() {
    return std::vector<std::vector<float>>{std::vector<float>{-0.0345, -0.1188, 0}};
  }
