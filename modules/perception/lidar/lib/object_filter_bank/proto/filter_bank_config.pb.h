...
class FilterBankConfig final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:apollo.perception.lidar.FilterBankConfig) */ {
 public:
  inline FilterBankConfig() : FilterBankConfig(nullptr) {}
  ~FilterBankConfig() override;
  explicit PROTOBUF_CONSTEXPR FilterBankConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(FilterBankConfig* other) {
    if (other == this) return;
  ...
  FilterBankConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit FilterBankConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena,
