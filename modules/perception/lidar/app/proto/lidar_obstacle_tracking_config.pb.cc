...
namespace lidar {
PROTOBUF_CONSTEXPR LidarObstacleTrackingConfig::LidarObstacleTrackingConfig(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.multi_target_tracker_)*/{nullptr, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.frame_classifier_)*/{nullptr, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.fusion_classifier_)*/{nullptr, ::_pbi::ConstantInitialized{}}} {}
struct LidarObstacleTrackingConfigDefaultTypeInternal {
  PROTOBUF_CONSTEXPR LidarObstacleTrackingConfigDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 LidarObstacleTrackingConfigDefaultTypeInternal _LidarObstacleTrackingConfig_default_instance_;
}  // namespace lidar
}  // namespace perception
}  // namespace apollo
static ::_pb::Metadata file_level_metadata_modules_2fperception_2flidar_2fapp_2fproto_2flidar_5fobstacle_5ftracking_5fconfig_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_modules_2fperception_2flidar_2fapp_2fproto_2flidar_5fobstacle_5ftracking_5fconfig_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_modules_2fperception_2flidar_2fapp_2fproto_2flidar_5fobstacle_5ftracking_5fconfig_2eproto = nullptr;

const uint32_t TableStruct_modules_2fperception_2flidar_2fapp_2fproto_2flidar_5fobstacle_5ftracking_5fconfig_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::apollo::perception::lidar::LidarObstacleTrackingConfig, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::lidar::LidarObstacleTrackingConfig, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::apollo::perception::lidar::LidarObstacleTrackingConfig, _impl_.multi_target_tracker_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::lidar::LidarObstacleTrackingConfig, _impl_.frame_classifier_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::lidar::LidarObstacleTrackingConfig, _impl_.fusion_classifier_),
  0,
  1,
  2,
};
...
static const ::_pb::Message* const file_default_instances[] = {
  &::apollo::perception::lidar::_LidarObstacleTrackingConfig_default_instance_._instance,
};
...
const char descriptor_table_protodef_modules_2fperception_2flidar_2fapp_2fproto_2flidar_5fobstacle_5ftracking_5fconfig_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_modules_2fperception_2flidar_2fapp_2fproto_2flidar_5fobstacle_5ftracking_5fconfig_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_modules_2fperception_2flidar_2fapp_2fproto_2flidar_5fobstacle_5ftracking_5fconfig_2eproto = {
    false, false, 272, descriptor_table_protodef_modules_2fperception_2flidar_2fapp_2fproto_2flidar_5fobstacle_5ftracking_5fconfig_2eproto,
    ...
    file_level_metadata_modules_2fperception_2flidar_2fapp_2fproto_2flidar_5fobstacle_5ftracking_5fconfig_2eproto, file_level_enum_descriptors_modules_2fperception_2flidar_2fapp_2fproto_2flidar_5fobstacle_5ftracking_5fconfig_2eproto,
    file_level_service_descriptors_modules_2fperception_2flidar_2fapp_2fproto_2flidar_5fobstacle_5ftracking_5fconfig_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_modules_2fperception_2flidar_2fapp_2fproto_2flidar_5fobstacle_5ftracking_5fconfig_2eproto_getter() {
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_modules_2fperception_2flidar_2fapp_2fproto_2flidar_5fobstacle_5ftracking_5fconfig_2eproto(&descriptor_table_modules_2fperception_2flidar_2fapp_2fproto_2flidar_5fobstacle_5ftracking_5fconfig_2eproto);
namespace apollo {
namespace perception {
namespace lidar {
...
class LidarObstacleTrackingConfig::_Internal {
 public:
  using HasBits = decltype(std::declval<LidarObstacleTrackingConfig>()._impl_._has_bits_);
...
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString LidarObstacleTrackingConfig::Impl_::_i_give_permission_to_break_this_code_default_multi_target_tracker_{{{"DummyMultiTargetTracker", 23}}, {nullptr}};
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString LidarObstacleTrackingConfig::Impl_::_i_give_permission_to_break_this_code_default_frame_classifier_{{{"DummyClassifier", 15}}, {nullptr}};
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString LidarObstacleTrackingConfig::Impl_::_i_give_permission_to_break_this_code_default_fusion_classifier_{{{"DummyClassifier", 15}}, {nullptr}};
...
LidarObstacleTrackingConfig::LidarObstacleTrackingConfig(const LidarObstacleTrackingConfig& from)
  ...
  new (&_impl_) Impl_{
    ...
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.multi_target_tracker_){}
    , decltype(_impl_.frame_classifier_){}
    , decltype(_impl_.fusion_classifier_){}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _impl_.multi_target_tracker_.InitDefault();
  if (from._internal_has_multi_target_tracker()) {
    _impl_.multi_target_tracker_.Set(from._internal_multi_target_tracker(), 
      GetArenaForAllocation());
  }
  _impl_.frame_classifier_.InitDefault();
  if (from._internal_has_frame_classifier()) {
    _impl_.frame_classifier_.Set(from._internal_frame_classifier(), 
      GetArenaForAllocation());
  }
  _impl_.fusion_classifier_.InitDefault();
  if (from._internal_has_fusion_classifier()) {
    _impl_.fusion_classifier_.Set(from._internal_fusion_classifier(), 
      GetArenaForAllocation());
  }
  // @@protoc_insertion_point(copy_constructor:apollo.perception.lidar.LidarObstacleTrackingConfig)
}

inline void LidarObstacleTrackingConfig::SharedCtor(
...
inline void LidarObstacleTrackingConfig::SharedDtor() {
  ...
  _impl_.multi_target_tracker_.Destroy();
  _impl_.frame_classifier_.Destroy();
  _impl_.fusion_classifier_.Destroy();
}
...
// @@protoc_insertion_point(message_clear_start:apollo.perception.lidar.LidarObstacleTrackingConfig)
  ...
  if (cached_has_bits & 0x00000007u) {
    if (cached_has_bits & 0x00000001u) {
      _impl_.multi_target_tracker_.ClearToDefault(::apollo::perception::lidar::LidarObstacleTrackingConfig::Impl_::_i_give_permission_to_break_this_code_default_multi_target_tracker_, GetArenaForAllocation());
       }
    if (cached_has_bits & 0x00000002u) {
      _impl_.frame_classifier_.ClearToDefault(::apollo::perception::lidar::LidarObstacleTrackingConfig::Impl_::_i_give_permission_to_break_this_code_default_frame_classifier_, GetArenaForAllocation());
       }
    if (cached_has_bits & 0x00000004u) {
      _impl_.fusion_classifier_.ClearToDefault(::apollo::perception::lidar::LidarObstacleTrackingConfig::Impl_::_i_give_permission_to_break_this_code_default_fusion_classifier_, GetArenaForAllocation());
       }
  }
...
const char* LidarObstacleTrackingConfig::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "apollo.perception.lidar.LidarObstacleTrackingConfig.multi_target_tracker");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "apollo.perception.lidar.LidarObstacleTrackingConfig.frame_classifier");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "apollo.perception.lidar.LidarObstacleTrackingConfig.fusion_classifier");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
...
uint8_t* LidarObstacleTrackingConfig::_InternalSerialize(
...
void LidarObstacleTrackingConfig::InternalSwap(LidarObstacleTrackingConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.multi_target_tracker_, lhs_arena,
      &other->_impl_.multi_target_tracker_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.frame_classifier_, lhs_arena,
      &other->_impl_.frame_classifier_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.fusion_classifier_, lhs_arena,
      &other->_impl_.fusion_classifier_, rhs_arena
  );
}
...
template<> PROTOBUF_NOINLINE ::apollo::perception::lidar::LidarObstacleTrackingConfig*
Arena::CreateMaybeMessage< ::apollo::perception::lidar::LidarObstacleTrackingConfig >(Arena* arena) {
