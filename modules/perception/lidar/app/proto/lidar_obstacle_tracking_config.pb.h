...
class LidarObstacleTrackingConfig final :
 ...
 public:
  inline LidarObstacleTrackingConfig() : LidarObstacleTrackingConfig(nullptr) {}
  ~LidarObstacleTrackingConfig() override;
  explicit PROTOBUF_CONSTEXPR LidarObstacleTrackingConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(LidarObstacleTrackingConfig* other) {
    if (other == this) return;
  ...
  LidarObstacleTrackingConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit LidarObstacleTrackingConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  void set_multi_target_tracker(ArgT0&& arg0, ArgT... args);
  std::string* mutable_multi_target_tracker();
  PROTOBUF_NODISCARD std::string* release_multi_target_tracker();
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_multi_target_tracker(const std::string& value);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_frame_classifier(ArgT0&& arg0, ArgT... args);
  std::string* mutable_frame_classifier();
  PROTOBUF_NODISCARD std::string* release_frame_classifier();
  void set_allocated_frame_classifier(std::string* frame_classifier);
  private:
  const std::string& _internal_frame_classifier() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_frame_classifier(const std::string& value);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_fusion_classifier(ArgT0&& arg0, ArgT... args);
  std::string* mutable_fusion_classifier();
  PROTOBUF_NODISCARD std::string* release_fusion_classifier();
  void set_allocated_fusion_classifier(std::string* fusion_classifier);
  private:
  const std::string& _internal_fusion_classifier() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_fusion_classifier(const std::string& value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    static const ::PROTOBUF_NAMESPACE_ID::internal::LazyString _i_give_permission_to_break_this_code_default_multi_target_tracker_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr multi_target_tracker_;
    static const ::PROTOBUF_NAMESPACE_ID::internal::LazyString _i_give_permission_to_break_this_code_default_frame_classifier_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr frame_classifier_;
    static const ::PROTOBUF_NAMESPACE_ID::internal::LazyString _i_give_permission_to_break_this_code_default_fusion_classifier_;
...
inline const std::string& LidarObstacleTrackingConfig::multi_target_tracker() const {
  ...
  if (_impl_.multi_target_tracker_.IsDefault()) return Impl_::_i_give_permission_to_break_this_code_default_multi_target_tracker_.get();
  return _internal_multi_target_tracker();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LidarObstacleTrackingConfig::set_multi_target_tracker(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.multi_target_tracker_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* LidarObstacleTrackingConfig::mutable_multi_target_tracker() {
  std::string* _s = _internal_mutable_multi_target_tracker();
...
inline const std::string& LidarObstacleTrackingConfig::_internal_multi_target_tracker() const {
  return _impl_.multi_target_tracker_.Get();
}
inline void LidarObstacleTrackingConfig::_internal_set_multi_target_tracker(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.multi_target_tracker_.Set(value, GetArenaForAllocation());
}
inline std::string* LidarObstacleTrackingConfig::_internal_mutable_multi_target_tracker() {
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.multi_target_tracker_.Mutable(::apollo::perception::lidar::LidarObstacleTrackingConfig::Impl_::_i_give_permission_to_break_this_code_default_multi_target_tracker_, GetArenaForAllocation());
}
inline std::string* LidarObstacleTrackingConfig::release_multi_target_tracker() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.multi_target_tracker_.Release();
  return p;
}
inline void LidarObstacleTrackingConfig::set_allocated_multi_target_tracker(std::string* multi_target_tracker) {
  ...
  _impl_.multi_target_tracker_.SetAllocated(multi_target_tracker, GetArenaForAllocation());
...
inline const std::string& LidarObstacleTrackingConfig::frame_classifier() const {
  ...
  if (_impl_.frame_classifier_.IsDefault()) return Impl_::_i_give_permission_to_break_this_code_default_frame_classifier_.get();
  return _internal_frame_classifier();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LidarObstacleTrackingConfig::set_frame_classifier(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.frame_classifier_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* LidarObstacleTrackingConfig::mutable_frame_classifier() {
  std::string* _s = _internal_mutable_frame_classifier();
...
inline const std::string& LidarObstacleTrackingConfig::_internal_frame_classifier() const {
  return _impl_.frame_classifier_.Get();
}
inline void LidarObstacleTrackingConfig::_internal_set_frame_classifier(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.frame_classifier_.Set(value, GetArenaForAllocation());
}
inline std::string* LidarObstacleTrackingConfig::_internal_mutable_frame_classifier() {
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.frame_classifier_.Mutable(::apollo::perception::lidar::LidarObstacleTrackingConfig::Impl_::_i_give_permission_to_break_this_code_default_frame_classifier_, GetArenaForAllocation());
}
inline std::string* LidarObstacleTrackingConfig::release_frame_classifier() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* p = _impl_.frame_classifier_.Release();
  return p;
}
inline void LidarObstacleTrackingConfig::set_allocated_frame_classifier(std::string* frame_classifier) {
  ...
  _impl_.frame_classifier_.SetAllocated(frame_classifier, GetArenaForAllocation());
...
inline const std::string& LidarObstacleTrackingConfig::fusion_classifier() const {
  ...
  if (_impl_.fusion_classifier_.IsDefault()) return Impl_::_i_give_permission_to_break_this_code_default_fusion_classifier_.get();
  return _internal_fusion_classifier();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LidarObstacleTrackingConfig::set_fusion_classifier(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000004u;
 _impl_.fusion_classifier_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* LidarObstacleTrackingConfig::mutable_fusion_classifier() {
  std::string* _s = _internal_mutable_fusion_classifier();
...
inline const std::string& LidarObstacleTrackingConfig::_internal_fusion_classifier() const {
  return _impl_.fusion_classifier_.Get();
}
inline void LidarObstacleTrackingConfig::_internal_set_fusion_classifier(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.fusion_classifier_.Set(value, GetArenaForAllocation());
}
inline std::string* LidarObstacleTrackingConfig::_internal_mutable_fusion_classifier() {
  _impl_._has_bits_[0] |= 0x00000004u;
  return _impl_.fusion_classifier_.Mutable(::apollo::perception::lidar::LidarObstacleTrackingConfig::Impl_::_i_give_permission_to_break_this_code_default_fusion_classifier_, GetArenaForAllocation());
}
inline std::string* LidarObstacleTrackingConfig::release_fusion_classifier() {
  ...
  _impl_._has_bits_[0] &= ~0x00000004u;
  auto* p = _impl_.fusion_classifier_.Release();
  return p;
}
inline void LidarObstacleTrackingConfig::set_allocated_fusion_classifier(std::string* fusion_classifier) {
  ...
  _impl_.fusion_classifier_.SetAllocated(fusion_classifier, GetArenaForAllocation());
