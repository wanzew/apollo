...
TEST(DistortionModelTest, distortion_model_get_set_test) {
  ...
  std::shared_ptr<BaseCameraModel> camera_model = distortion_model.get_camera_model();
  ...
  Eigen::Matrix3f ret_intrinsic_mat = pinhole_camera_model->get_intrinsic_params();
