...
POINT_CLOUD_REGISTER_POINT_STRUCT(apollo::perception::pcl_util::PointD,
                                  (double, x, x)(double, y, y)(double, z, z)(uint8_t,
                                                                             intensity,
                                                                             intensity))
...
POINT_CLOUD_REGISTER_POINT_STRUCT(apollo::perception::pcl_util::PointXYZIRT,
...
POINT_CLOUD_REGISTER_POINT_STRUCT(apollo::perception::pcl_util::PointXYZIRTd,
                                  (double, x, x)(double, y, y)(double, z, z)(uint8_t,
                                                                             intensity,
                                                                             intensity)(
                                      uint8_t, ring, ring)(double, timestamp, timestamp))
