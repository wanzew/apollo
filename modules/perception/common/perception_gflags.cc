...
DEFINE_string(config_manager_path,
              "./conf/config_manager.config",
              "The ModelConfig config paths file.");
DEFINE_string(work_root, "/apollo/modules/perception/", "perception work root direcotry.");

/// obstacle/base/object.cc
DEFINE_bool(is_serialize_point_cloud, false, "serialize and output object cloud");
...
DEFINE_string(onboard_object_builder, "DummyObjectBuilder", "onboard object builder");
DEFINE_string(onboard_object_filter, "DummyObjectFilter", "onboard object filter");
...
DEFINE_string(lidar_tf2_child_frame_id, "velodyne64", "the tf2 transform child frame id");
DEFINE_string(obstacle_module_name, "perception_obstacle", "perception obstacle module name");
...
DEFINE_string(radar_tf2_child_frame_id, "radar", "the tf2 transform child frame id");
...
DEFINE_double(q_matrix_coefficient_amplifier, 0.5, "Kalman fitler matrix Q coeffcients");
...
DEFINE_double(a_matrix_covariance_coeffcient_1,
              0.05,
              "Kalman fitler matrix a coeffcients, a_matrix_(0, 2)");
DEFINE_double(a_matrix_covariance_coeffcient_2,
              0.05,
...
DEFINE_string(onboard_lane_post_processor,
              "CCLanePostProcessor",
...
DEFINE_bool(use_distance_angle_fusion, true, "use distance angle prob distance in fusion");
...
DEFINE_string(yolo_camera_detector_config,
...
DEFINE_string(tracker_config,
              "modules/perception/model/tracker_config.pb.txt",
...
DEFINE_string(geometry_camera_converter_config,
