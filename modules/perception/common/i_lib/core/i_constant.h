...
class Constant<double> {
 public:
  ...
  static const double TWO_PI() { return 6.283185307179586476925286766559; }    // 2pi
  static const double HALF_PI() { return 1.5707963267948966192313216916398; }  // pi over 2
  static const double REC_TWO_PI() {
    return 0.15915494309189533576888376337251;
  }                                                                           // reciprocal of 2pi
  static const double SQRT_2() { return 1.4142135623730950488016887242097; }  // square root of 2
  static const double REC_SQRT_2() {
    return 0.70710678118654752440084436210485;
  }  // reciprocal of square root of 2
  static const double SQRT_3() { return 1.7320508075688772935274463415059; }  // square root of 3
  ...
  static const double SQRT_EPSILON() { return 1.053e-08; }  // square root of epsilon
...
class Constant<float> {
 public:
  ...
  static const float TWO_PI() { return 6.283185307179586476925286766559f; }    // 2pi
  static const float HALF_PI() { return 1.5707963267948966192313216916398f; }  // pi over 2
  static const float REC_TWO_PI() {
    return 0.15915494309189533576888376337251f;
  }                                                                           // reciprocal of 2pi
  static const float SQRT_2() { return 1.4142135623730950488016887242097f; }  // square root of 2
  static const float REC_SQRT_2() {
    return 0.70710678118654752440084436210485f;
  }  // reciprocal of square root of 2
  static const float SQRT_3() { return 1.7320508075688772935274463415059f; }  // square root of 3
  ...
  static const float SQRT_EPSILON() { return 2.44e-04f; }  // square root of epsilon
