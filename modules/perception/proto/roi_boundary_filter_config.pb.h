...
class ROIBoundaryFilterConfig final :
 ...
 public:
  inline ROIBoundaryFilterConfig() : ROIBoundaryFilterConfig(nullptr) {}
  ~ROIBoundaryFilterConfig() override;
  explicit PROTOBUF_CONSTEXPR ROIBoundaryFilterConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(ROIBoundaryFilterConfig* other) {
    if (other == this) return;
  ...
  ROIBoundaryFilterConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit ROIBoundaryFilterConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
inline double ROIBoundaryFilterConfig::_internal_distance_to_boundary_threshold() const {
  return _impl_.distance_to_boundary_threshold_;
}
...
inline void ROIBoundaryFilterConfig::_internal_set_distance_to_boundary_threshold(double value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.distance_to_boundary_threshold_ = value;
}
...
inline float ROIBoundaryFilterConfig::_internal_cross_roi_threshold() const {
  return _impl_.cross_roi_threshold_;
}
...
inline void ROIBoundaryFilterConfig::_internal_set_cross_roi_threshold(float value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.cross_roi_threshold_ = value;
}
...
inline double ROIBoundaryFilterConfig::_internal_inside_threshold() const {
  return _impl_.inside_threshold_;
}
...
inline void ROIBoundaryFilterConfig::_internal_set_inside_threshold(double value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.inside_threshold_ = value;
}
