...
PROTOBUF_NAMESPACE_OPEN
template<> ::apollo::perception::probabilistic_fusion_config::ModelConfigs* Arena::CreateMaybeMessage<::apollo::perception::probabilistic_fusion_config::ModelConfigs>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace apollo {
namespace perception {
namespace probabilistic_fusion_config {
...
class ModelConfigs final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:apollo.perception.probabilistic_fusion_config.ModelConfigs) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "apollo.perception.probabilistic_fusion_config.ModelConfigs";
  }
  protected:
  ...
  enum : int {
    ...
    kMaxCameraInvisiblePeriodFieldNumber = 14,
  ...
  private:
  float _internal_max_camera_invisible_period() const;
  void _internal_set_max_camera_invisible_period(float value);
  public:
...
inline std::string* ModelConfigs::_internal_mutable_name() {
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.name_.Mutable(::apollo::perception::probabilistic_fusion_config::ModelConfigs::Impl_::_i_give_permission_to_break_this_code_default_name_, GetArenaForAllocation());
}
...
inline std::string* ModelConfigs::_internal_mutable_version() {
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.version_.Mutable(::apollo::perception::probabilistic_fusion_config::ModelConfigs::Impl_::_i_give_permission_to_break_this_code_default_version_, GetArenaForAllocation());
}
...
inline std::string* ModelConfigs::_internal_mutable_match_method() {
  _impl_._has_bits_[0] |= 0x00000004u;
  return _impl_.match_method_.Mutable(::apollo::perception::probabilistic_fusion_config::ModelConfigs::Impl_::_i_give_permission_to_break_this_code_default_match_method_, GetArenaForAllocation());
}
...
inline std::string* ModelConfigs::_internal_mutable_publish_sensor() {
  _impl_._has_bits_[0] |= 0x00000008u;
  return _impl_.publish_sensor_.Mutable(::apollo::perception::probabilistic_fusion_config::ModelConfigs::Impl_::_i_give_permission_to_break_this_code_default_publish_sensor_, GetArenaForAllocation());
}
...
// optional float max_camera_invisible_period = 14 [default = 0.25];
inline bool ModelConfigs::_internal_has_max_camera_invisible_period() const {
...
inline float ModelConfigs::_internal_max_camera_invisible_period() const {
...
inline void ModelConfigs::_internal_set_max_camera_invisible_period(float value) {
  _impl_._has_bits_[0] |= 0x00000010u;
