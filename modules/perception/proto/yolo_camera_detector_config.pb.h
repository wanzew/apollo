...
#ifndef GOOGLE_PROTOBUF_INCLUDED_modules_2fperception_2fproto_2fyolo_5fcamera_5fdetector_5fconfig_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_modules_2fperception_2fproto_2fyolo_5fcamera_5fdetector_5fconfig_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_modules_2fperception_2fproto_2fyolo_5fcamera_5fdetector_5fconfig_2eproto
...
struct TableStruct_modules_2fperception_2fproto_2fyolo_5fcamera_5fdetector_5fconfig_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fperception_2fproto_2fyolo_5fcamera_5fdetector_5fconfig_2eproto;
namespace apollo {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::apollo::perception::yolo_camera_detector_config::ModelConfigs* Arena::CreateMaybeMessage<::apollo::perception::yolo_camera_detector_config::ModelConfigs>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace apollo {
namespace perception {
namespace yolo_camera_detector_config {
...
class ModelConfigs final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:apollo.perception.yolo_camera_detector_config.ModelConfigs) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "apollo.perception.yolo_camera_detector_config.ModelConfigs";
  }
  protected:
  ...
  private:
  bool _internal_has_yolo_root() const;
  public:
  void clear_yolo_root();
  const std::string& yolo_root() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_yolo_root(ArgT0&& arg0, ArgT... args);
  std::string* mutable_yolo_root();
  PROTOBUF_NODISCARD std::string* release_yolo_root();
  void set_allocated_yolo_root(std::string* yolo_root);
  private:
  const std::string& _internal_yolo_root() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_yolo_root(const std::string& value);
  std::string* _internal_mutable_yolo_root();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    static const ::PROTOBUF_NAMESPACE_ID::internal::LazyString _i_give_permission_to_break_this_code_default_yolo_root_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr yolo_root_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_modules_2fperception_2fproto_2fyolo_5fcamera_5fdetector_5fconfig_2eproto;
};
// ===================================================================
...
inline std::string* ModelConfigs::_internal_mutable_name() {
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.name_.Mutable(::apollo::perception::yolo_camera_detector_config::ModelConfigs::Impl_::_i_give_permission_to_break_this_code_default_name_, GetArenaForAllocation());
}
...
inline std::string* ModelConfigs::_internal_mutable_version() {
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.version_.Mutable(::apollo::perception::yolo_camera_detector_config::ModelConfigs::Impl_::_i_give_permission_to_break_this_code_default_version_, GetArenaForAllocation());
}
...
// optional string yolo_root = 3 [default = "/apollo/modules/perception/model/yolo_camera_detector"];
inline bool ModelConfigs::_internal_has_yolo_root() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool ModelConfigs::has_yolo_root() const {
  return _internal_has_yolo_root();
}
...
inline const std::string& ModelConfigs::yolo_root() const {
  ...
  if (_impl_.yolo_root_.IsDefault()) return Impl_::_i_give_permission_to_break_this_code_default_yolo_root_.get();
  return _internal_yolo_root();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ModelConfigs::set_yolo_root(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000004u;
 _impl_.yolo_root_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* ModelConfigs::mutable_yolo_root() {
  std::string* _s = _internal_mutable_yolo_root();
  // @@protoc_insertion_point(field_mutable:apollo.perception.yolo_camera_detector_config.ModelConfigs.yolo_root)
  return _s;
}
inline const std::string& ModelConfigs::_internal_yolo_root() const {
  return _impl_.yolo_root_.Get();
}
inline void ModelConfigs::_internal_set_yolo_root(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.yolo_root_.Set(value, GetArenaForAllocation());
}
inline std::string* ModelConfigs::_internal_mutable_yolo_root() {
  _impl_._has_bits_[0] |= 0x00000004u;
  return _impl_.yolo_root_.Mutable(::apollo::perception::yolo_camera_detector_config::ModelConfigs::Impl_::_i_give_permission_to_break_this_code_default_yolo_root_, GetArenaForAllocation());
}
inline std::string* ModelConfigs::release_yolo_root() {
  ...
  if (!_internal_has_yolo_root()) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000004u;
  auto* p = _impl_.yolo_root_.Release();
  return p;
}
inline void ModelConfigs::set_allocated_yolo_root(std::string* yolo_root) {
  if (yolo_root != nullptr) {
    _impl_._has_bits_[0] |= 0x00000004u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000004u;
  }
  _impl_.yolo_root_.SetAllocated(yolo_root, GetArenaForAllocation());
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_modules_2fperception_2fproto_2fyolo_5fcamera_5fdetector_5fconfig_2eproto
