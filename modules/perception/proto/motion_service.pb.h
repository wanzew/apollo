...
class MotionType final :
 ...
 public:
  ...
  ~MotionType() override;
  explicit PROTOBUF_CONSTEXPR MotionType(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  MotionType* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class VehicleStatus final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR VehicleStatus(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  VehicleStatus* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::apollo::perception::MotionType* release_motion();
  ...
  void unsafe_arena_set_allocated_motion(
      ::apollo::perception::MotionType* motion);
  ::apollo::perception::MotionType* unsafe_arena_release_motion();
...
class Motion_Service final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:apollo.perception.Motion_Service) */ {
 public:
  inline Motion_Service() : Motion_Service(nullptr) {}
  ~Motion_Service() override;
  explicit PROTOBUF_CONSTEXPR Motion_Service(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(Motion_Service* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  Motion_Service* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit Motion_Service(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
inline const ::apollo::perception::MotionType& VehicleStatus::_internal_motion() const {
  const ::apollo::perception::MotionType* p = _impl_.motion_;
...
inline void VehicleStatus::unsafe_arena_set_allocated_motion(
    ::apollo::perception::MotionType* motion) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.perception.VehicleStatus.motion)
}
inline ::apollo::perception::MotionType* VehicleStatus::release_motion() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::apollo::perception::MotionType* temp = _impl_.motion_;
...
inline ::apollo::perception::MotionType* VehicleStatus::unsafe_arena_release_motion() {
...
inline ::apollo::perception::MotionType* VehicleStatus::_internal_mutable_motion() {
  ...
  if (_impl_.motion_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::perception::MotionType>(GetArenaForAllocation());
    _impl_.motion_ = p;
  }
  return _impl_.motion_;
}
inline ::apollo::perception::MotionType* VehicleStatus::mutable_motion() {
  ::apollo::perception::MotionType* _msg = _internal_mutable_motion();
...
inline void VehicleStatus::set_allocated_motion(::apollo::perception::MotionType* motion) {
  ...
  if (motion) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(motion);
...
inline int Motion_Service::_internal_vehicle_status_size() const {
  return _impl_.vehicle_status_.size();
}
...
inline ::apollo::perception::VehicleStatus* Motion_Service::mutable_vehicle_status(int index) {
  ...
  return _impl_.vehicle_status_.Mutable(index);
}
...
inline ::apollo::perception::VehicleStatus* Motion_Service::_internal_add_vehicle_status() {
  return _impl_.vehicle_status_.Add();
}
inline ::apollo::perception::VehicleStatus* Motion_Service::add_vehicle_status() {
  ::apollo::perception::VehicleStatus* _add = _internal_add_vehicle_status();
...
inline void Motion_Service::unsafe_arena_set_allocated_header(
    ::apollo::common::Header* header) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.perception.Motion_Service.header)
}
...
inline ::apollo::common::Header* Motion_Service::unsafe_arena_release_header() {
