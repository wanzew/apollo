...
class PerceptionLanes final :
 ...
 public:
  ...
  ~PerceptionLanes() override;
  explicit PROTOBUF_CONSTEXPR PerceptionLanes(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PerceptionLanes* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
void PerceptionLanes::set_source_topic(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
inline void PerceptionLanes::set_allocated_camera_calibrator(::apollo::perception::camera::CameraCalibrator* camera_calibrator) {
  ...
  if (camera_calibrator) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(camera_calibrator));
    if (message_arena != submessage_arena) {
