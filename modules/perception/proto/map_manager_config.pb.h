...
class MapManagerConfig final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR MapManagerConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  MapManagerConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline double MapManagerConfig::_internal_roi_search_distance() const {
  return _impl_.roi_search_distance_;
}
...
inline void MapManagerConfig::_internal_set_roi_search_distance(double value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.roi_search_distance_ = value;
}
