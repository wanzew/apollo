...
static ::_pb::Metadata file_level_metadata_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto = nullptr;

const uint32_t TableStruct_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::apollo::perception::async_fusion_config::ModelConfigs, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::async_fusion_config::ModelConfigs, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::apollo::perception::async_fusion_config::ModelConfigs, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::async_fusion_config::ModelConfigs, _impl_.version_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::async_fusion_config::ModelConfigs, _impl_.match_method_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::async_fusion_config::ModelConfigs, _impl_.max_match_distance_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::async_fusion_config::ModelConfigs, _impl_.max_lidar_invisible_period_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::async_fusion_config::ModelConfigs, _impl_.max_radar_invisible_period_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::async_fusion_config::ModelConfigs, _impl_.max_radar_confident_angle_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::async_fusion_config::ModelConfigs, _impl_.min_radar_confident_distance_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::async_fusion_config::ModelConfigs, _impl_.publish_if_has_lidar_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::async_fusion_config::ModelConfigs, _impl_.publish_if_has_radar_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::async_fusion_config::ModelConfigs, _impl_.publish_sensor_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::async_fusion_config::ModelConfigs, _impl_.use_radar_),
  PROTOBUF_FIELD_OFFSET(::apollo::perception::async_fusion_config::ModelConfigs, _impl_.use_lidar_),
  0,
  1,
  2,
  4,
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 19, -1, sizeof(::apollo::perception::async_fusion_config::ModelConfigs)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::apollo::perception::async_fusion_config::_ModelConfigs_default_instance_._instance,
};

const char descriptor_table_protodef_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n2modules/perception/proto/async_fusion_"
  "config.proto\022%apollo.perception.async_fu"
  "sion_config\"\306\003\n\014ModelConfigs\022\031\n\004name\030\001 \001"
  "(\t:\013AsyncFusion\022\026\n\007version\030\002 \001(\t:\0051.0.0\022"
  " \n\014match_method\030\003 \001(\t:\nhm_matcher\022\035\n\022max"
  "_match_distance\030\004 \001(\002:\0014\022(\n\032max_lidar_in"
  "visible_period\030\005 \001(\002:\0040.25\022(\n\032max_radar_"
  "invisible_period\030\006 \001(\002:\0040.25\022%\n\031max_rada"
  "r_confident_angle\030\007 \001(\002:\00230\022(\n\034min_radar"
  "_confident_distance\030\010 \001(\002:\00240\022\"\n\024publish"
  "_if_has_lidar\030\t \001(\010:\004true\022\"\n\024publish_if_"
  "has_radar\030\n \001(\010:\004true\022#\n\016publish_sensor\030"
  "\013 \001(\t:\013velodyne_64\022\027\n\tuse_radar\030\014 \001(\010:\004t"
  "rue\022\027\n\tuse_lidar\030\r \001(\010:\004true"
  ;
static ::_pbi::once_flag descriptor_table_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto = {
    false, false, 548, descriptor_table_protodef_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto,
    "modules/perception/proto/async_fusion_config.proto",
    &descriptor_table_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto::offsets,
    file_level_metadata_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto, file_level_enum_descriptors_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto,
    file_level_service_descriptors_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto_getter() {
  return &descriptor_table_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto(&descriptor_table_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto);
namespace apollo {
namespace perception {
namespace async_fusion_config {
...
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString ModelConfigs::Impl_::_i_give_permission_to_break_this_code_default_name_{{{"AsyncFusion", 11}}, {nullptr}};
...
ModelConfigs::ModelConfigs(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:apollo.perception.async_fusion_config.ModelConfigs)
}
ModelConfigs::ModelConfigs(const ModelConfigs& from)
  ...
  ::memcpy(&_impl_.max_match_distance_, &from._impl_.max_match_distance_,
    ...
    reinterpret_cast<char*>(&_impl_.max_match_distance_)) + sizeof(_impl_.use_lidar_));
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "apollo.perception.async_fusion_config.ModelConfigs.name");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "apollo.perception.async_fusion_config.ModelConfigs.version");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "apollo.perception.async_fusion_config.ModelConfigs.match_method");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
      ...
      case 11:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 90)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "apollo.perception.async_fusion_config.ModelConfigs.publish_sensor");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::Metadata ModelConfigs::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto_getter, &descriptor_table_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto_once,
      file_level_metadata_modules_2fperception_2fproto_2fasync_5ffusion_5fconfig_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::apollo::perception::async_fusion_config::ModelConfigs*
Arena::CreateMaybeMessage< ::apollo::perception::async_fusion_config::ModelConfigs >(Arena* arena) {
  return Arena::CreateMessageInternal< ::apollo::perception::async_fusion_config::ModelConfigs >(arena);
}
