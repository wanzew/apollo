...
class SensorMeta final :
 ...
 public:
  ...
  ~SensorMeta() override;
  explicit PROTOBUF_CONSTEXPR SensorMeta(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  SensorMeta* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class MultiSensorMeta final :
 ...
 public:
  ...
  ~MultiSensorMeta() override;
  explicit PROTOBUF_CONSTEXPR MultiSensorMeta(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  MultiSensorMeta* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
void SensorMeta::set_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
inline ::apollo::perception::SensorMeta_SensorType SensorMeta::_internal_type() const {
  return static_cast< ::apollo::perception::SensorMeta_SensorType >(_impl_.type_);
}
...
inline ::apollo::perception::SensorMeta_SensorOrientation SensorMeta::_internal_orientation() const {
  return static_cast< ::apollo::perception::SensorMeta_SensorOrientation >(_impl_.orientation_);
}
...
inline int MultiSensorMeta::_internal_sensor_meta_size() const {
  return _impl_.sensor_meta_.size();
}
...
inline ::apollo::perception::SensorMeta* MultiSensorMeta::mutable_sensor_meta(int index) {
  ...
  return _impl_.sensor_meta_.Mutable(index);
}
...
inline ::apollo::perception::SensorMeta* MultiSensorMeta::_internal_add_sensor_meta() {
  return _impl_.sensor_meta_.Add();
}
inline ::apollo::perception::SensorMeta* MultiSensorMeta::add_sensor_meta() {
  ::apollo::perception::SensorMeta* _add = _internal_add_sensor_meta();
