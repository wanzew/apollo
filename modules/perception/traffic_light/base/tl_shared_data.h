 ...
 *****************************************************************************/
#ifndef MODULES_PERCEPTION_TRAFFIC_LIGHT_ONBOARD_PREPROCESSOR_DATA_H_
#define MODULES_PERCEPTION_TRAFFIC_LIGHT_ONBOARD_PREPROCESSOR_DATA_H_
...
class TLPreprocessingData : public CommonSharedData<ImageLights> {
 public:
  ...
  std::string name() const override { return "TLPreprocessingData"; }
};
...
#endif  // MODULES_PERCEPTION_TRAFFIC_LIGHT_ONBOARD_PREPROCESSOR_DATA_H_
