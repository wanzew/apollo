...
const std::map<EltwiseParameter::EltwiseOp, nvinfer1::ElementWiseOperation> eltwise_map{
    {EltwiseParameter_EltwiseOp_PROD, nvinfer1::ElementWiseOperation::kPROD},
...
const std::vector<std::string> _gpu_checklist{
    "GeForce GTX 1080", "GeForce GTX 1080 Ti", "Tesla P4", "Tesla P40", "GeForce GTX 1070",
    "GeForce GTX 1060", "Tesla V100-SXM2-16GB"};

class RTNet : public Inference {
 public:
  RTNet(const std::string&              net_file,
