...
bool RecognitionComponent::Proc(const std::shared_ptr<LidarFrameMessage>& message) {
  AINFO << std::setprecision(16)
        << "Enter Tracking component, message timestamp: " << message->timestamp_
...
bool RecognitionComponent::InternalProc(const std::shared_ptr<const LidarFrameMessage>& in_message,
  ...
  lidar::LidarProcessResult ret = tracker_->Process(track_options, lidar_frame.get());
  ...
  AINFO << std::setprecision(16) << "FRAME_STATISTICS:Lidar:End:msg_time[" << in_message->timestamp_
