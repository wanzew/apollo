...
class TrafficLightsPerceptionComponent : public apollo::cyber::Component<> {
 ...
 private:
  ...
  void OnReceiveV2XMsg(const std::shared_ptr<apollo::v2x::IntersectionTrafficLightData> v2x_msg);
  ...
  bool CheckCameraImageStatus(double timestamp, double interval, const std::string& camera_name);
  ...
  void TransRect2Box(const base::RectI& rect, apollo::perception::TrafficLightBox* box);
 ...
 private:
  ...
  std::shared_ptr<apollo::cyber::Writer<apollo::perception::TrafficLightDetection>> writer_;
  ...
  boost::circular_buffer<apollo::v2x::IntersectionTrafficLightData> v2x_msg_buffer_;
};
