...
class Visualizer {
 ...
 public:
  ...
  bool Init_all_info_single_camera(const std::vector<std::string>&               camera_names,
  ...
  bool adjust_angles(const std::string& camera_name,
                     const double       pitch_adj,
                     const double       yaw_adj,
                     const double       roll_adj);
  ...
  void Draw2Dand3D_all_info_single_camera(const std::string&          camera_name,
                                          const cv::Mat&              img,
                                          const CameraFrame&          frame,
