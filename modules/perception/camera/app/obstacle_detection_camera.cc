...
void ObstacleDetectionCamera::SetIm2CarHomography(Eigen::Matrix3d homography_im2car) {
  if (calibration_service_ == nullptr) {
    AERROR << "Calibraion service is not available";
    return;
  }
...
bool ObstacleDetectionCamera::GetCalibrationService(BaseCalibrationService** calibration_service) {
