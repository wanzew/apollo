...
class MyInferenceEngine : public BaseInferenceEngine {
 public:
  ...
  bool Infer(const InferenceEngineOptions& options, CameraFrame* frame) override { return true; }
...
class MyObstacleDetector : public BaseObstacleDetector {
 public:
  ...
  bool Detect(const ObstacleDetectorOptions& options, CameraFrame* frame) override { return true; }
...
class MyObstacleTracker : public BaseObstacleTracker {
 public:
  ...
  bool Predict(const ObstacleTrackerOptions& options, CameraFrame* frame) override { return true; }
  ...
  bool Track(const ObstacleTrackerOptions& options, CameraFrame* frame) override { return true; }
...
class MyObstacleTransformer : public BaseObstacleTransformer {
 public:
  ...
  bool Init(const ObstacleTransformerInitOptions& options) override { return true; }
...
TEST(ObstacleInterfaceTest, test_camera_transformer) {
  BaseObstacleTransformer* camera_transformer =
      BaseObstacleTransformerRegisterer::GetInstanceByName("MyObstacleTransformer");
...
class MyObstaclePostprocessor : public BaseObstaclePostprocessor {
 public:
  ...
  bool Init(const ObstaclePostprocessorInitOptions& options) override { return true; }
...
TEST(ObstacleInterfaceTest, test_camera_postprocessor) {
  BaseObstaclePostprocessor* camera_postprocessor =
      BaseObstaclePostprocessorRegisterer::GetInstanceByName("MyObstaclePostprocessor");
...
class MyTrafficLightDetector : public BaseTrafficLightDetector {
 public:
  ...
  bool Init(const TrafficLightDetectorInitOptions& options) override { return true; }
...
TEST(TrafficLightInterfaceTest, test_traffic_light_detector) {
  BaseTrafficLightDetector* traffic_light_detector =
      BaseTrafficLightDetectorRegisterer::GetInstanceByName("MyTrafficLightDetector");
...
class MyTrafficLightTracker : public BaseTrafficLightTracker {
 public:
  ...
  bool Init(const TrafficLightTrackerInitOptions& options) override { return true; }
...
TEST(TrafficLightInterfaceTest, test_traffic_light_tracker) {
  BaseTrafficLightTracker* traffic_light_tracker =
      BaseTrafficLightTrackerRegisterer::GetInstanceByName("MyTrafficLightTracker");
...
class MyLandmarkDetector : public BaseLandmarkDetector {
 public:
  ...
  bool Init(const LandmarkDetectorInitOptions& options) override { return true; }

  bool Detect(const LandmarkDetectorOptions& options, CameraFrame* frame) override { return true; }
...
class MyLaneDetector : public BaseLaneDetector {
 public:
  ...
  bool Detect(const LaneDetectorOptions& options, CameraFrame* frame) override { return true; }
...
class MyLaneTracker : public BaseLaneTracker {
 public:
  ...
  bool Track(const LaneTrackerOptions& options, CameraFrame* frame) override { return true; }
...
TEST(LaneInterfaceTest, test_lane_tracker) {
  BaseLaneTracker* lane_tracker = BaseLaneTrackerRegisterer::GetInstanceByName("MyLaneTracker");
...
class MyLanePostprocessor : public BaseLanePostprocessor {
 public:
  ...
  bool Init(const LanePostprocessorInitOptions& options) override { return true; }
...
class MyFeatureExtractor : public BaseFeatureExtractor {
 public:
  ...
  bool Init(const FeatureExtractorInitOptions& init_options) override { return true; }

  bool Extract(const FeatureExtractorOptions& options, CameraFrame* frame) override { return true; }
...
class MySceneParser : public BaseSceneParser {
 public:
  ...
  bool Parse(const SceneParserOptions& options, CameraFrame* frame) override { return true; }
...
TEST(SceneInterfaceTest, test_scene_parser) {
  BaseSceneParser* scene_parser = BaseSceneParserRegisterer::GetInstanceByName("MySceneParser");
...
class MyCalibrator : public BaseCalibrator {
 public:
  ...
  bool Calibrate(const CalibratorOptions& options, float* pitch_angle) override { return true; }
...
TEST(CalibratorInterfaceTest, test_calibrator) {
  BaseCalibrator* calibrator = BaseCalibratorRegisterer::GetInstanceByName("MyCalibrator");
...
class MyCalibrationService : public BaseCalibrationService {
 public:
  ...
  bool Init(const CalibrationServiceInitOptions& options) override { return true; }
...
TEST(CalibrationServiceInterfaceTest, test_calibrator) {
  BaseCalibrationService* calibrator =
      BaseCalibrationServiceRegisterer::GetInstanceByName("MyCalibrationService");
  EXPECT_NE(calibrator, nullptr);
...
class MyCameraPerception : public BaseCameraPerception {
 public:
  ...
  bool Init(const CameraPerceptionInitOptions& init_options) override { return true; }
