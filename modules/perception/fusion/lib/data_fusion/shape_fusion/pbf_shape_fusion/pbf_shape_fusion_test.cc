...
TEST(PbfShapeFusion, lidar_track) {
  FLAGS_work_root            = "/apollo/modules/perception/testdata/fusion/pbf_shape_fusion";
  ...
  SensorObjectPtr lidar_obj(new SensorObject(base_track_lidar, lidar_sensor_frame));
  ...
  SensorObjectPtr lidar_measurement(new SensorObject(base_object_lidar, lidar_sensor_frame_2));
  // radar measurment
  ...
  SensorObjectPtr radar_measurement(new SensorObject(base_object_radar, radar_sensor_frame));
  // camera measurment
  ...
  SensorObjectPtr camera_measurement(new SensorObject(base_object_camera, camera_sensor_frame));
  ...
  EXPECT_LT((size - shape_fusion.GetTrack()->GetFusedObject()->GetBaseObject()->size).norm(), 1e-6);
  EXPECT_FLOAT_EQ(shape_fusion.GetTrack()->GetFusedObject()->GetBaseObject()->theta, 0.0);
...
TEST(PbfShapeFusion, radar_track) {
  ...
  SensorObjectPtr radar_obj(new SensorObject(base_track_radar, radar_sensor_frame));
  ...
  SensorObjectPtr lidar_measurement(new SensorObject(base_object_lidar, lidar_sensor_frame));
  // radar measurment
  base::ObjectPtr base_object_radar(new base::Object);
  base_object_radar->center       = Eigen::Vector3d(10, 0, 0);
  base_object_radar->anchor_point = Eigen::Vector3d(10, 0, 0);
  ...
  SensorObjectPtr radar_measurement(new SensorObject(base_object_radar, radar_sensor_frame_2));
  // camera measurment
  base::ObjectPtr base_object_camera(new base::Object);
  base_object_camera->center       = Eigen::Vector3d(10, 0, 0);
  base_object_camera->anchor_point = Eigen::Vector3d(10, 0, 0);
  ...
  SensorObjectPtr unknown_measurement(new SensorObject(base_object_unknown, unknown_sensor_frame));
  ...
  size << 2.0f, 1.0f, 3.0f;
  EXPECT_LT((size - shape_fusion.GetTrack()->GetFusedObject()->GetBaseObject()->size).norm(), 1e-6);
  EXPECT_FLOAT_EQ(shape_fusion.GetTrack()->GetFusedObject()->GetBaseObject()->theta,
                  SHAPE_FUSION_PI / 4);
...
TEST(PbfShapeFusion, camera_track) {
  ...
  SensorObjectPtr camera_obj(new SensorObject(base_track_camera, camera_sensor_frame));
  ...
  SensorObjectPtr radar_measurement_2(new SensorObject(base_object_radar, radar_sensor_frame_2));
  // camera measurment
  base::ObjectPtr base_object_camera(new base::Object);
  base_object_camera->center       = Eigen::Vector3d(10, 0, 0);
  base_object_camera->anchor_point = Eigen::Vector3d(10, 0, 0);
  ...
  SensorObjectPtr camera_measurement(new SensorObject(base_object_camera, camera_sensor_frame_2));
