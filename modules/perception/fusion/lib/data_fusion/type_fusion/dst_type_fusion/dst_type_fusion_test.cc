...
TEST(DstTypeFusionTest, test_update_with_measurement) {
  ...
  base_lidar_object_ptr->type_probs.resize(static_cast<size_t>(base::ObjectType::MAX_OBJECT_TYPE),
                                           0.0f);
  base_lidar_object_ptr->type_probs =
      std::vector<float>(static_cast<size_t>(base::ObjectType::MAX_OBJECT_TYPE), 0.1f);
  base_lidar_object_ptr->type_probs[static_cast<size_t>(base::ObjectType::VEHICLE)] = 0.6f;
  ...
  base_camera_object_ptr->type_probs.resize(static_cast<size_t>(base::ObjectType::MAX_OBJECT_TYPE));
  base_camera_object_ptr->type_probs =
      std::vector<float>(static_cast<size_t>(base::ObjectType::MAX_OBJECT_TYPE), 0.1f);
  base_camera_object_ptr->type_probs[static_cast<size_t>(base::ObjectType::PEDESTRIAN)] = 0.4f;
...
TEST(DstTypeFusionTest, test_update_without_measurement) {
  ...
  type_fusion1.UpdateWithoutMeasurement("velodyne_64", 151192277.124567989, 151192277.124567989,
                                        0.9);
  CHECK_EQ(static_cast<size_t>(track1->GetFusedObject()->GetBaseObject()->type),
           static_cast<size_t>(base::ObjectType::UNKNOWN));
  type_fusion1.UpdateWithoutMeasurement(sensor_id, 151192277.124567989, 151192277.124567989, 0.9);
  CHECK_EQ(static_cast<size_t>(track1->GetFusedObject()->GetBaseObject()->type),
           static_cast<size_t>(base::ObjectType::UNKNOWN));
  type_fusion1.UpdateWithoutMeasurement("camera_test", 151192277.124567989, 151192277.124567989,
                                        0.9);
  CHECK_EQ(static_cast<size_t>(track1->GetFusedObject()->GetBaseObject()->type),
           static_cast<size_t>(base::ObjectType::UNKNOWN));

  // update more times
  type_fusion1.UpdateWithoutMeasurement(sensor_id, 151192277.124567989, 151192277.124567989, 0.0);
  type_fusion1.UpdateWithoutMeasurement(sensor_id, 151192277.124567989, 151192277.124567989, 0.0);
  ...
  type_fusion_2.UpdateWithoutMeasurement(sensor_id, 151192277.124567989, 151192277.124567989, 0.0);
  CHECK_EQ(static_cast<size_t>(track1->GetFusedObject()->GetBaseObject()->type),
           static_cast<size_t>(base::ObjectType::UNKNOWN));
  ...
  type_fusion_3.UpdateWithoutMeasurement(sensor_id, 151192277.124567989, 151192277.124567989, 0.0);
