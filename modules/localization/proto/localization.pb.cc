...
PROTOBUF_CONSTEXPR LocalizationEstimate::LocalizationEstimate(
  ...
  , /*decltype(_impl_.msf_status_)*/nullptr
  , /*decltype(_impl_.sensor_status_)*/nullptr
...
const uint32_t TableStruct_modules_2flocalization_2fproto_2flocalization_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::localization::LocalizationEstimate, _impl_.msf_status_),
  PROTOBUF_FIELD_OFFSET(::apollo::localization::LocalizationEstimate, _impl_.sensor_status_),
  0,
  1,
  2,
  5,
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::localization::LocalizationStatus, _impl_.state_message_),
  1,
  2,
  3,
  5,
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 16, 29, -1, sizeof(::apollo::localization::LocalizationEstimate)},
  { 36, 48, -1, sizeof(::apollo::localization::LocalizationStatus)},
};
...
const char descriptor_table_protodef_modules_2flocalization_2fproto_2flocalization_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_modules_2flocalization_2fproto_2flocalization_2eproto_deps[5] = {
...
const ::_pbi::DescriptorTable descriptor_table_modules_2flocalization_2fproto_2flocalization_2eproto = {
    false, false, 1302, descriptor_table_protodef_modules_2flocalization_2fproto_2flocalization_2eproto,
    "modules/localization/proto/localization.proto",
    &descriptor_table_modules_2flocalization_2fproto_2flocalization_2eproto_once, descriptor_table_modules_2flocalization_2fproto_2flocalization_2eproto_deps, 5, 3,
...
LocalizationEstimate::LocalizationEstimate(const LocalizationEstimate& from)
  ...
  if (from._internal_has_msf_status()) {
    _impl_.msf_status_ = new ::apollo::localization::MsfStatus(*from._impl_.msf_status_);
  }
  if (from._internal_has_sensor_status()) {
    _impl_.sensor_status_ = new ::apollo::localization::MsfSensorMsgStatus(*from._impl_.sensor_status_);
  }
...
inline void LocalizationEstimate::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete _impl_.msf_status_;
  if (this != internal_default_instance()) delete _impl_.sensor_status_;
}
...
// @@protoc_insertion_point(message_clear_start:apollo.localization.LocalizationEstimate)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      GOOGLE_DCHECK(_impl_.msf_status_ != nullptr);
      _impl_.msf_status_->Clear();
    }
    if (cached_has_bits & 0x00000010u) {
      GOOGLE_DCHECK(_impl_.sensor_status_ != nullptr);
...
uint8_t* LocalizationEstimate::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(6, _Internal::msf_status(this),
        _Internal::msf_status(this).GetCachedSize(), target, stream);
  }

  // optional .apollo.localization.MsfSensorMsgStatus sensor_status = 7;
  if (cached_has_bits & 0x00000010u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(7, _Internal::sensor_status(this),
        _Internal::sensor_status(this).GetCachedSize(), target, stream);
  }
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 50)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "apollo.localization.LocalizationStatus.state_message");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
