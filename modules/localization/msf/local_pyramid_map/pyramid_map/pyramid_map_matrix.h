...
class PyramidMapMatrix : public BaseMapMatrix {
 public:
  ...
  const float*
  GetIntensityVarSafe(unsigned int row, unsigned int col, unsigned int level = 0) const;
  ...
  const float*
  GetGroundAltitudeSafe(unsigned int row, unsigned int col, unsigned int level = 0) const;
  /**@brief Get a count value by check. */
  const unsigned int*
  GetCountSafe(unsigned int row, unsigned int col, unsigned int level = 0) const;
  /**@brief Get a ground count value by check. */
  const unsigned int*
  GetGroundCountSafe(unsigned int row, unsigned int col, unsigned int level = 0) const;

  /**@brief Get cell values by check. */
  void GetMapCellSafe(float**        intensity,
                      float**        intensity_var,
                      float**        altitude,
                      float**        altitude_var,
  ...
  void SetIntensityMatrix(const float* input,
                          unsigned int size,
                          unsigned int start_index,
                          unsigned int level = 0);
  void SetIntensityVarMatrix(const float* input,
                             unsigned int size,
                             unsigned int start_index,
                             unsigned int level = 0);
  void SetAltitudeMatrix(const float* input,
                         unsigned int size,
                         unsigned int start_index,
                         unsigned int level = 0);
  void SetAltitudeVarMatrix(const float* input,
                            unsigned int size,
                            unsigned int start_index,
                            unsigned int level = 0);
  void SetGroundAltitudeMatrix(const float* input,
                               unsigned int size,
                               unsigned int start_index,
                               unsigned int level = 0);
  void SetCountMatrix(const unsigned int* input,
                      unsigned int        size,
                      unsigned int        start_index,
                      unsigned int        level = 0);
  void SetGroundCountMatrix(const unsigned int* input,
                            unsigned int        size,
                            unsigned int        start_index,
                            unsigned int        level = 0);
  ...
  void
  SetIntensitySafe(float intensity, unsigned int row, unsigned int col, unsigned int level = 0);
  /**@brief Set an intensity variance value by check. */
  void SetIntensityVarSafe(float        intensity_var,
                           unsigned int row,
                           unsigned int col,
                           unsigned int level = 0);
  ...
  void SetAltitudeVarSafe(float        altitude_var,
                          unsigned int row,
                          unsigned int col,
                          unsigned int level = 0);
  /**@brief Set an altitude ground value by check. */
  void SetGroundAltitudeSafe(float        ground_altitude,
                             unsigned int row,
                             unsigned int col,
                             unsigned int level = 0);
  ...
  void SetGroundCountSafe(unsigned int ground_count,
                          unsigned int row,
                          unsigned int col,
                          unsigned int level = 0);
   ...
   */
  void SetValueSafe(unsigned char intensity,
                    float         altitude,
                    unsigned int  row,
                    unsigned int  col,
                    unsigned int  level = 0);
  ...
  void MergeCellSafe(const float*        intensity,
  ...
  void AddGroundSample(float        ground_altitude,
                       unsigned int row,
                       unsigned int col,
                       unsigned int level = 0);
   ...
   */
  inline void GetMapCellBase(float**        intensity,
                             float**        intensity_var,
                             float**        altitude,
                             unsigned int** count,
                             unsigned int   row,
  ...
  inline const float*
  GetIntensity(unsigned int row, unsigned int col, unsigned int level = 0) const;
  /**@brief Get an intensity variance value by check. */
  inline const float*
  GetIntensityVar(unsigned int row, unsigned int col, unsigned int level = 0) const;
  /**@brief Get an altitude value without check. */
  inline const float* GetAltitude(unsigned int row, unsigned int col, unsigned int level = 0) const;
  /**@brief Get an altitude variance value without check. */
  inline const float*
  GetAltitudeVar(unsigned int row, unsigned int col, unsigned int level = 0) const;
  /**@brief Get an altitude ground value without check. */
  inline const float*
  GetGroundAltitude(unsigned int row, unsigned int col, unsigned int level = 0) const;
  /**@brief Get a count value without check. */
  inline const unsigned int*
  GetCount(unsigned int row, unsigned int col, unsigned int level = 0) const;
  /**@brief Get a ground count value without check. */
  inline const unsigned int*
  GetGroundCount(unsigned int row, unsigned int col, unsigned int level = 0) const;
  ...
  inline const FloatMatrix* GetGroundAltitudeMatrix(unsigned int level = 0) const;
 ...
 private:
  ...
  bool CheckLegalityForGetData(unsigned int row, unsigned int col, unsigned int level) const;

  bool CheckLegalityForSetData(unsigned int level, unsigned int start_id, unsigned int size) const;
...
inline bool PyramidMapMatrix::HasIntensityVar() const { return has_intensity_var_; }

inline bool PyramidMapMatrix::HasAltitude() const { return has_altitude_; }

inline bool PyramidMapMatrix::HasAltitudeVar() const { return has_altitude_var_; }

inline bool PyramidMapMatrix::HasGroundAltitude() const { return has_ground_altitude_; }

inline bool PyramidMapMatrix::HasCount() const { return has_count_; }

inline bool PyramidMapMatrix::HasGroundCount() const { return has_ground_count_; }

inline unsigned int PyramidMapMatrix::GetRowsSafe(unsigned int level) const {
  if (level >= resolution_num_) {
    std::cerr << "PyramidMapMatrix: [GetRows] The level id is illegal." << std::endl;
    return 0;
  }
...
inline unsigned int PyramidMapMatrix::GetColsSafe(unsigned int level) const {
  if (level >= resolution_num_) {
    std::cerr << "PyramidMapMatrix: [GetCols] The level id is illegal." << std::endl;
    return 0;
  }
...
inline unsigned int PyramidMapMatrix::GetRows(unsigned int level) const { return rows_mr_[level]; }

inline unsigned int PyramidMapMatrix::GetCols(unsigned int level) const { return cols_mr_[level]; }

inline unsigned int PyramidMapMatrix::GetResolutionNum() const { return resolution_num_; }

inline unsigned int PyramidMapMatrix::GetResolutionRatio() const { return ratio_; }

inline void PyramidMapMatrix::AddSampleBase(
    float intensity, float altitude, unsigned int row, unsigned int col, unsigned int level) {
...
inline const float*
PyramidMapMatrix::GetIntensity(unsigned int row, unsigned int col, unsigned int level) const {
  return &intensity_matrixes_[level][row][col];
}

inline const float*
PyramidMapMatrix::GetIntensityVar(unsigned int row, unsigned int col, unsigned int level) const {
  return &intensity_var_matrixes_[level][row][col];
}

inline const float*
PyramidMapMatrix::GetAltitude(unsigned int row, unsigned int col, unsigned int level) const {
  return &altitude_matrixes_[level][row][col];
}

inline const float*
PyramidMapMatrix::GetAltitudeVar(unsigned int row, unsigned int col, unsigned int level) const {
  return &altitude_var_matrixes_[level][row][col];
}

inline const float*
PyramidMapMatrix::GetGroundAltitude(unsigned int row, unsigned int col, unsigned int level) const {
  return &ground_altitude_matrixes_[level][row][col];
}

inline const unsigned int*
PyramidMapMatrix::GetCount(unsigned int row, unsigned int col, unsigned int level) const {
  return &count_matrixes_[level][row][col];
}

inline const unsigned int*
PyramidMapMatrix::GetGroundCount(unsigned int row, unsigned int col, unsigned int level) const {
...
inline FloatMatrix* PyramidMapMatrix::GetIntensityVarMatrix(unsigned int level) {
...
inline FloatMatrix* PyramidMapMatrix::GetGroundAltitudeMatrix(unsigned int level) {
...
inline const FloatMatrix* PyramidMapMatrix::GetIntensityMatrix(unsigned int level) const {
  return &intensity_matrixes_[level];
}

inline const FloatMatrix* PyramidMapMatrix::GetIntensityVarMatrix(unsigned int level) const {
  return &intensity_var_matrixes_[level];
}

inline const FloatMatrix* PyramidMapMatrix::GetAltitudeMatrix(unsigned int level) const {
  return &altitude_matrixes_[level];
}

inline const FloatMatrix* PyramidMapMatrix::GetAltitudeVarMatrix(unsigned int level) const {
  return &altitude_var_matrixes_[level];
}

inline const FloatMatrix* PyramidMapMatrix::GetGroundAltitudeMatrix(unsigned int level) const {
  return &ground_altitude_matrixes_[level];
}

inline const UIntMatrix* PyramidMapMatrix::GetCountMatrix(unsigned int level) const {
  return &count_matrixes_[level];
}

inline const UIntMatrix* PyramidMapMatrix::GetGroundCountMatrix(unsigned int level) const {
  return &ground_count_matrixes_[level];
}
