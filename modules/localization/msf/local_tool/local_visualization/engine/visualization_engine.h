...
struct VisualMapParam {
  void set(const std::vector<float>& map_resolutions,
           ...
           const unsigned int        map_node_size_y,
...
class MapImageCache {
 ...
 public:
  explicit MapImageCache(int capacity)
      : _capacity(capacity) {}
...
class VisualizationEngine {
 ...
 private:
  ...
  void InitOtherParams(const int          x_min,
                       const int          y_min,
                       const int          x_max,
                       const int          y_max,
                       const int          level,
  ...
  inline void QuaternionToEuler(const double quaternion[4], double att[3]) {
    double dcm21 = 2 * (quaternion[2] * quaternion[3] + quaternion[0] * quaternion[1]);
    double dcm20 = 2 * (quaternion[1] * quaternion[3] - quaternion[0] * quaternion[2]);
    double dcm22 = quaternion[0] * quaternion[0] - quaternion[1] * quaternion[1] -
                   quaternion[2] * quaternion[2] + quaternion[3] * quaternion[3];
    double dcm01 = 2 * (quaternion[1] * quaternion[2] - quaternion[0] * quaternion[3]);
