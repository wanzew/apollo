...
int main(int argc, char** argv) {
  ...
  boost_desc.add_options()("help", "produce help message")(
      "basedir", boost::program_options::value<std::string>(), "provide the data base dir");
  ...
  bool                                              success =
      local_visualizer.Init(map_folder, map_visual_folder, pcd_folder, pcd_timestamp_file,
