...
class LocalizationLidarProcess {
 ...
 private:
  ...
  bool
       GetPredictPose(const double lidar_time, TransformD* inspva_pose, ForecastState* forecast_state);
  bool CheckState();
 ...
 private:
  ...
  LocalLidarStatus  local_lidar_status_  = LocalLidarStatus::MSF_LOCAL_LIDAR_UNDEFINED_STATUS;
  LocalLidarQuality local_lidar_quality_ = LocalLidarQuality::MSF_LOCAL_LIDAR_BAD;
