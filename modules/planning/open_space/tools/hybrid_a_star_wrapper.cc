...
HybridAObstacleContainer* CreateObstaclesPtr() { return new HybridAObstacleContainer(); }
HybridAResultContainer*   CreateResultPtr() { return new HybridAResultContainer(); }
...
bool Plan(HybridAStar*              planner_ptr,
...
void GetResult(HybridAResultContainer* result_ptr,
               double*                 x,
               double*                 y,
               double*                 phi,
               double*                 v,
