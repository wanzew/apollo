...
bool DistanceApproachIPOPTRelaxEndInterface::get_bounds_info(
...
bool DistanceApproachIPOPTRelaxEndInterface::get_starting_point(int     n,
                                                                bool    init_x,
                                                                double* x,
                                                                bool    init_z,
                                                                double* z_L,
...
bool DistanceApproachIPOPTRelaxEndInterface::eval_f(int           n,
                                                    const double* x,
                                                    bool          new_x,
                                                    double&       obj_value) {
...
bool DistanceApproachIPOPTRelaxEndInterface::eval_grad_f(int           n,
                                                         const double* x,
                                                         bool          new_x,
                                                         double*       grad_f) {
...
bool DistanceApproachIPOPTRelaxEndInterface::eval_h(int           n,
                                                    const double* x,
                                                    bool          new_x,
                                                    double        obj_factor,
                                                    int           m,
...
//***************    start ADOL-C part ***********************************
template <class T>
void DistanceApproachIPOPTRelaxEndInterface::eval_obj(int n, const T* x, T* obj_value) {
  // Objective is :
  // min control inputs
  // min input rate
...
template <class T>
void DistanceApproachIPOPTRelaxEndInterface::eval_constraints(int n, const T* x, int m, T* g) {
  // state start index
  int state_index = state_start_index_;
...
bool DistanceApproachIPOPTRelaxEndInterface::check_g(int           n,
                                                     const double* x,
                                                     int           m,
                                                     const double* g) {
  int    kN = n;
...
void DistanceApproachIPOPTRelaxEndInterface::generate_tapes(int  n,
                                                            int  m,
                                                            int* nnz_jac_g,
                                                            int* nnz_h_lag) {
