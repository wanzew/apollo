...
DistanceApproachIPOPTFixedDualInterface::DistanceApproachIPOPTFixedDualInterface(
...
bool DistanceApproachIPOPTFixedDualInterface::get_starting_point(int     n,
                                                                 bool    init_x,
                                                                 double* x,
                                                                 bool    init_z,
                                                                 double* z_L,
...
bool DistanceApproachIPOPTFixedDualInterface::eval_f(int           n,
                                                     const double* x,
                                                     bool          new_x,
                                                     double&       obj_value) {
...
bool DistanceApproachIPOPTFixedDualInterface::eval_h(int           n,
                                                     const double* x,
                                                     bool          new_x,
                                                     double        obj_factor,
                                                     int           m,
...
//***************    start ADOL-C part ***********************************
template <class T>
void DistanceApproachIPOPTFixedDualInterface::eval_obj(int n, const T* x, T* obj_value) {
  // Objective is :
  // min control inputs
  // min input rate
...
template <class T>
void DistanceApproachIPOPTFixedDualInterface::eval_constraints(int n, const T* x, int m, T* g) {
  // state start index
  int state_index = state_start_index_;
  ...
  ADEBUG << "constraint_index after adding variable box constraints updated: " << constraint_index;
}

bool DistanceApproachIPOPTFixedDualInterface::check_g(int           n,
                                                      const double* x,
                                                      int           m,
                                                      const double* g) {
  int    kN = n;
...
void DistanceApproachIPOPTFixedDualInterface::generate_tapes(int  n,
                                                             int  m,
                                                             int* nnz_jac_g,
                                                             int* nnz_h_lag) {
