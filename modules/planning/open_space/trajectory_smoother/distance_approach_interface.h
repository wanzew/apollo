...
class DistanceApproachInterface : public Ipopt::TNLP {
 public:
  ...
  virtual bool get_nlp_info(int&            n,
                            int&            m,
                            int&            nnz_jac_g,         // NOLINT
                            int&            nnz_h_lag,         // NOLINT
                            IndexStyleEnum& index_style) = 0;  // NOLINT

  /** Method to return the bounds for my problem */
  virtual bool
  get_bounds_info(int n, double* x_l, double* x_u, int m, double* g_l, double* g_u) = 0;

  /** Method to return the starting point for the algorithm */
  virtual bool get_starting_point(int     n,
                                  bool    init_x,
                                  double* x,
                                  bool    init_z,
                                  double* z_L,
  ...
  virtual bool eval_jac_g_ser(int           n,
                              const double* x,
                              bool          new_x,
                              int           m,
                              int           nele_jac,
  ...
  virtual void get_optimization_results(Eigen::MatrixXd* state_result,
