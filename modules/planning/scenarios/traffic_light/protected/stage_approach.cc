...
Stage::StageStatus
TrafficLightProtectedStageApproach::Process(const TrajectoryPoint& planning_init_point,
                                            Frame*                 frame) {
  ...
  if (!plan_ok) { AERROR << "TrafficLightProtectedStageApproach planning error"; }
