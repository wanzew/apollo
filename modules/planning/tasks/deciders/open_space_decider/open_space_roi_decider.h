...
class OpenSpaceRoiDecider : public Decider {
 ...
 private:
  static bool SelectTargetDeadEndJunction(std::vector<hdmap::JunctionInfoConstPtr>* junctions,
  ...
  void        SetDeadEndPose(Frame* const                            frame,
                             const std::vector<common::math::Vec2d>& dead_end_vertices);
  bool
       GetDeadEndBoundary(Frame* const                                         frame,
                          const std::vector<common::math::Vec2d>&              dead_end_vertices,
  ...
  void GetInLaneBoundaryPoints(hdmap::LaneInfoConstPtr        lane_info,
                               const hdmap::Path&             nearby_path,
                               std::vector<common::PointENU>* In_left_boundary_points,
                               std::vector<common::PointENU>* In_right_boundary_points);
  void GetOutLaneBoundaryPoints(hdmap::LaneInfoConstPtr        lane_info,
                                const hdmap::Path&             nearby_path,
  ...
  void SetOrigin(Frame* const frame, const std::array<common::math::Vec2d, 4>& vertices);
  void SetOriginFromADC(Frame* const frame, const hdmap::Path& nearby_path);
  void SetParkingSpotEndPose(Frame* const                              frame,
  ...
  void GetRoadBoundaryFromMap(const hdmap::Path&                nearby_path,
                              const double                      center_line_s,
                              const common::math::Vec2d&        origin_point,
                              const double                      origin_heading,
                              std::vector<common::math::Vec2d>* left_lane_boundary,
  ...
  void AddBoundaryKeyPoint(const hdmap::Path&                nearby_path,
  ...
  bool
  LoadObstacleInVertices(const std::vector<std::vector<common::math::Vec2d>>& roi_parking_boundary,
                         Frame* const                                         frame);
   ...
   */
  bool IsInParkingLot(const double                        adc_init_x,
