...
class TrajectoryCost {
 ...
 private:
  ...
  ComparableCost
  GetCostFromObsSL(const float adc_s, const float adc_l, const SLBoundary& obs_sl_boundary);

  common::math::Box2d GetBoxFromSLPoint(const common::SLPoint& sl, const float dl) const;
