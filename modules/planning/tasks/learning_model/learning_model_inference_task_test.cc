...
class LearningModelInferenceTaskTest : public ::testing::Test {
 public:
  virtual void SetUp() {
    ...
    auto* inference_config = config_.mutable_learning_model_inference_task_config();
...
TEST_F(LearningModelInferenceTaskTest, Init) {
  ...
  EXPECT_EQ(learning_model_inference_task.Name(), TaskConfig::TaskType_Name(config_.task_type()));
}
