...
class PiecewiseJerkSpeedNonlinearIpoptInterface : public Ipopt::TNLP {
 public:
  PiecewiseJerkSpeedNonlinearIpoptInterface(const double s_init,
  ...
  void
  set_w_target_state(const double w_target_s, const double w_target_v, const double w_target_a);
