...
double StGraphPoint::spatial_potential_cost() const { return spatial_potential_cost_; }
...
void StGraphPoint::SetObstacleCost(const double obs_cost) { obstacle_cost_ = obs_cost; }
...
void StGraphPoint::SetTotalCost(const double total_cost) { total_cost_ = total_cost; }

void StGraphPoint::SetPrePoint(const StGraphPoint& pre_point) { pre_point_ = &pre_point; }

double StGraphPoint::GetOptimalSpeed() const { return optimal_speed_; }

void StGraphPoint::SetOptimalSpeed(const double optimal_speed) { optimal_speed_ = optimal_speed; }
