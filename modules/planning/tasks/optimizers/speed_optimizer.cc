...
SpeedOptimizer::SpeedOptimizer(const TaskConfig& config)
    : Task(config) {}

Status SpeedOptimizer::Execute(Frame* frame, ReferenceLineInfo* reference_line_info) {
...
void SpeedOptimizer::RecordDebugInfo(const SpeedData& speed_data, STGraphDebug* st_graph_debug) {
