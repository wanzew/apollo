...
bool LateralTrajectoryOptimizer::optimize(
  ...
  auto ptr_interface = new LateralTrajectoryOptimizerInterface(
      d_state[0], d_state[1], d_state[2], delta_s, FLAGS_lateral_third_order_derivative_max,
      lateral_bounds);

  ptr_interface->set_objective_weights(FLAGS_weight_lateral_offset, FLAGS_weight_lateral_derivative,
