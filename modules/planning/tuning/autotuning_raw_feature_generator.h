...
class AutotuningRawFeatureGenerator {
 public:
   ...
   */
  common::Status
  EvaluateTrajectory(const std::vector<common::TrajectoryPoint>& trajectory,
   ...
   */
  common::Status
  EvaluateSpeedProfile(const std::vector<common::SpeedPoint>&  speed_profile,
                       autotuning::TrajectoryRawFeature* const trajectory_feature) const;
 ...
 private:
   ...
   */
  void ConvertToDiscretizedBoundaries(const STBoundary& boundary, const double speed);

  common::Status
  EvaluateSpeedPoint(const common::SpeedPoint&                    speed_point,
                     const size_t                                 index,
                     autotuning::TrajectoryPointRawFeature* const trajectory_point_feature) const;
