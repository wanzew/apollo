...
class Spline2dConstraint {
 public:
  ...
  bool Add2dSecondDerivativeBoundary(const std::vector<double>&                      t_coord,
                                     const std::vector<double>&                      angle,
                                     const std::vector<apollo::common::math::Vec2d>& ref_point,
                                     const std::vector<double>& longitudinal_bound,
                                     const std::vector<double>& lateral_bound);
  ...
  bool Add2dThirdDerivativeBoundary(const std::vector<double>&                      t_coord,
                                    const std::vector<double>&                      angle,
                                    const std::vector<apollo::common::math::Vec2d>& ref_point,
                                    const std::vector<double>& longitudinal_bound,
                                    const std::vector<double>& lateral_bound);
 ...
 private:
  ...
  double SignDistance(const apollo::common::math::Vec2d& xy_point, const double angle) const;
  bool   AddPointKthOrderDerivativeConstraint(const double               t,
