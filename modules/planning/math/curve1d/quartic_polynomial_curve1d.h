...
class QuarticPolynomialCurve1d : public PolynomialCurve1d {
 public:
   ...
   * @return       self
   */
  QuarticPolynomialCurve1d& FitWithEndPointFirstOrder(const double x0,
                                                      const double dx0,
                                                      const double ddx0,
                                                      const double x1,
                                                      const double dx1,
   ...
   */
  QuarticPolynomialCurve1d& FitWithEndPointSecondOrder(const double x0,
                                                       const double dx0,
                                                       const double x1,
                                                       const double dx1,
                                                       const double ddx1,
   ...
   */
  QuarticPolynomialCurve1d& IntegratedFromCubicCurve(const PolynomialCurve1d& other,
