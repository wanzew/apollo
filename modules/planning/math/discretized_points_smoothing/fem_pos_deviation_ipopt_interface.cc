...
bool FemPosDeviationIpoptInterface::get_bounds_info(
...
bool FemPosDeviationIpoptInterface::eval_grad_f(int           n,
                                                const double* x,
                                                bool          new_x,
                                                double*       grad_f) {
  CHECK_EQ(static_cast<size_t>(n), num_of_variables_);
...
bool FemPosDeviationIpoptInterface::eval_h(int           n,
                                           const double* x,
                                           bool          new_x,
                                           double        obj_factor,
                                           int           m,
...
void FemPosDeviationIpoptInterface::finalize_solution(Ipopt::SolverReturn               status,
                                                      int                               n,
                                                      const double*                     x,
                                                      const double*                     z_L,
                                                      const double*                     z_U,
...
bool FemPosDeviationIpoptInterface::eval_obj(int n, const T* x, T* obj_value) {
  *obj_value = 0.0;
  ...
  for (size_t i = 0; i + 1 < num_of_points_; ++i) {
    ...
    *obj_value +=
        weight_path_length_ * ((x[findex] - x[nindex]) * (x[findex] - x[nindex]) +
