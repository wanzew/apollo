...
constexpr StopReasonCode StopReasonCode_MAX = STOP_REASON_PULL_OVER;
...
class ObjectDecisionType final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::apollo::planning::ObjectSidePass* release_sidepass();
  ::apollo::planning::ObjectSidePass* mutable_sidepass();
  void set_allocated_sidepass(::apollo::planning::ObjectSidePass* sidepass);
  private:
  const ::apollo::planning::ObjectSidePass& _internal_sidepass() const;
  ::apollo::planning::ObjectSidePass* _internal_mutable_sidepass();
  public:
  void unsafe_arena_set_allocated_sidepass(
      ::apollo::planning::ObjectSidePass* sidepass);
  ::apollo::planning::ObjectSidePass* unsafe_arena_release_sidepass();
...
class MainParking final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:apollo.planning.MainParking) */ {
 public:
  ...
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(const MainParking& from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
...
inline ::apollo::planning::ObjectSidePass* ObjectDecisionType::release_sidepass() {
  ...
  if (_internal_has_sidepass()) {
    clear_has_object_tag();
    ::apollo::planning::ObjectSidePass* temp = _impl_.object_tag_.sidepass_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.object_tag_.sidepass_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::apollo::planning::ObjectSidePass& ObjectDecisionType::_internal_sidepass() const {
  return _internal_has_sidepass()
...
inline ::apollo::planning::ObjectSidePass* ObjectDecisionType::unsafe_arena_release_sidepass() {
  // @@protoc_insertion_point(field_unsafe_arena_release:apollo.planning.ObjectDecisionType.sidepass)
  if (_internal_has_sidepass()) {
    clear_has_object_tag();
    ::apollo::planning::ObjectSidePass* temp = _impl_.object_tag_.sidepass_;
    _impl_.object_tag_.sidepass_ = nullptr;
...
inline void ObjectDecisionType::unsafe_arena_set_allocated_sidepass(::apollo::planning::ObjectSidePass* sidepass) {
  clear_object_tag();
  if (sidepass) {
    set_has_sidepass();
    _impl_.object_tag_.sidepass_ = sidepass;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.planning.ObjectDecisionType.sidepass)
}
inline ::apollo::planning::ObjectSidePass* ObjectDecisionType::_internal_mutable_sidepass() {
  if (!_internal_has_sidepass()) {
    clear_object_tag();
    set_has_sidepass();
    _impl_.object_tag_.sidepass_ = CreateMaybeMessage< ::apollo::planning::ObjectSidePass >(GetArenaForAllocation());
  }
  return _impl_.object_tag_.sidepass_;
}
inline ::apollo::planning::ObjectSidePass* ObjectDecisionType::mutable_sidepass() {
  ::apollo::planning::ObjectSidePass* _msg = _internal_mutable_sidepass();
