...
PROTOBUF_CONSTEXPR SpiralSmootherConfig::SpiralSmootherConfig(
  ...
  , /*decltype(_impl_.max_iteration_)*/1000u
  , /*decltype(_impl_.opt_acceptable_iteration_)*/15u
  , /*decltype(_impl_.opt_acceptable_tol_)*/1e-06
  , /*decltype(_impl_.weight_curve_length_)*/1
  , /*decltype(_impl_.weight_kappa_)*/1
  , /*decltype(_impl_.weight_dkappa_)*/100} {}
...
PROTOBUF_CONSTEXPR DiscretePointsSmootherConfig::DiscretePointsSmootherConfig(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.smoothing_method_)*/2
  , /*decltype(_impl_.SmootherConfig_)*/{}
  , /*decltype(_impl_._oneof_case_)*/{}} {}
struct DiscretePointsSmootherConfigDefaultTypeInternal {
  PROTOBUF_CONSTEXPR DiscretePointsSmootherConfigDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DiscretePointsSmootherConfigDefaultTypeInternal _DiscretePointsSmootherConfig_default_instance_;
PROTOBUF_CONSTEXPR ReferenceLineSmootherConfig::ReferenceLineSmootherConfig(
  ...
  , /*decltype(_impl_.max_lateral_boundary_bound_)*/0.5
  , /*decltype(_impl_.min_lateral_boundary_bound_)*/0.2
  , /*decltype(_impl_.curb_shift_)*/0.2
  , /*decltype(_impl_.lateral_buffer_)*/0.2
...
static ::_pb::Metadata file_level_metadata_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto[4];
...
const uint32_t TableStruct_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::planning::SpiralSmootherConfig, _impl_.weight_curve_length_),
  PROTOBUF_FIELD_OFFSET(::apollo::planning::SpiralSmootherConfig, _impl_.weight_kappa_),
  PROTOBUF_FIELD_OFFSET(::apollo::planning::SpiralSmootherConfig, _impl_.weight_dkappa_),
  0,
  1,
  3,
  2,
  ...
  7,
  8,
  PROTOBUF_FIELD_OFFSET(::apollo::planning::DiscretePointsSmootherConfig, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::apollo::planning::DiscretePointsSmootherConfig, _internal_metadata_),
  ~0u,  // no _extensions_
  PROTOBUF_FIELD_OFFSET(::apollo::planning::DiscretePointsSmootherConfig, _impl_._oneof_case_[0]),
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::apollo::planning::DiscretePointsSmootherConfig, _impl_.smoothing_method_),
  ::_pbi::kInvalidFieldOffsetTag,
  ::_pbi::kInvalidFieldOffsetTag,
  PROTOBUF_FIELD_OFFSET(::apollo::planning::DiscretePointsSmootherConfig, _impl_.SmootherConfig_),
  0,
  ~0u,
  ~0u,
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::planning::ReferenceLineSmootherConfig, _impl_.max_lateral_boundary_bound_),
  PROTOBUF_FIELD_OFFSET(::apollo::planning::ReferenceLineSmootherConfig, _impl_.min_lateral_boundary_bound_),
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::planning::ReferenceLineSmootherConfig, _impl_.lateral_buffer_),
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 16, 31, -1, sizeof(::apollo::planning::SpiralSmootherConfig)},
  { 40, 50, -1, sizeof(::apollo::planning::DiscretePointsSmootherConfig)},
  { 53, 71, -1, sizeof(::apollo::planning::ReferenceLineSmootherConfig)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::apollo::planning::_DiscretePointsSmootherConfig_default_instance_._instance,
...
const char descriptor_table_protodef_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto_deps[2] = {
...
const ::_pbi::DescriptorTable descriptor_table_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto = {
    false, false, 1633, descriptor_table_protodef_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto,
    "modules/planning/proto/reference_line_smoother_config.proto",
    &descriptor_table_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto_once, descriptor_table_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto_deps, 2, 4,
...
SpiralSmootherConfig::SpiralSmootherConfig(const SpiralSmootherConfig& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.weight_curve_length_){}
    , decltype(_impl_.weight_kappa_){}
    , decltype(_impl_.weight_dkappa_){}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.max_deviation_, &from._impl_.max_deviation_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.weight_dkappa_) -
    reinterpret_cast<char*>(&_impl_.max_deviation_)) + sizeof(_impl_.weight_dkappa_));
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 57)) {
          ...
          _impl_.weight_curve_length_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 65)) {
          ...
          _impl_.weight_kappa_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 73)) {
          ...
          _impl_.weight_dkappa_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* SpiralSmootherConfig::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(3, this->_internal_max_iteration(), target);
  }
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(6, this->_internal_opt_acceptable_iteration(), target);
  }

  // optional double weight_curve_length = 7 [default = 1];
  if (cached_has_bits & 0x00000040u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(7, this->_internal_weight_curve_length(), target);
  }

  // optional double weight_kappa = 8 [default = 1];
  if (cached_has_bits & 0x00000080u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(8, this->_internal_weight_kappa(), target);
  }

  // optional double weight_dkappa = 9 [default = 100];
  if (cached_has_bits & 0x00000100u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(9, this->_internal_weight_dkappa(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:apollo.planning.SpiralSmootherConfig)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    // optional uint32 max_iteration = 3 [default = 1000];
    if (cached_has_bits & 0x00000008u) {
      total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_max_iteration());
    }

    // optional uint32 opt_acceptable_iteration = 6 [default = 15];
    if (cached_has_bits & 0x00000010u) {
      total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_opt_acceptable_iteration());
    }
...
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.planning.SpiralSmootherConfig)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000040u) {
      _impl_.weight_curve_length_ = from._impl_.weight_curve_length_;
    }
    if (cached_has_bits & 0x00000080u) {
      _impl_.weight_kappa_ = from._impl_.weight_kappa_;
    }
    _impl_._has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x00000100u) {
...
void SpiralSmootherConfig::InternalSwap(SpiralSmootherConfig* other) {
  ...
  swap(_impl_.weight_curve_length_, other->_impl_.weight_curve_length_);
  swap(_impl_.weight_kappa_, other->_impl_.weight_kappa_);
  swap(_impl_.weight_dkappa_, other->_impl_.weight_dkappa_);
}
...
class DiscretePointsSmootherConfig::_Internal {
 public:
  using HasBits = decltype(std::declval<DiscretePointsSmootherConfig>()._impl_._has_bits_);
...
DiscretePointsSmootherConfig::_Internal::cos_theta_smoothing(const DiscretePointsSmootherConfig* msg) {
  return *msg->_impl_.SmootherConfig_.cos_theta_smoothing_;
}
...
DiscretePointsSmootherConfig::_Internal::fem_pos_deviation_smoothing(const DiscretePointsSmootherConfig* msg) {
  return *msg->_impl_.SmootherConfig_.fem_pos_deviation_smoothing_;
}
...
void DiscretePointsSmootherConfig::clear_cos_theta_smoothing() {
  if (_internal_has_cos_theta_smoothing()) {
    if (GetArenaForAllocation() == nullptr) {
      delete _impl_.SmootherConfig_.cos_theta_smoothing_;
    }
...
void DiscretePointsSmootherConfig::clear_fem_pos_deviation_smoothing() {
  if (_internal_has_fem_pos_deviation_smoothing()) {
    if (GetArenaForAllocation() == nullptr) {
      delete _impl_.SmootherConfig_.fem_pos_deviation_smoothing_;
    }
    clear_has_SmootherConfig();
  }
}
...
DiscretePointsSmootherConfig::DiscretePointsSmootherConfig(const DiscretePointsSmootherConfig& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.smoothing_method_){}
    , decltype(_impl_.SmootherConfig_){}
    , /*decltype(_impl_._oneof_case_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _impl_.smoothing_method_ = from._impl_.smoothing_method_;
  clear_has_SmootherConfig();
...
const char* DiscretePointsSmootherConfig::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
  ...
  switch (SmootherConfig_case()) {
    case kCosThetaSmoothing: {
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(4, _Internal::cos_theta_smoothing(this),
          _Internal::cos_theta_smoothing(this).GetCachedSize(), target, stream);
      break;
    }
    case kFemPosDeviationSmoothing: {
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(5, _Internal::fem_pos_deviation_smoothing(this),
          _Internal::fem_pos_deviation_smoothing(this).GetCachedSize(), target, stream);
      break;
    }
    default: ;
  }
...
// @@protoc_insertion_point(message_byte_size_start:apollo.planning.DiscretePointsSmootherConfig)
  ...
  if (cached_has_bits & 0x00000001u) {
    total_size += 1 +
      ::_pbi::WireFormatLite::EnumSize(this->_internal_smoothing_method());
  }
...
void DiscretePointsSmootherConfig::InternalSwap(DiscretePointsSmootherConfig* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
  swap(_impl_.smoothing_method_, other->_impl_.smoothing_method_);
...
ReferenceLineSmootherConfig::_Internal::discrete_points(const ReferenceLineSmootherConfig* msg) {
  return *msg->_impl_.SmootherConfig_.discrete_points_;
}
...
void ReferenceLineSmootherConfig::set_allocated_discrete_points(::apollo::planning::DiscretePointsSmootherConfig* discrete_points) {
  ...
  if (discrete_points) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(discrete_points);
    if (message_arena != submessage_arena) {
...
ReferenceLineSmootherConfig::ReferenceLineSmootherConfig(const ReferenceLineSmootherConfig& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.max_lateral_boundary_bound_){}
    , decltype(_impl_.min_lateral_boundary_bound_){}
    , decltype(_impl_.curb_shift_){}
    , decltype(_impl_.lateral_buffer_){}
    , decltype(_impl_.resolution_){}
    , decltype(_impl_.SmootherConfig_){}
    , /*decltype(_impl_._oneof_case_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.num_of_total_points_, &from._impl_.num_of_total_points_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.resolution_) -
    reinterpret_cast<char*>(&_impl_.num_of_total_points_)) + sizeof(_impl_.resolution_));
  clear_has_SmootherConfig();
  switch (from.SmootherConfig_case()) {
    case kQpSpline: {
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 25)) {
          ...
          _impl_.max_lateral_boundary_bound_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 33)) {
          ...
          _impl_.min_lateral_boundary_bound_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 57)) {
          ...
          _impl_.lateral_buffer_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* ReferenceLineSmootherConfig::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(3, this->_internal_max_lateral_boundary_bound(), target);
  }

  // optional double min_lateral_boundary_bound = 4 [default = 0.2];
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(4, this->_internal_min_lateral_boundary_bound(), target);
  }

  // optional uint32 num_of_total_points = 5 [default = 500];
  if (cached_has_bits & 0x00000001u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(5, this->_internal_num_of_total_points(), target);
  }

  // optional double curb_shift = 6 [default = 0.2];
  if (cached_has_bits & 0x00000020u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(6, this->_internal_curb_shift(), target);
  }

  // optional double lateral_buffer = 7 [default = 0.2];
  if (cached_has_bits & 0x00000040u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(7, this->_internal_lateral_buffer(), target);
  }
  ...
  switch (SmootherConfig_case()) {
    ...
    case kDiscretePoints: {
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(22, _Internal::discrete_points(this),
          _Internal::discrete_points(this).GetCachedSize(), target, stream);
      break;
    }
    default: ;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.planning.ReferenceLineSmootherConfig)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      _impl_.max_lateral_boundary_bound_ = from._impl_.max_lateral_boundary_bound_;
    }
    if (cached_has_bits & 0x00000010u) {
      _impl_.min_lateral_boundary_bound_ = from._impl_.min_lateral_boundary_bound_;
    }
    if (cached_has_bits & 0x00000020u) {
      _impl_.curb_shift_ = from._impl_.curb_shift_;
    }
    if (cached_has_bits & 0x00000040u) {
      _impl_.lateral_buffer_ = from._impl_.lateral_buffer_;
    }
    if (cached_has_bits & 0x00000080u) {
...
void ReferenceLineSmootherConfig::InternalSwap(ReferenceLineSmootherConfig* other) {
  ...
  swap(_impl_.max_lateral_boundary_bound_, other->_impl_.max_lateral_boundary_bound_);
  swap(_impl_.min_lateral_boundary_bound_, other->_impl_.min_lateral_boundary_bound_);
  swap(_impl_.curb_shift_, other->_impl_.curb_shift_);
  swap(_impl_.lateral_buffer_, other->_impl_.lateral_buffer_);
...
::PROTOBUF_NAMESPACE_ID::Metadata ReferenceLineSmootherConfig::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto_getter, &descriptor_table_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto_once,
      file_level_metadata_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto[3]);
}
...
template<> PROTOBUF_NOINLINE ::apollo::planning::DiscretePointsSmootherConfig*
Arena::CreateMaybeMessage< ::apollo::planning::DiscretePointsSmootherConfig >(Arena* arena) {
