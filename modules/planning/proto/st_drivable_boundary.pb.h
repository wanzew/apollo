...
class STDrivableBoundaryInstance final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR STDrivableBoundaryInstance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class STDrivableBoundary final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR STDrivableBoundary(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline int STDrivableBoundary::_internal_st_boundary_size() const {
  return _impl_.st_boundary_.size();
}
...
inline ::apollo::planning::STDrivableBoundaryInstance* STDrivableBoundary::mutable_st_boundary(int index) {
  ...
  return _impl_.st_boundary_.Mutable(index);
}
...
inline ::apollo::planning::STDrivableBoundaryInstance* STDrivableBoundary::_internal_add_st_boundary() {
  return _impl_.st_boundary_.Add();
}
inline ::apollo::planning::STDrivableBoundaryInstance* STDrivableBoundary::add_st_boundary() {
  ::apollo::planning::STDrivableBoundaryInstance* _add = _internal_add_st_boundary();
