...
static ::_pb::Metadata file_level_metadata_modules_2fplanning_2fproto_2fdecision_2eproto[23];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_modules_2fplanning_2fproto_2fdecision_2eproto[5];
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 100, -1, -1, sizeof(::apollo::planning::ObjectDecisionType)},
  { 115, 124, -1, sizeof(::apollo::planning::ObjectDecision)},
  { 127, -1, -1, sizeof(::apollo::planning::ObjectDecisions)},
  { 134, 145, -1, sizeof(::apollo::planning::MainStop)},
  { 150, -1, -1, sizeof(::apollo::planning::EmergencyStopHardBrake)},
  { 156, -1, -1, sizeof(::apollo::planning::EmergencyStopCruiseToStop)},
  { 162, 173, -1, sizeof(::apollo::planning::MainEmergencyStop)},
  { 177, 184, -1, sizeof(::apollo::planning::MainCruise)},
  { 185, 195, -1, sizeof(::apollo::planning::MainChangeLane)},
  { 199, 207, -1, sizeof(::apollo::planning::MainMissionComplete)},
  { 209, 216, -1, sizeof(::apollo::planning::MainNotReady)},
  { 217, -1, -1, sizeof(::apollo::planning::MainParking)},
  { 223, -1, -1, sizeof(::apollo::planning::MainDecision)},
  { 238, 247, -1, sizeof(::apollo::planning::DecisionResult)},
};
...
const char descriptor_table_protodef_modules_2fplanning_2fproto_2fdecision_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ng.ObjectNudgeH\000\0223\n\010sidepass\030\007 \001(\0132\037.apo"
  "llo.planning.ObjectSidePassH\000\022-\n\005avoid\030\010"
  " \001(\0132\034.apollo.planning.ObjectAvoidH\000B\014\n\n"
  "object_tag\"q\n\016ObjectDecision\022\n\n\002id\030\001 \001(\t"
  "\022\025\n\rperception_id\030\002 \001(\005\022<\n\017object_decisi"
  "on\030\003 \003(\0132#.apollo.planning.ObjectDecisio"
  "nType\"D\n\017ObjectDecisions\0221\n\010decision\030\001 \003"
  "(\0132\037.apollo.planning.ObjectDecision\"\315\001\n\010"
  "MainStop\0224\n\013reason_code\030\001 \001(\0162\037.apollo.p"
  "lanning.StopReasonCode\022\016\n\006reason\030\002 \001(\t\022+"
  "\n\nstop_point\030\003 \001(\0132\027.apollo.common.Point"
  "ENU\022\024\n\014stop_heading\030\004 \001(\001\0228\n\020change_lane"
  "_type\030\005 \001(\0162\036.apollo.routing.ChangeLaneT"
  "ype\"\030\n\026EmergencyStopHardBrake\"\033\n\031Emergen"
  "cyStopCruiseToStop\"\237\003\n\021MainEmergencyStop"
  "\022B\n\013reason_code\030\001 \001(\0162-.apollo.planning."
  "MainEmergencyStop.ReasonCode\022\016\n\006reason\030\002"
  " \001(\t\022=\n\nhard_brake\030\003 \001(\0132\'.apollo.planni"
  "ng.EmergencyStopHardBrakeH\000\022D\n\016cruise_to"
  "_stop\030\004 \001(\0132*.apollo.planning.EmergencyS"
  "topCruiseToStopH\000\"\250\001\n\nReasonCode\022\035\n\031ESTO"
  "P_REASON_INTERNAL_ERR\020\001\022\032\n\026ESTOP_REASON_"
  "COLLISION\020\002\022\035\n\031ESTOP_REASON_ST_FIND_PATH"
  "\020\003\022!\n\035ESTOP_REASON_ST_MAKE_DECISION\020\004\022\035\n"
  "\031ESTOP_REASON_SENSOR_ERROR\020\005B\006\n\004task\"F\n\n"
  "MainCruise\0228\n\020change_lane_type\030\001 \001(\0162\036.a"
  "pollo.routing.ChangeLaneType\"\377\001\n\016MainCha"
  "ngeLane\0222\n\004type\030\001 \001(\0162$.apollo.planning."
  "MainChangeLane.Type\0221\n\014default_lane\030\002 \003("
  "\0132\033.apollo.planning.TargetLane\0224\n\021defaul"
  "t_lane_stop\030\003 \001(\0132\031.apollo.planning.Main"
  "Stop\0223\n\020target_lane_stop\030\004 \001(\0132\031.apollo."
  "planning.MainStop\"\033\n\004Type\022\010\n\004LEFT\020\001\022\t\n\005R"
  "IGHT\020\002\"X\n\023MainMissionComplete\022+\n\nstop_po"
  "int\030\001 \001(\0132\027.apollo.common.PointENU\022\024\n\014st"
...
const ::_pbi::DescriptorTable descriptor_table_modules_2fplanning_2fproto_2fdecision_2eproto = {
    false, false, 3866, descriptor_table_protodef_modules_2fplanning_2fproto_2fdecision_2eproto,
    "modules/planning/proto/decision.proto",
    &descriptor_table_modules_2fplanning_2fproto_2fdecision_2eproto_once, descriptor_table_modules_2fplanning_2fproto_2fdecision_2eproto_deps, 3, 23,
...
class ObjectDecisionType::_Internal {
 public:
  ...
  static const ::apollo::planning::ObjectSidePass& sidepass(const ObjectDecisionType* msg);
...
ObjectDecisionType::_Internal::sidepass(const ObjectDecisionType* msg) {
  return *msg->_impl_.object_tag_.sidepass_;
}
...
void ObjectDecisionType::set_allocated_sidepass(::apollo::planning::ObjectSidePass* sidepass) {
  ...
  if (sidepass) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(sidepass);
    if (message_arena != submessage_arena) {
      sidepass = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, sidepass, submessage_arena);
    }
    set_has_sidepass();
    _impl_.object_tag_.sidepass_ = sidepass;
  }
...
ObjectDecisionType::ObjectDecisionType(const ObjectDecisionType& from)
  ...
  switch (from.object_tag_case()) {
    ...
    case kSidepass: {
      _internal_mutable_sidepass()->::apollo::planning::ObjectSidePass::MergeFrom(from._internal_sidepass());
      break;
    }
    case kAvoid: {
...
// @@protoc_insertion_point(one_of_clear_start:apollo.planning.ObjectDecisionType)
  switch (object_tag_case()) {
    ...
    case kSidepass: {
      if (GetArenaForAllocation() == nullptr) {
        delete _impl_.object_tag_.sidepass_;
      }
      break;
    }
    case kAvoid: {
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 50)) {
          ...
          goto handle_unusual;
        continue;
      // .apollo.planning.ObjectSidePass sidepass = 7;
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 58)) {
          ptr = ctx->ParseMessage(_internal_mutable_sidepass(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      // .apollo.planning.ObjectAvoid avoid = 8;
      case 8:
...
uint8_t* ObjectDecisionType::_InternalSerialize(
  ...
  switch (object_tag_case()) {
    ...
    case kSidepass: {
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(7, _Internal::sidepass(this),
          _Internal::sidepass(this).GetCachedSize(), target, stream);
      break;
    }
    case kAvoid: {
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(8, _Internal::avoid(this),
