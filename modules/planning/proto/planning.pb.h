...
class RSSInfo final :
 ...
 public:
  ...
  ~RSSInfo() override;
  explicit PROTOBUF_CONSTEXPR RSSInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  RSSInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class ADCTrajectory final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::apollo::planning::RSSInfo* release_rss_info();
...
inline ::apollo::planning::ADCTrajectory_TrajectoryType ADCTrajectory::_internal_trajectory_type() const {
  return static_cast< ::apollo::planning::ADCTrajectory_TrajectoryType >(_impl_.trajectory_type_);
}
...
void ADCTrajectory::set_replan_reason(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.replan_reason_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ADCTrajectory::_internal_set_replan_reason(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.replan_reason_.Set(value, GetArenaForAllocation());
}
inline std::string* ADCTrajectory::_internal_mutable_replan_reason() {
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.replan_reason_.Mutable(GetArenaForAllocation());
}
inline std::string* ADCTrajectory::release_replan_reason() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.replan_reason_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void ADCTrajectory::set_allocated_replan_reason(std::string* replan_reason) {
  ...
  _impl_.replan_reason_.SetAllocated(replan_reason, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.replan_reason_.IsDefault()) {
    _impl_.replan_reason_.Set("", GetArenaForAllocation());
  }
...
inline int ADCTrajectory::_internal_target_lane_id_size() const {
  return _impl_.target_lane_id_.size();
}
...
inline ::apollo::hdmap::Id* ADCTrajectory::mutable_target_lane_id(int index) {
  ...
  return _impl_.target_lane_id_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::apollo::hdmap::Id >*
...
inline ::apollo::hdmap::Id* ADCTrajectory::_internal_add_target_lane_id() {
  return _impl_.target_lane_id_.Add();
}
inline ::apollo::hdmap::Id* ADCTrajectory::add_target_lane_id() {
  ::apollo::hdmap::Id* _add = _internal_add_target_lane_id();
...
inline const ::apollo::planning::RSSInfo& ADCTrajectory::_internal_rss_info() const {
  const ::apollo::planning::RSSInfo* p = _impl_.rss_info_;
...
inline void ADCTrajectory::unsafe_arena_set_allocated_rss_info(
    ::apollo::planning::RSSInfo* rss_info) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.rss_info_);
  }
  _impl_.rss_info_ = rss_info;
  if (rss_info) {
    _impl_._has_bits_[0] |= 0x00000200u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000200u;
...
inline ::apollo::planning::RSSInfo* ADCTrajectory::release_rss_info() {
  _impl_._has_bits_[0] &= ~0x00000200u;
  ::apollo::planning::RSSInfo* temp = _impl_.rss_info_;
...
inline ::apollo::planning::RSSInfo* ADCTrajectory::_internal_mutable_rss_info() {
  ...
  if (_impl_.rss_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::planning::RSSInfo>(GetArenaForAllocation());
    _impl_.rss_info_ = p;
  }
  return _impl_.rss_info_;
}
inline ::apollo::planning::RSSInfo* ADCTrajectory::mutable_rss_info() {
  ::apollo::planning::RSSInfo* _msg = _internal_mutable_rss_info();
...
inline void ADCTrajectory::set_allocated_rss_info(::apollo::planning::RSSInfo* rss_info) {
  ...
  if (rss_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(rss_info);
    if (message_arena != submessage_arena) {
