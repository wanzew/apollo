...
class PadMessage final :
 ...
 public:
  ...
  ~PadMessage() override;
  explicit PROTOBUF_CONSTEXPR PadMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PadMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline ::apollo::planning::DrivingAction PadMessage::_internal_action() const {
  return static_cast< ::apollo::planning::DrivingAction >(_impl_.action_);
}
