...
PROTOBUF_CONSTEXPR SLBoundary::SLBoundary(
  ...
  , /*decltype(_impl_.boundary_point_)*/{}
...
const uint32_t TableStruct_modules_2fplanning_2fproto_2fsl_5fboundary_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::planning::SLBoundary, _impl_.boundary_point_),
  0,
  1,
  2,
  3,
...
const char descriptor_table_protodef_modules_2fplanning_2fproto_2fsl_5fboundary_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_modules_2fplanning_2fproto_2fsl_5fboundary_2eproto_deps[1] = {
...
const ::_pbi::DescriptorTable descriptor_table_modules_2fplanning_2fproto_2fsl_5fboundary_2eproto = {
    false, false, 223, descriptor_table_protodef_modules_2fplanning_2fproto_2fsl_5fboundary_2eproto,
...
SLBoundary::SLBoundary(const SLBoundary& from)
  ...
  new (&_impl_) Impl_{
    ...
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.boundary_point_){from._impl_.boundary_point_}
...
inline void SLBoundary::SharedCtor(
  ...
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.boundary_point_){arena}
    , decltype(_impl_.start_s_){0}
    , decltype(_impl_.end_s_){0}
    , decltype(_impl_.start_l_){0}
    , decltype(_impl_.end_l_){0}
...
inline void SLBoundary::SharedDtor() {
  ...
  _impl_.boundary_point_.~RepeatedPtrField();
}
...
uint8_t* SLBoundary::_InternalSerialize(
  ...
  // repeated .apollo.common.SLPoint boundary_point = 5;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_boundary_point_size()); i < n; i++) {
    const auto& repfield = this->_internal_boundary_point(i);
...
// @@protoc_insertion_point(message_byte_size_start:apollo.planning.SLBoundary)
  ...
  for (const auto& msg : this->_impl_.boundary_point_) {
    total_size +=
...
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.planning.SLBoundary)
  ...
  _impl_.boundary_point_.MergeFrom(from._impl_.boundary_point_);
...
void SLBoundary::InternalSwap(SLBoundary* other) {
  ...
  _impl_.boundary_point_.InternalSwap(&other->_impl_.boundary_point_);
