...
Obstacle* PathDecision::Find(const std::string& object_id) { return obstacles_.Find(object_id); }
...
PathDecision::FindPerceptionObstacle(const std::string& perception_obstacle_id) const {
