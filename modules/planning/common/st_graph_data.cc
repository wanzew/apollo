...
double StGraphData::min_s_on_st_boundaries() const { return min_s_on_st_boundaries_; }
...
planning_internal::STGraphDebug* StGraphData::mutable_st_graph_debug() { return st_graph_debug_; }
...
bool StGraphData::SetSTDrivableBoundary(
  ...
  if (s_boundary.size() != v_obs_info.size()) { return false; }
