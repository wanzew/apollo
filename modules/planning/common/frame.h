...
class Frame {
 public:
  ...
  const DiscretizedPath& current_frame_planned_path() const { return current_frame_planned_path_; }
  ...
  const DrivingAction& GetPadMsgDrivingAction() const { return pad_msg_driving_action_; }
