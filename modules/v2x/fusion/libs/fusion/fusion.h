...
class Fusion {
 public:
  ...
  std::vector<std::vector<base::Object>>& get_fusion_result() { return fusion_result_; }
  ...
  bool GetV2xFusionObjects(const std::vector<std::vector<base::Object>>& fusion_result,
                           std::vector<base::Object>*                    fused_objects);
 ...
 private:
  ...
  double CheckOdistance(const base::Object& in1_ptr, const base::Object& in2_ptr);
  bool   CheckDisScore(const base::Object& in1_ptr, const base::Object& in2_ptr, double* score);
  bool   CheckTypeScore(const base::Object& in1_ptr, const base::Object& in2_ptr, double* score);
