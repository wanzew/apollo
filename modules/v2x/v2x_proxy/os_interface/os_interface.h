...
class OsInterFace {
 public:
  ...
  void
  GetLocalizationFromOs(const std::shared_ptr<::apollo::localization::LocalizationEstimate>& msg);
  ...
  void
  SendV2xTrafficLightToOs(const std::shared_ptr<::apollo::v2x::IntersectionTrafficLightData>& msg);
 ...
 private:
  ...
  std::shared_ptr<::apollo::cyber::Reader<::apollo::planning::ADCTrajectory>> planning_reader_ =
      nullptr;
  std::shared_ptr<::apollo::cyber::Writer<::apollo::v2x::obu::ObuTrafficLight>>
      v2x_obu_traffic_light_writer_ = nullptr;
  std::shared_ptr<::apollo::cyber::Writer<::apollo::v2x::IntersectionTrafficLightData>>
      v2x_traffic_light_writer_ = nullptr;
  std::shared_ptr<::apollo::cyber::Writer<::apollo::perception::TrafficLightDetection>>
