...
void Scuepb310::Parse(const std::uint8_t* bytes, int32_t length, ChassisDetail* chassis) const {
  chassis->mutable_ge3()->mutable_scu_epb_310()->set_epb_intidx(epb_intidx(bytes, length));
  chassis->mutable_ge3()->mutable_scu_epb_310()->set_epb_drvmode(epb_drvmode(bytes, length));
  chassis->mutable_ge3()->mutable_scu_epb_310()->set_epb_sysst(epb_sysst(bytes, length));
  chassis->mutable_ge3()->mutable_scu_epb_310()->set_epb_faultst(epb_faultst(bytes, length));
}
...
Scu_epb_310::Epb_intidxType Scuepb310::epb_intidx(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 1);
...
Scu_epb_310::Epb_drvmodeType Scuepb310::epb_drvmode(const std::uint8_t* bytes,
  ...
  Scu_epb_310::Epb_drvmodeType ret = static_cast<Scu_epb_310::Epb_drvmodeType>(x);
  return ret;
}
...
// 'motorola', 'physical_unit': ''}
Scu_epb_310::Epb_sysstType Scuepb310::epb_sysst(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
  int32_t x = t0.get_byte(0, 3);
...
Scu_epb_310::Epb_faultstType Scuepb310::epb_faultst(const std::uint8_t* bytes,
  ...
  Scu_epb_310::Epb_faultstType ret = static_cast<Scu_epb_310::Epb_faultstType>(x);
  return ret;
}
}  // namespace ge3
}  // namespace canbus
