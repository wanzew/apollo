...
class Scuepb310 : public ::apollo::drivers::canbus::ProtocolData<::apollo::canbus::ChassisDetail> {
 public:
 ...
 private:
  ...
  Scu_epb_310::Epb_intidxType epb_intidx(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Scu_epb_310::Epb_drvmodeType epb_drvmode(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Scu_epb_310::Epb_sysstType epb_sysst(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Scu_epb_310::Epb_faultstType epb_faultst(const std::uint8_t* bytes, const int32_t length) const;
};
