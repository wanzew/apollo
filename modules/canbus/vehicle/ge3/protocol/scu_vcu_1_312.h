...
class Scuvcu1312 : public ::apollo::drivers::canbus::ProtocolData<::apollo::canbus::ChassisDetail> {
 public:
 ...
 private:
  ...
  // 'physical_unit': ''}
  Scu_vcu_1_312::Vcu_elcsysfaultType vcu_elcsysfault(const std::uint8_t* bytes,
  ...
  Scu_vcu_1_312::Vcu_intidxType vcu_intidx(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Scu_vcu_1_312::Vcu_geardrvmodeType vcu_geardrvmode(const std::uint8_t* bytes,
                                                     const int32_t       length) const;
  ...
  Scu_vcu_1_312::Vcu_faultstType vcu_faultst(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Scu_vcu_1_312::Vcu_drvmodeType vcu_drvmode(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Scu_vcu_1_312::Vcu_gearpstType vcu_gearpst(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Scu_vcu_1_312::Vcu_gearfaultstType vcu_gearfaultst(const std::uint8_t* bytes,
                                                     const int32_t       length) const;
  ...
  // 'physical_unit': ''}
  Scu_vcu_1_312::Vcu_gearactType vcu_gearact(const std::uint8_t* bytes, const int32_t length) const;
};
