...
class Pcbcm201 : public ::apollo::drivers::canbus::ProtocolData<::apollo::canbus::ChassisDetail> {
 public:
 ...
 private:
  ...
  // 'physical_range': '[0|1]', 'bit': 2, 'type': 'enum', 'order': 'motorola',
  // 'physical_unit': ''}
  void set_p_pc_lowbeamreq(uint8_t* data, Pc_bcm_201::Pc_lowbeamreqType pc_lowbeamreq);
  ...
  // 'physical_range': '[0|1]', 'bit': 3, 'type': 'enum', 'order': 'motorola',
  // 'physical_unit': ''}
  void set_p_pc_highbeamreq(uint8_t* data, Pc_bcm_201::Pc_highbeamreqType pc_highbeamreq);
  ...
  // False, 'offset': 0.0, 'physical_range': '[0|3]', 'bit': 4, 'type': 'enum',
  // 'order': 'motorola', 'physical_unit': ''}
  void set_p_pc_rightturnlampreq(uint8_t*                            data,
  ...
  // 0.0, 'physical_range': '[0|1]', 'bit': 5, 'type': 'enum', 'order':
  // 'motorola', 'physical_unit': ''}
  void set_p_pc_leftturnlampreq(uint8_t*                           data,
  ...
  // 0.0, 'physical_range': '[0|1]', 'bit': 7, 'type': 'enum', 'order':
  // 'motorola', 'physical_unit': ''}
  void set_p_pc_hazardlampreq(uint8_t* data, Pc_bcm_201::Pc_hazardlampreqType pc_hazardlampreq);
