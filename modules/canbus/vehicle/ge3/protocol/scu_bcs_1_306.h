...
class Scubcs1306 : public ::apollo::drivers::canbus::ProtocolData<::apollo::canbus::ChassisDetail> {
 public:
 ...
 private:
  ...
  Scu_bcs_1_306::Bcs_aebavailableType bcs_aebavailable(const std::uint8_t* bytes,
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Scu_bcs_1_306::Bcs_cddavailableType bcs_cddavailable(const std::uint8_t* bytes,
                                                       const int32_t       length) const;
  ...
  Scu_bcs_1_306::Bcs_intidxType bcs_intidx(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Scu_bcs_1_306::Bcs_vdcactivestType bcs_vdcactivest(const std::uint8_t* bytes,
                                                     const int32_t       length) const;
  ...
  // 'physical_unit': ''}
  Scu_bcs_1_306::Bcs_absactivestType bcs_absactivest(const std::uint8_t* bytes,
                                                     const int32_t       length) const;
  ...
  // 'physical_unit': ''}
  Scu_bcs_1_306::Bcs_faultstType bcs_faultst(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Scu_bcs_1_306::Bcs_drvmodeType bcs_drvmode(const std::uint8_t* bytes, const int32_t length) const;
};
