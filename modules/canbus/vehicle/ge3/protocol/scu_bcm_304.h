...
class Scubcm304 : public ::apollo::drivers::canbus::ProtocolData<::apollo::canbus::ChassisDetail> {
 public:
 ...
 private:
  ...
  Scu_bcm_304::Bcm_vehreversestType bcm_vehreversest(const std::uint8_t* bytes,
  ...
  // 'order': 'motorola', 'physical_unit': '-'}
  Scu_bcm_304::Bcm_rightturnlampstType bcm_rightturnlampst(const std::uint8_t* bytes,
                                                           const int32_t       length) const;
  ...
  // 'order': 'motorola', 'physical_unit': '-'}
  Scu_bcm_304::Bcm_rearfoglampstType bcm_rearfoglampst(const std::uint8_t* bytes,
                                                       const int32_t       length) const;
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Scu_bcm_304::Bcm_parkinglampstType bcm_parkinglampst(const std::uint8_t* bytes,
                                                       const int32_t       length) const;
  ...
  // 'order': 'motorola', 'physical_unit': '-'}
  Scu_bcm_304::Bcm_leftturnlampstType bcm_leftturnlampst(const std::uint8_t* bytes,
                                                         const int32_t       length) const;
  ...
  // 'order': 'motorola', 'physical_unit': '-'}
  Scu_bcm_304::Bcm_keystType bcm_keyst(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': '-'}
  Scu_bcm_304::Bcm_hornstType bcm_hornst(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Scu_bcm_304::Bcm_hazardlampstType bcm_hazardlampst(const std::uint8_t* bytes,
                                                     const int32_t       length) const;
  ...
  // 'order': 'motorola', 'physical_unit': '-'}
  Scu_bcm_304::Bcm_frontfoglampstType bcm_frontfoglampst(const std::uint8_t* bytes,
                                                         const int32_t       length) const;
  ...
  Scu_bcm_304::Bcm_brakelightswitchstType bcm_brakelightswitchst(const std::uint8_t* bytes,
                                                                 const int32_t       length) const;
};
