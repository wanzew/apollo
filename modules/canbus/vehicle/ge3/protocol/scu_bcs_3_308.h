...
class Scubcs3308 : public ::apollo::drivers::canbus::ProtocolData<::apollo::canbus::ChassisDetail> {
 public:
 ...
 private:
  ...
  Scu_bcs_3_308::Bcs_rrwheelspdvdType bcs_rrwheelspdvd(const std::uint8_t* bytes,
  ...
  // 'physical_unit': '-'}
  Scu_bcs_3_308::Bcs_rrwheeldirectionvdType bcs_rrwheeldirectionvd(const std::uint8_t* bytes,
                                                                   const int32_t length) const;
  ...
  // 'order': 'motorola', 'physical_unit': '-'}
  Scu_bcs_3_308::Bcs_rlwheelspdvdType bcs_rlwheelspdvd(const std::uint8_t* bytes,
                                                       const int32_t       length) const;
  ...
  // 'physical_unit': '-'}
  Scu_bcs_3_308::Bcs_rlwheeldirectionvdType bcs_rlwheeldirectionvd(const std::uint8_t* bytes,
                                                                   const int32_t length) const;
  ...
  // 'order': 'motorola', 'physical_unit': '-'}
  Scu_bcs_3_308::Bcs_frwheelspdvdType bcs_frwheelspdvd(const std::uint8_t* bytes,
                                                       const int32_t       length) const;
  ...
  // 'physical_unit': '-'}
  Scu_bcs_3_308::Bcs_frwheeldirectionvdType bcs_frwheeldirectionvd(const std::uint8_t* bytes,
                                                                   const int32_t length) const;
  ...
  // 'order': 'motorola', 'physical_unit': '-'}
  Scu_bcs_3_308::Bcs_flwheelspdvdType bcs_flwheelspdvd(const std::uint8_t* bytes,
                                                       const int32_t       length) const;
  ...
  // 'physical_unit': '-'}
  Scu_bcs_3_308::Bcs_flwheeldirectionvdType bcs_flwheeldirectionvd(const std::uint8_t* bytes,
                                                                   const int32_t length) const;
  ...
  Scu_bcs_3_308::Bcs_rrwheeldirectionType bcs_rrwheeldirection(const std::uint8_t* bytes,
                                                               const int32_t       length) const;
  ...
  Scu_bcs_3_308::Bcs_rlwheeldirectionType bcs_rlwheeldirection(const std::uint8_t* bytes,
                                                               const int32_t       length) const;
  ...
  Scu_bcs_3_308::Bcs_frwheeldirectionType bcs_frwheeldirection(const std::uint8_t* bytes,
                                                               const int32_t       length) const;
  ...
  Scu_bcs_3_308::Bcs_flwheeldirectionType bcs_flwheeldirection(const std::uint8_t* bytes,
                                                               const int32_t       length) const;
};
