...
TEST_F(Neolix_eduMessageManagerTest, Adsbrakecommand46) {
  ...
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Adsbrakecommand46::ID);
...
TEST_F(Neolix_eduMessageManagerTest, Vcuvehiclefaultresponse201) {
  ...
  EXPECT_NE(pd, nullptr);
  EXPECT_EQ(static_cast<Vcuvehiclefaultresponse201*>(pd)->ID, Vcuvehiclefaultresponse201::ID);
}
TEST_F(Neolix_eduMessageManagerTest, Vcuvehicleinforesponse502) {
  ...
  EXPECT_NE(pd, nullptr);
  EXPECT_EQ(static_cast<Vcuvehicleinforesponse502*>(pd)->ID, Vcuvehicleinforesponse502::ID);
}
TEST_F(Neolix_eduMessageManagerTest, Vcuvehiclestatusreport101) {
  ...
  EXPECT_NE(pd, nullptr);
  EXPECT_EQ(static_cast<Vcuvehiclestatusreport101*>(pd)->ID, Vcuvehiclestatusreport101::ID);
}
TEST_F(Neolix_eduMessageManagerTest, Aebdiagnosis1626) {
  Neolix_eduMessageManager     manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Aebdiagnosis1626::ID);
  EXPECT_NE(pd, nullptr);
  EXPECT_EQ(static_cast<Aebdiagnosis1626*>(pd)->ID, Aebdiagnosis1626::ID);
}
TEST_F(Neolix_eduMessageManagerTest, Aebdiagresp718) {
  Neolix_eduMessageManager     manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Aebdiagresp718::ID);
  EXPECT_NE(pd, nullptr);
  EXPECT_EQ(static_cast<Aebdiagresp718*>(pd)->ID, Aebdiagresp718::ID);
}
TEST_F(Neolix_eduMessageManagerTest, Aebfrontwheelspeed353) {
  Neolix_eduMessageManager     manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Aebfrontwheelspeed353::ID);
  EXPECT_NE(pd, nullptr);
  EXPECT_EQ(static_cast<Aebfrontwheelspeed353*>(pd)->ID, Aebfrontwheelspeed353::ID);
}
TEST_F(Neolix_eduMessageManagerTest, Aebrearwheelspeed354) {
  Neolix_eduMessageManager     manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Aebrearwheelspeed354::ID);
  EXPECT_NE(pd, nullptr);
  EXPECT_EQ(static_cast<Aebrearwheelspeed354*>(pd)->ID, Aebrearwheelspeed354::ID);
}
TEST_F(Neolix_eduMessageManagerTest, Aebwheelimpulse355) {
  Neolix_eduMessageManager     manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Aebwheelimpulse355::ID);
  EXPECT_NE(pd, nullptr);
  EXPECT_EQ(static_cast<Aebwheelimpulse355*>(pd)->ID, Aebwheelimpulse355::ID);
}
TEST_F(Neolix_eduMessageManagerTest, Pas1stdata311) {
  Neolix_eduMessageManager     manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Pas1stdata311::ID);
  EXPECT_NE(pd, nullptr);
  EXPECT_EQ(static_cast<Pas1stdata311*>(pd)->ID, Pas1stdata311::ID);
}
TEST_F(Neolix_eduMessageManagerTest, Pas2nddata312) {
  Neolix_eduMessageManager     manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Pas2nddata312::ID);
  EXPECT_NE(pd, nullptr);
