...
void Pas1stdata311::Parse(const std::uint8_t* bytes, int32_t length, ChassisDetail* chassis) const {
  ...
  chassis->mutable_neolix_edu()->mutable_pas_1st_data_311()->set_pas_f1_status(
  ...
  chassis->mutable_neolix_edu()->mutable_pas_1st_data_311()->set_pas_f4_status(
      pas_f4_status(bytes, length));
  chassis->mutable_neolix_edu()->mutable_pas_1st_data_311()->set_pasdistance2(
      pasdistance2(bytes, length));
  chassis->mutable_neolix_edu()->mutable_pas_1st_data_311()->set_pasdistance1(
...
double Pas1stdata311::pasdistance4(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 4);
...
// 'motorola', 'physical_unit': 'cm'}
double Pas1stdata311::pasdistance3(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 3);
  int32_t x = t0.get_byte(0, 8);
...
// 'physical_unit': 'bit'}
bool Pas1stdata311::pas_f1_status(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// 'physical_unit': 'bit'}
bool Pas1stdata311::pas_f2_status(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// 'physical_unit': 'bit'}
bool Pas1stdata311::pas_f3_status(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// 'physical_unit': 'bit'}
bool Pas1stdata311::pas_f4_status(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// 'motorola', 'physical_unit': 'cm'}
double Pas1stdata311::pasdistance2(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 2);
  int32_t x = t0.get_byte(0, 8);
...
double Pas1stdata311::pasdistance1(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 1);
  int32_t x = t0.get_byte(0, 8);
