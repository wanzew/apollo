...
void Vcuvehiclestatusreport101::Parse(const std::uint8_t* bytes,
                                      int32_t             length,
                                      ChassisDetail*      chassis) const {
  chassis->mutable_neolix_edu()->mutable_vcu_vehicle_status_report_101()->set_drive_enable_resp(
      drive_enable_resp(bytes, length));
  chassis->mutable_neolix_edu()
      ->mutable_vcu_vehicle_status_report_101()
      ->set_vcu_highvoltagecircuitstate(vcu_highvoltagecircuitstate(bytes, length));
  chassis->mutable_neolix_edu()
      ->mutable_vcu_vehicle_status_report_101()
      ->set_vcu_dcdc_enabledstates(vcu_dcdc_enabledstates(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_vehicle_status_report_101()->set_control_mode_resp(
      control_mode_resp(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_vehicle_status_report_101()->set_vcu_vehicle_speed(
      vcu_vehicle_speed(bytes, length));
  chassis->mutable_neolix_edu()
      ->mutable_vcu_vehicle_status_report_101()
      ->set_vcu_lowbatterychargingfunctionst(vcu_lowbatterychargingfunctionst(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_vehicle_status_report_101()->set_vcu_display_soc(
      vcu_display_soc(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_vehicle_status_report_101()->set_vcu_motor_speed(
      vcu_motor_speed(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_vehicle_status_report_101()->set_vcu_motor_direction(
      vcu_motor_direction(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_vehicle_status_report_101()->set_vcu_motor_speed_valid(
      vcu_motor_speed_valid(bytes, length));
  chassis->mutable_neolix_edu()
      ->mutable_vcu_vehicle_status_report_101()
      ->set_vcu_statusrept_alivecounter(vcu_statusrept_alivecounter(bytes, length));
  chassis->mutable_neolix_edu()
      ->mutable_vcu_vehicle_status_report_101()
      ->set_vcu_statusrept_checksum(vcu_statusrept_checksum(bytes, length));

  chassis->mutable_vehicle_spd()->set_vehicle_spd(vcu_vehicle_speed(bytes, length));
  chassis->mutable_battery()->set_battery_percent(vcu_display_soc(bytes, length));
}
...
bool Vcuvehiclestatusreport101::drive_enable_resp(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
bool Vcuvehiclestatusreport101::vcu_highvoltagecircuitstate(const std::uint8_t* bytes,
...
// 'order': 'motorola', 'physical_unit': ''}
bool Vcuvehiclestatusreport101::vcu_dcdc_enabledstates(const std::uint8_t* bytes,
                                                       int32_t             length) const {
  Byte    t0(bytes + 0);
...
Vcuvehiclestatusreport101::control_mode_resp(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
int Vcuvehiclestatusreport101::vcu_lowbatterychargingfunctionst(const std::uint8_t* bytes,
                                                                int32_t             length) const {
  Byte    t0(bytes + 2);
...
int Vcuvehiclestatusreport101::vcu_display_soc(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 3);
  int32_t x = t0.get_byte(0, 8);
...
double Vcuvehiclestatusreport101::vcu_motor_speed(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 4);
  int32_t x = t0.get_byte(0, 8);
...
int Vcuvehiclestatusreport101::vcu_statusrept_alivecounter(const std::uint8_t* bytes,
                                                           int32_t             length) const {
  Byte    t0(bytes + 6);
...
int Vcuvehiclestatusreport101::vcu_statusrept_checksum(const std::uint8_t* bytes,
                                                       int32_t             length) const {
  Byte    t0(bytes + 7);
  int32_t x = t0.get_byte(0, 8);
