...
class Vcuvehiclefaultresponse201
 ...
 private:
  ...
  int vehicle_error_indicationsvcu(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int brake_system_errorehb(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // ''}
  int high_voltage_battery_errorbcu(const std::uint8_t* bytes, const int32_t length) const;
