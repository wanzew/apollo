...
void Aebfrontwheelspeed353::Parse(const std::uint8_t* bytes,
                                  int32_t             length,
                                  ChassisDetail*      chassis) const {
  chassis->mutable_neolix_edu()->mutable_aeb_frontwheelspeed_353()->set_vehiclespeedvalid(
      vehiclespeedvalid(bytes, length));
  chassis->mutable_neolix_edu()->mutable_aeb_frontwheelspeed_353()->set_vehiclespeed(
      vehiclespeed(bytes, length));
  chassis->mutable_neolix_edu()->mutable_aeb_frontwheelspeed_353()->set_vehiclerealdirect(
      vehiclerealdirect(bytes, length));
  chassis->mutable_neolix_edu()->mutable_aeb_frontwheelspeed_353()->set_wheelspeed_fl_valid(
      wheelspeed_fl_valid(bytes, length));
  chassis->mutable_neolix_edu()->mutable_aeb_frontwheelspeed_353()->set_wheelspeed_fl(
      wheelspeed_fl(bytes, length));
  chassis->mutable_neolix_edu()->mutable_aeb_frontwheelspeed_353()->set_wheelspeed_fr_valid(
      wheelspeed_fr_valid(bytes, length));
  chassis->mutable_neolix_edu()->mutable_aeb_frontwheelspeed_353()->set_wheelspeed_fr(
      wheelspeed_fr(bytes, length));
  chassis->mutable_neolix_edu()->mutable_aeb_frontwheelspeed_353()->set_wheelspeed_fl_direct(
      wheelspeed_fl_direct(bytes, length));
  chassis->mutable_neolix_edu()->mutable_aeb_frontwheelspeed_353()->set_wheelspeed_fr_direct(
      wheelspeed_fr_direct(bytes, length));
  chassis->mutable_neolix_edu()->mutable_aeb_frontwheelspeed_353()->set_alivecounter_front(
      alivecounter_front(bytes, length));
  chassis->mutable_neolix_edu()->mutable_aeb_frontwheelspeed_353()->set_checksum_front(
...
bool Aebfrontwheelspeed353::vehiclespeedvalid(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
double Aebfrontwheelspeed353::vehiclespeed(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
double Aebfrontwheelspeed353::vehiclerealdirect(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// 'motorola', 'physical_unit': 'bit'}
bool Aebfrontwheelspeed353::wheelspeed_fl_valid(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 2);
  int32_t x = t0.get_byte(7, 1);
...
double Aebfrontwheelspeed353::wheelspeed_fl(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 2);
...
// 'motorola', 'physical_unit': 'bit'}
bool Aebfrontwheelspeed353::wheelspeed_fr_valid(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 4);
  int32_t x = t0.get_byte(7, 1);
...
double Aebfrontwheelspeed353::wheelspeed_fr(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 4);
  int32_t x = t0.get_byte(0, 7);
...
// 'physical_unit': ''}
double Aebfrontwheelspeed353::alivecounter_front(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 6);
...
double Aebfrontwheelspeed353::checksum_front(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 7);
