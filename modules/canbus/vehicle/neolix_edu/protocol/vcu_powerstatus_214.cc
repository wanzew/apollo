...
void Vcupowerstatus214::Parse(const std::uint8_t* bytes,
                              int32_t             length,
                              ChassisDetail*      chassis) const {
  chassis->mutable_neolix_edu()->mutable_vcu_powerstatus_214()->set_vcu_powermode(
      vcu_powermode(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_powerstatus_214()->set_vcu_powermodevalid(
      vcu_powermodevalid(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_powerstatus_214()->set_replacebatterystateindication(
      replacebatterystateindication(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_powerstatus_214()->set_forbidden_aeb_signal(
      forbidden_aeb_signal(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_powerstatus_214()->set_bcu_chargedischargecurrent(
      bcu_chargedischargecurrent(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_powerstatus_214()->set_bcu_batt_internalvoltage(
      bcu_batt_internalvoltage(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_powerstatus_214()->set_vcu_driverinfo_alivecounter(
      vcu_driverinfo_alivecounter(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_powerstatus_214()->set_vcu_driverinfo_checksum(
...
int Vcupowerstatus214::vcu_powermode(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 1);
...
int Vcupowerstatus214::vcu_powermodevalid(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 1);
