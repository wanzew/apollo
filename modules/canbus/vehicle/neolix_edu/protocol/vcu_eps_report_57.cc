...
void Vcuepsreport57::Parse(const std::uint8_t* bytes,
                           int32_t             length,
                           ChassisDetail*      chassis) const {
  chassis->mutable_neolix_edu()->mutable_vcu_eps_report_57()->set_drive_enable_resp(
      drive_enable_resp(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_eps_report_57()->set_control_mode_resp(
      control_mode_resp(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_eps_report_57()->set_vcu_eps_report(
      vcu_eps_report(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_eps_report_57()->set_vcu_real_angle(
      vcu_real_angle(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_eps_report_57()->set_vcu_real_angle_valid(
      vcu_real_angle_valid(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_eps_report_57()->set_vcu_target_angle_valid(
      vcu_target_angle_valid(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_eps_report_57()->set_vcu_target_angle(
      vcu_target_angle(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_eps_report_57()->set_vcu_eps_rept_alivecounter(
      vcu_eps_rept_alivecounter(bytes, length));
  chassis->mutable_neolix_edu()->mutable_vcu_eps_report_57()->set_vcu_eps_rept_checksum(
      vcu_eps_rept_checksum(bytes, length));

  chassis->mutable_eps()->set_steering_angle(vcu_real_angle(bytes, length));
  chassis->mutable_check_response()->set_is_eps_online(drive_enable_resp(bytes, length) == 1);
}
...
bool Vcuepsreport57::drive_enable_resp(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
Vcu_eps_report_57::Control_mode_respType
Vcuepsreport57::control_mode_resp(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// 'motorola', 'physical_unit': ''}
bool Vcuepsreport57::vcu_eps_report(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// 'physical_unit': ''}
double Vcuepsreport57::vcu_real_angle(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 2);
...
// 'motorola', 'physical_unit': ''}
bool Vcuepsreport57::vcu_real_angle_valid(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 4);
  int32_t x = t0.get_byte(0, 1);
...
bool Vcuepsreport57::vcu_target_angle_valid(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 4);
...
double Vcuepsreport57::vcu_target_angle(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 5);
  int32_t x = t0.get_byte(0, 8);
...
int Vcuepsreport57::vcu_eps_rept_alivecounter(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 6);
...
int Vcuepsreport57::vcu_eps_rept_checksum(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 7);
  int32_t x = t0.get_byte(0, 8);
