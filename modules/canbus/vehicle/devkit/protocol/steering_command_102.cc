...
void Steeringcommand102::UpdateData(uint8_t* data) {
  ...
  checksum_102_ = data[0] ^ data[1] ^ data[2] ^ data[3] ^ data[4] ^ data[5] ^ data[6];
...
Steeringcommand102* Steeringcommand102::set_steer_angle_target(int steer_angle_target) {
...
// 'type': 'int'}
void Steeringcommand102::set_p_steer_angle_target(uint8_t* data, int steer_angle_target) {
...
Steeringcommand102* Steeringcommand102::set_steer_angle_spd(int steer_angle_spd) {
...
void Steeringcommand102::set_p_steer_angle_spd(uint8_t* data, int steer_angle_spd) {
