...
class Steeringreport502
 ...
 private:
  ...
  // 'type': 'int'}
  int steer_angle_spd_actual(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Steering_report_502::Steer_en_stateType steer_en_state(const std::uint8_t* bytes,
                                                         const int32_t       length) const;
