...
void Throttlereport500::Parse(const std::uint8_t* bytes,
                              int32_t             length,
                              ChassisDetail*      chassis) const {
  chassis->mutable_devkit()->mutable_throttle_report_500()->set_throttle_pedal_actual(
  ...
  chassis->mutable_devkit()->mutable_throttle_report_500()->set_throttle_en_state(
      throttle_en_state(bytes, length));
  chassis->mutable_check_response()->set_is_vcu_online(throttle_en_state(bytes, length) == 1);
}
...
double Throttlereport500::throttle_pedal_actual(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 3);
...
// 'physical_unit': ''}
Throttle_report_500::Throttle_flt2Type Throttlereport500::throttle_flt2(const std::uint8_t* bytes,
...
Throttle_report_500::Throttle_flt1Type Throttlereport500::throttle_flt1(const std::uint8_t* bytes,
                                                                        int32_t length) const {
  Byte    t0(bytes + 1);
  int32_t x = t0.get_byte(0, 8);
...
// 'physical_unit': ''}
Throttle_report_500::Throttle_en_stateType
Throttlereport500::throttle_en_state(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
