...
void Parkcommand104::UpdateData(uint8_t* data) {
  ...
  checksum_104_ = data[0] ^ data[1] ^ data[2] ^ data[3] ^ data[4] ^ data[5] ^ data[6];
...
Parkcommand104* Parkcommand104::set_park_target(Park_command_104::Park_targetType park_target) {
...
void Parkcommand104::set_p_park_target(uint8_t*                          data,
...
Parkcommand104* Parkcommand104::set_park_en_ctrl(Park_command_104::Park_en_ctrlType park_en_ctrl) {
...
// 'order': 'motorola', 'physical_unit': ''}
void Parkcommand104::set_p_park_en_ctrl(uint8_t*                           data,
