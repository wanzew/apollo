...
class Brakereport501
 ...
 private:
  ...
  double brake_pedal_actual(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Brake_report_501::Brake_en_stateType brake_en_state(const std::uint8_t* bytes,
                                                      const int32_t       length) const;
};
