...
void Brakecommand101::UpdateData(uint8_t* data) {
  ...
  checksum_101_ = data[0] ^ data[1] ^ data[2] ^ data[3] ^ data[4] ^ data[5] ^ data[6];
...
Brakecommand101* Brakecommand101::set_aeb_en_ctrl(Brake_command_101::Aeb_en_ctrlType aeb_en_ctrl) {
...
void Brakecommand101::set_p_aeb_en_ctrl(uint8_t*                           data,
...
Brakecommand101* Brakecommand101::set_brake_pedal_target(double brake_pedal_target) {
...
void Brakecommand101::set_p_brake_pedal_target(uint8_t* data, double brake_pedal_target) {
...
void Brakecommand101::set_p_brake_en_ctrl(uint8_t*                             data,
