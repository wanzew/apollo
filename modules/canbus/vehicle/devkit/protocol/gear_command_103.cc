...
void Gearcommand103::UpdateData(uint8_t* data) {
  ...
  checksum_103_ = data[0] ^ data[1] ^ data[2] ^ data[3] ^ data[4] ^ data[5] ^ data[6];
...
Gearcommand103* Gearcommand103::set_gear_target(Gear_command_103::Gear_targetType gear_target) {
...
void Gearcommand103::set_p_gear_target(uint8_t*                          data,
...
Gearcommand103* Gearcommand103::set_gear_en_ctrl(Gear_command_103::Gear_en_ctrlType gear_en_ctrl) {
...
void Gearcommand103::set_p_gear_en_ctrl(uint8_t*                           data,
