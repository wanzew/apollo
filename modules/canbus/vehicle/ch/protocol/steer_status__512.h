...
class Steerstatus512
 ...
 private:
  ...
  // 'physical_unit': ''}
  Steer_status__512::Steer_angle_en_stsType steer_angle_en_sts(const std::uint8_t* bytes,
  ...
  Steer_status__512::Steer_errType steer_err(const std::uint8_t* bytes, const int32_t length) const;
