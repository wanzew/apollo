...
class Brakestatus511
 ...
 private:
  ...
  // 'physical_unit': ''}
  Brake_status__511::Brake_pedal_en_stsType brake_pedal_en_sts(const std::uint8_t* bytes,
  ...
  Brake_status__511::Brake_errType brake_err(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Brake_status__511::Emergency_btn_envType emergency_btn_env(const std::uint8_t* bytes,
                                                             const int32_t       length) const;
  ...
  // 'physical_unit': ''}
  Brake_status__511::Front_bump_envType front_bump_env(const std::uint8_t* bytes,
                                                       const int32_t       length) const;
  ...
  Brake_status__511::Back_bump_envType back_bump_env(const std::uint8_t* bytes,
                                                     const int32_t       length) const;
