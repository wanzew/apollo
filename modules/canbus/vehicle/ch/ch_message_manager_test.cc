...
TEST_F(ChMessageManagerTest, Brakecommand111) {
  ...
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Brakecommand111::ID);
...
TEST_F(ChMessageManagerTest, Brakestatus511) {
  ChMessageManager             manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Brakestatus511::ID);
  EXPECT_NE(pd, nullptr);
...
TEST_F(ChMessageManagerTest, Controlcommand115) {
  ChMessageManager             manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Controlcommand115::ID);
  EXPECT_NE(pd, nullptr);
...
TEST_F(ChMessageManagerTest, Ecustatus1515) {
  ChMessageManager             manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Ecustatus1515::ID);
  EXPECT_NE(pd, nullptr);
...
TEST_F(ChMessageManagerTest, Ecustatus2516) {
  ChMessageManager             manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Ecustatus2516::ID);
  EXPECT_NE(pd, nullptr);
...
TEST_F(ChMessageManagerTest, Ecustatus3517) {
  ChMessageManager             manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Ecustatus3517::ID);
  EXPECT_NE(pd, nullptr);
...
TEST_F(ChMessageManagerTest, Gearcommand114) {
  ChMessageManager             manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Gearcommand114::ID);
  EXPECT_NE(pd, nullptr);
...
TEST_F(ChMessageManagerTest, Gearstatus514) {
  ChMessageManager             manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Gearstatus514::ID);
  EXPECT_NE(pd, nullptr);
...
TEST_F(ChMessageManagerTest, Steercommand112) {
  ChMessageManager             manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Steercommand112::ID);
  EXPECT_NE(pd, nullptr);
...
TEST_F(ChMessageManagerTest, Steerstatus512) {
  ChMessageManager             manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Steerstatus512::ID);
  EXPECT_NE(pd, nullptr);
...
TEST_F(ChMessageManagerTest, Throttlecommand110) {
  ChMessageManager             manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Throttlecommand110::ID);
  EXPECT_NE(pd, nullptr);
...
TEST_F(ChMessageManagerTest, Throttlestatus510) {
  ChMessageManager             manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Throttlestatus510::ID);
  EXPECT_NE(pd, nullptr);
...
TEST_F(ChMessageManagerTest, Turnsignalcommand113) {
  ChMessageManager             manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Turnsignalcommand113::ID);
  EXPECT_NE(pd, nullptr);
  EXPECT_EQ(static_cast<Turnsignalcommand113*>(pd)->ID, Turnsignalcommand113::ID);
}

TEST_F(ChMessageManagerTest, Turnsignalstatus513) {
  ChMessageManager             manager;
  ProtocolData<ChassisDetail>* pd = manager.GetMutableProtocolDataById(Turnsignalstatus513::ID);
  EXPECT_NE(pd, nullptr);
  EXPECT_EQ(static_cast<Turnsignalstatus513*>(pd)->ID, Turnsignalstatus513::ID);
}
