...
void Doorrpt417::Parse(const std::uint8_t* bytes, int32_t length, ChassisDetail* chassis) const {
  ...
  chassis->mutable_lexus()->mutable_door_rpt_417()->set_rear_pass_door_open_is_valid(
      rear_pass_door_open_is_valid(bytes, length));
  chassis->mutable_lexus()->mutable_door_rpt_417()->set_rear_driver_door_open_is_valid(
  ...
  chassis->mutable_lexus()->mutable_door_rpt_417()->set_driver_door_open_is_valid(
