...
void Headlightauxrpt318::Parse(const std::uint8_t* bytes,
                               int32_t             length,
                               ChassisDetail*      chassis) const {
  chassis->mutable_lexus()->mutable_headlight_aux_rpt_318()->set_headlights_mode_is_valid(
      headlights_mode_is_valid(bytes, length));
  chassis->mutable_lexus()->mutable_headlight_aux_rpt_318()->set_headlights_mode(
      headlights_mode(bytes, length));
  chassis->mutable_lexus()->mutable_headlight_aux_rpt_318()->set_fog_lights_on_is_valid(
  ...
  chassis->mutable_lexus()->mutable_headlight_aux_rpt_318()->set_headlights_on_bright_is_valid(
      headlights_on_bright_is_valid(bytes, length));
  chassis->mutable_lexus()->mutable_headlight_aux_rpt_318()->set_headlights_on_bright(
      headlights_on_bright(bytes, length));
  chassis->mutable_lexus()->mutable_headlight_aux_rpt_318()->set_headlights_on_is_valid(
...
bool Headlightauxrpt318::headlights_mode_is_valid(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 2);
...
Headlight_aux_rpt_318::Headlights_modeType
Headlightauxrpt318::headlights_mode(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 1);
...
bool Headlightauxrpt318::fog_lights_on_is_valid(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 2);
...
bool Headlightauxrpt318::fog_lights_on(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
  int32_t x = t0.get_byte(2, 1);
...
bool Headlightauxrpt318::headlights_on_bright_is_valid(const std::uint8_t* bytes,
...
bool Headlightauxrpt318::headlights_on_bright(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
  int32_t x = t0.get_byte(1, 1);
...
bool Headlightauxrpt318::headlights_on_is_valid(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 2);
...
// 'type': 'bool', 'order': 'motorola', 'physical_unit': ''}
bool Headlightauxrpt318::headlights_on(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
  int32_t x = t0.get_byte(0, 1);
