...
void Shiftrpt228::Parse(const std::uint8_t* bytes, int32_t length, ChassisDetail* chassis) const {
  chassis->mutable_lexus()->mutable_shift_rpt_228()->set_vehicle_fault(
      vehicle_fault(bytes, length));
  chassis->mutable_lexus()->mutable_shift_rpt_228()->set_pacmod_fault(pacmod_fault(bytes, length));
  ...
  chassis->mutable_lexus()->mutable_shift_rpt_228()->set_enabled(enabled(bytes, length));
  chassis->mutable_lexus()->mutable_shift_rpt_228()->set_command_output_fault(
      command_output_fault(bytes, length));
  chassis->mutable_lexus()->mutable_shift_rpt_228()->set_manual_input(manual_input(bytes, length));
  chassis->mutable_lexus()->mutable_shift_rpt_228()->set_commanded_value(
      commanded_value(bytes, length));
  chassis->mutable_lexus()->mutable_shift_rpt_228()->set_output_value(output_value(bytes, length));
}

// config detail: {'name': 'vehicle_fault', 'offset': 0.0, 'precision': 1.0,
// 'len': 1, 'is_signed_var': False, 'physical_range': '[0|1]', 'bit': 6,
// 'type': 'bool', 'order': 'motorola', 'physical_unit': ''}
bool Shiftrpt228::vehicle_fault(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// 'type': 'bool', 'order': 'motorola', 'physical_unit': ''}
bool Shiftrpt228::pacmod_fault(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// 'type': 'bool', 'order': 'motorola', 'physical_unit': ''}
bool Shiftrpt228::override_active(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
bool Shiftrpt228::output_reported_fault(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
bool Shiftrpt228::input_output_fault(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
bool Shiftrpt228::command_output_fault(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
Shift_rpt_228::Manual_inputType Shiftrpt228::manual_input(const std::uint8_t* bytes,
  ...
  Shift_rpt_228::Manual_inputType ret = static_cast<Shift_rpt_228::Manual_inputType>(x);
  return ret;
}
...
Shift_rpt_228::Commanded_valueType Shiftrpt228::commanded_value(const std::uint8_t* bytes,
                                                                int32_t             length) const {
  Byte    t0(bytes + 2);
  int32_t x = t0.get_byte(0, 8);

  Shift_rpt_228::Commanded_valueType ret = static_cast<Shift_rpt_228::Commanded_valueType>(x);
  return ret;
}
...
// 'motorola', 'physical_unit': ''}
Shift_rpt_228::Output_valueType Shiftrpt228::output_value(const std::uint8_t* bytes,
                                                          int32_t             length) const {
  Byte    t0(bytes + 3);
  int32_t x = t0.get_byte(0, 8);

  Shift_rpt_228::Output_valueType ret = static_cast<Shift_rpt_228::Output_valueType>(x);
  return ret;
}
}  // namespace lexus
}  // namespace canbus
