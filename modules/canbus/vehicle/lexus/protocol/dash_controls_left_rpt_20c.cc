...
void Dashcontrolsleftrpt20c::Parse(const std::uint8_t* bytes,
                                   int32_t             length,
                                   ChassisDetail*      chassis) const {
  chassis->mutable_lexus()->mutable_dash_controls_left_rpt_20c()->set_output_value(
      output_value(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_left_rpt_20c()->set_commanded_value(
      commanded_value(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_left_rpt_20c()->set_manual_input(
      manual_input(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_left_rpt_20c()->set_vehicle_fault(
      vehicle_fault(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_left_rpt_20c()->set_pacmod_fault(
      pacmod_fault(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_left_rpt_20c()->set_override_active(
      override_active(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_left_rpt_20c()->set_output_reported_fault(
      output_reported_fault(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_left_rpt_20c()->set_input_output_fault(
      input_output_fault(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_left_rpt_20c()->set_enabled(
      enabled(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_left_rpt_20c()->set_command_output_fault(
...
Dashcontrolsleftrpt20c::output_value(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 3);
...
Dashcontrolsleftrpt20c::commanded_value(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 2);
  int32_t x = t0.get_byte(0, 8);
...
Dashcontrolsleftrpt20c::manual_input(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 1);
  int32_t x = t0.get_byte(0, 8);
...
bool Dashcontrolsleftrpt20c::vehicle_fault(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// 'type': 'bool', 'order': 'motorola', 'physical_unit': ''}
bool Dashcontrolsleftrpt20c::pacmod_fault(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// 'type': 'bool', 'order': 'motorola', 'physical_unit': ''}
bool Dashcontrolsleftrpt20c::override_active(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
bool Dashcontrolsleftrpt20c::input_output_fault(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
bool Dashcontrolsleftrpt20c::enabled(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
bool Dashcontrolsleftrpt20c::command_output_fault(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
