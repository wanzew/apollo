...
void Wiperauxrpt334::Parse(const std::uint8_t* bytes,
                           int32_t             length,
                           ChassisDetail*      chassis) const {
  chassis->mutable_lexus()->mutable_wiper_aux_rpt_334()->set_spray_empty_is_valid(
      spray_empty_is_valid(bytes, length));
  chassis->mutable_lexus()->mutable_wiper_aux_rpt_334()->set_spray_empty(
      spray_empty(bytes, length));
  chassis->mutable_lexus()->mutable_wiper_aux_rpt_334()->set_spray_near_empty_is_valid(
  ...
  chassis->mutable_lexus()->mutable_wiper_aux_rpt_334()->set_rear_spraying_is_valid(
  ...
  chassis->mutable_lexus()->mutable_wiper_aux_rpt_334()->set_rear_wiping_is_valid(
      rear_wiping_is_valid(bytes, length));
  chassis->mutable_lexus()->mutable_wiper_aux_rpt_334()->set_rear_wiping(
      rear_wiping(bytes, length));
  chassis->mutable_lexus()->mutable_wiper_aux_rpt_334()->set_front_spraying_is_valid(
  ...
  chassis->mutable_lexus()->mutable_wiper_aux_rpt_334()->set_front_wiping_is_valid(
