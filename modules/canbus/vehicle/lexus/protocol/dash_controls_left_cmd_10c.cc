...
#include "modules/canbus/vehicle/lexus/protocol/dash_controls_left_cmd_10c.h"
...
void Dashcontrolsleftcmd10c::Parse(const std::uint8_t* bytes,
                                   int32_t             length,
                                   ChassisDetail*      chassis) const {
  chassis->mutable_lexus()->mutable_dash_controls_left_cmd_10c()->set_ignore_overrides(
      ignore_overrides(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_left_cmd_10c()->set_enable(enable(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_left_cmd_10c()->set_clear_override(
      clear_override(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_left_cmd_10c()->set_clear_faults(
      clear_faults(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_left_cmd_10c()->set_dash_controls_button(
...
bool Dashcontrolsleftcmd10c::ignore_overrides(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
bool Dashcontrolsleftcmd10c::enable(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// 'type': 'bool', 'order': 'motorola', 'physical_unit': ''}
bool Dashcontrolsleftcmd10c::clear_override(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// 'type': 'bool', 'order': 'motorola', 'physical_unit': ''}
bool Dashcontrolsleftcmd10c::clear_faults(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
Dashcontrolsleftcmd10c::dash_controls_button(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 1);
