...
void Interiorlightsrpt416::Parse(const std::uint8_t* bytes,
                                 int32_t             length,
                                 ChassisDetail*      chassis) const {
  chassis->mutable_lexus()->mutable_interior_lights_rpt_416()->set_dim_level_is_valid(
      dim_level_is_valid(bytes, length));
  chassis->mutable_lexus()->mutable_interior_lights_rpt_416()->set_mood_lights_on_is_valid(
      mood_lights_on_is_valid(bytes, length));
  chassis->mutable_lexus()->mutable_interior_lights_rpt_416()->set_rear_dome_lights_on_is_valid(
      rear_dome_lights_on_is_valid(bytes, length));
  chassis->mutable_lexus()->mutable_interior_lights_rpt_416()->set_front_dome_lights_on_is_valid(
  ...
  chassis->mutable_lexus()->mutable_interior_lights_rpt_416()->set_mood_lights_on(
      mood_lights_on(bytes, length));
  chassis->mutable_lexus()->mutable_interior_lights_rpt_416()->set_rear_dome_lights_on(
      rear_dome_lights_on(bytes, length));
  chassis->mutable_lexus()->mutable_interior_lights_rpt_416()->set_front_dome_lights_on(
...
bool Interiorlightsrpt416::dim_level_is_valid(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 2);
...
bool Interiorlightsrpt416::rear_dome_lights_on_is_valid(const std::uint8_t* bytes,
                                                        int32_t             length) const {
  Byte    t0(bytes + 2);
...
bool Interiorlightsrpt416::front_dome_lights_on_is_valid(const std::uint8_t* bytes,
                                                         int32_t             length) const {
  Byte    t0(bytes + 2);
...
Interior_lights_rpt_416::Dim_levelType Interiorlightsrpt416::dim_level(const std::uint8_t* bytes,
                                                                       int32_t length) const {
  Byte    t0(bytes + 1);
...
bool Interiorlightsrpt416::mood_lights_on(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
  int32_t x = t0.get_byte(2, 1);
...
bool Interiorlightsrpt416::rear_dome_lights_on(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
  int32_t x = t0.get_byte(1, 1);
...
bool Interiorlightsrpt416::front_dome_lights_on(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
  int32_t x = t0.get_byte(0, 1);
