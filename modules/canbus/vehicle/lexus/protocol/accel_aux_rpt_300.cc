...
void Accelauxrpt300::Parse(const std::uint8_t* bytes,
                           int32_t             length,
                           ChassisDetail*      chassis) const {
  chassis->mutable_lexus()->mutable_accel_aux_rpt_300()->set_user_interaction_is_valid(
  ...
  chassis->mutable_lexus()->mutable_accel_aux_rpt_300()->set_raw_pedal_force_is_valid(
  ...
  chassis->mutable_lexus()->mutable_accel_aux_rpt_300()->set_raw_pedal_pos_is_valid(
