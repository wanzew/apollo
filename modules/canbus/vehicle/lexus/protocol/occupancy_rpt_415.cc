...
#include "modules/canbus/vehicle/lexus/protocol/occupancy_rpt_415.h"
...
void Occupancyrpt415::Parse(const std::uint8_t* bytes,
                            int32_t             length,
                            ChassisDetail*      chassis) const {
  chassis->mutable_lexus()->mutable_occupancy_rpt_415()->set_rear_seatbelt_buckled_is_valid(
      rear_seatbelt_buckled_is_valid(bytes, length));
  chassis->mutable_lexus()->mutable_occupancy_rpt_415()->set_pass_seatbelt_buckled_is_valid(
      pass_seatbelt_buckled_is_valid(bytes, length));
  chassis->mutable_lexus()->mutable_occupancy_rpt_415()->set_driver_seatbelt_buckled_is_valid(
      driver_seatbelt_buckled_is_valid(bytes, length));
  chassis->mutable_lexus()->mutable_occupancy_rpt_415()->set_rear_seat_occupied_is_valid(
      rear_seat_occupied_is_valid(bytes, length));
  chassis->mutable_lexus()->mutable_occupancy_rpt_415()->set_pass_seat_occupied_is_valid(
      pass_seat_occupied_is_valid(bytes, length));
  chassis->mutable_lexus()->mutable_occupancy_rpt_415()->set_driver_seat_occupied_is_valid(
      driver_seat_occupied_is_valid(bytes, length));
  chassis->mutable_lexus()->mutable_occupancy_rpt_415()->set_rear_seatbelt_buckled(
      rear_seatbelt_buckled(bytes, length));
  chassis->mutable_lexus()->mutable_occupancy_rpt_415()->set_pass_seatbelt_buckled(
      pass_seatbelt_buckled(bytes, length));
  chassis->mutable_lexus()->mutable_occupancy_rpt_415()->set_driver_seatbelt_buckled(
  ...
  chassis->mutable_lexus()->mutable_occupancy_rpt_415()->set_driver_seat_occupied(
...
bool Occupancyrpt415::driver_seatbelt_buckled_is_valid(const std::uint8_t* bytes,
                                                       int32_t             length) const {
  Byte    t0(bytes + 1);
