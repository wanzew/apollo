...
void Steeringmotorrpt2405::Parse(const std::uint8_t* bytes,
                                 int32_t             length,
                                 ChassisDetail*      chassis) const {
  chassis->mutable_lexus()->mutable_steering_motor_rpt_2_405()->set_encoder_temperature(
      encoder_temperature(bytes, length));
  chassis->mutable_lexus()->mutable_steering_motor_rpt_2_405()->set_motor_temperature(
      motor_temperature(bytes, length));
  chassis->mutable_lexus()->mutable_steering_motor_rpt_2_405()->set_angular_speed(
...
// 'physical_unit': 'deg C'}
int Steeringmotorrpt2405::encoder_temperature(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// 'physical_unit': 'deg C'}
int Steeringmotorrpt2405::motor_temperature(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 2);
  int32_t x = t0.get_byte(0, 8);
...
double Steeringmotorrpt2405::angular_speed(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 4);
  int32_t x = t0.get_byte(0, 8);
