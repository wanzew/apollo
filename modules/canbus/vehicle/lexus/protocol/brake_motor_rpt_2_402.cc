...
void Brakemotorrpt2402::Parse(const std::uint8_t* bytes,
                              int32_t             length,
                              ChassisDetail*      chassis) const {
  chassis->mutable_lexus()->mutable_brake_motor_rpt_2_402()->set_encoder_temperature(
      encoder_temperature(bytes, length));
  chassis->mutable_lexus()->mutable_brake_motor_rpt_2_402()->set_motor_temperature(
