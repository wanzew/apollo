...
void Wheelspeedrpt407::Parse(const std::uint8_t* bytes,
                             int32_t             length,
                             ChassisDetail*      chassis) const {
  chassis->mutable_lexus()->mutable_wheel_speed_rpt_407()->set_wheel_spd_rear_right(
      wheel_spd_rear_right(bytes, length));
  chassis->mutable_lexus()->mutable_wheel_speed_rpt_407()->set_wheel_spd_rear_left(
      wheel_spd_rear_left(bytes, length));
  chassis->mutable_lexus()->mutable_wheel_speed_rpt_407()->set_wheel_spd_front_right(
      wheel_spd_front_right(bytes, length));
  chassis->mutable_lexus()->mutable_wheel_speed_rpt_407()->set_wheel_spd_front_left(
