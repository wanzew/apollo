...
class Errorstatee1
 ...
 private:
  ...
  // 'physical_unit': 'bit'}
  Error_state_e1::Brake_error_codeType brake_error_code(const std::uint8_t* bytes,
  ...
  // 'physical_unit': 'bit'}
  Error_state_e1::Driven_error_codeType driven_error_code(const std::uint8_t* bytes,
                                                          const int32_t       length) const;
  ...
  // 'physical_unit': 'bit'}
  Error_state_e1::Steering_error_codeType steering_error_code(const std::uint8_t* bytes,
                                                              const int32_t       length) const;
  ...
  // 'physical_unit': 'bit'}
  Error_state_e1::Parking_error_codeType parking_error_code(const std::uint8_t* bytes,
                                                            const int32_t       length) const;
