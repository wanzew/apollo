...
class Vehiclestatefeedbackc1
 ...
 private:
  ...
  // 'physical_unit': ''}
  Vehicle_state_feedback_c1::Parking_actualType parking_actual(const std::uint8_t* bytes,
  ...
  // '%'}
  double brake_torque_feedback(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Vehicle_state_feedback_c1::Gear_state_actualType gear_state_actual(const std::uint8_t* bytes,
                                                                     const int32_t length) const;
