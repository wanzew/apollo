...
class Llcmotionfeedback221
 ...
 private:
  ...
  double llc_fbk_vehiclespeed(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int llc_motionfeedback2_counter(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int llc_motionfeedback2_checksum(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': 'deg/s'}
  double llc_fbk_steeringrate(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double llc_fbk_steeringangle(const std::uint8_t* bytes, const int32_t length) const;
};
