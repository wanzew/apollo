...
class Llcmotioncommandfeedback122
 ...
 private:
  ...
  // 'physical_unit': 'deg'}
  double llc_fbk_steeringanglesetpoint(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': '%'}
  double llc_fbk_throttlesetpoint(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': '%'}
  double llc_fbk_brakepercentsetpoint(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  int llc_motioncommandfeedback1_count(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  int llc_motioncommandfeedback1_check(const std::uint8_t* bytes, const int32_t length) const;
};
