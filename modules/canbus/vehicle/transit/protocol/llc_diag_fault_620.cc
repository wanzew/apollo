...
void Llcdiagfault620::Parse(const std::uint8_t* bytes,
                            int32_t             length,
                            ChassisDetail*      chassis) const {
  chassis->mutable_transit()->mutable_llc_diag_fault_620()->set_llc_disengagecounter_brake(
      llc_disengagecounter_brake(bytes, length));
  chassis->mutable_transit()->mutable_llc_diag_fault_620()->set_llc_disengagecounter_steer(
      llc_disengagecounter_steer(bytes, length));
  chassis->mutable_transit()->mutable_llc_diag_fault_620()->set_llc_disengagecounter_throttle(
      llc_disengagecounter_throttle(bytes, length));
  chassis->mutable_transit()->mutable_llc_diag_fault_620()->set_llc_fbk_faultcounter(
      llc_fbk_faultcounter(bytes, length));
  chassis->mutable_transit()->mutable_llc_diag_fault_620()->set_llc_disengagecounter_button(
      llc_disengagecounter_button(bytes, length));
  chassis->mutable_transit()->mutable_llc_diag_fault_620()->set_llc_fbk_version_year(
      llc_fbk_version_year(bytes, length));
  chassis->mutable_transit()->mutable_llc_diag_fault_620()->set_llc_fbk_version_month(
      llc_fbk_version_month(bytes, length));
  chassis->mutable_transit()->mutable_llc_diag_fault_620()->set_llc_fbk_version_day(
      llc_fbk_version_day(bytes, length));
  chassis->mutable_transit()->mutable_llc_diag_fault_620()->set_llc_fbk_version_hour(
...
int Llcdiagfault620::llc_disengagecounter_brake(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 4);
...
int Llcdiagfault620::llc_disengagecounter_steer(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 2);
  int32_t x = t0.get_byte(0, 8);
...
int Llcdiagfault620::llc_fbk_faultcounter(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
  int32_t x = t0.get_byte(0, 8);
...
int Llcdiagfault620::llc_disengagecounter_button(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 1);
  int32_t x = t0.get_byte(0, 8);
...
int Llcdiagfault620::llc_fbk_version_year(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 5);
...
int Llcdiagfault620::llc_fbk_version_month(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 6);
...
int Llcdiagfault620::llc_fbk_version_day(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 6);
...
int Llcdiagfault620::llc_fbk_version_hour(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 7);
