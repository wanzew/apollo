...
class Llcdiagfault620
 ...
 private:
  ...
  int llc_disengagecounter_brake(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int llc_disengagecounter_steer(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int llc_disengagecounter_throttle(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int llc_fbk_faultcounter(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int llc_disengagecounter_button(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int llc_fbk_version_year(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int llc_fbk_version_month(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int llc_fbk_version_day(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int llc_fbk_version_hour(const std::uint8_t* bytes, const int32_t length) const;
};
