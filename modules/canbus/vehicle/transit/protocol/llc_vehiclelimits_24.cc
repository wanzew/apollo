...
void Llcvehiclelimits24::Parse(const std::uint8_t* bytes,
                               int32_t             length,
                               ChassisDetail*      chassis) const {
  chassis->mutable_transit()->mutable_llc_vehiclelimits_24()->set_llc_fbk_maxsteeringangle(
      llc_fbk_maxsteeringangle(bytes, length));
  chassis->mutable_transit()->mutable_llc_vehiclelimits_24()->set_llc_fbk_maxbrakepercent(
