...
Chassis GemController::chassis() {
  ...
  if (chassis_detail.gem().has_vehicle_speed_rpt_6f() &&
    ...
    chassis_.set_speed_mps(chassis_detail.gem().vehicle_speed_rpt_6f().vehicle_speed());
  } else {
  ...
  if (chassis_detail.gem().has_accel_rpt_68() &&
    ...
    chassis_.set_throttle_percentage(chassis_detail.gem().accel_rpt_68().output_value());
  } else {
  ...
  if (chassis_detail.gem().has_brake_rpt_6c() &&
    ...
    chassis_.set_brake_percentage(chassis_detail.gem().brake_rpt_6c().output_value());
  } else {
  ...
  if (chassis_detail.gem().has_steering_rpt_1_6e() &&
    ...
    chassis_.set_steering_percentage(chassis_detail.gem().steering_rpt_1_6e().output_value() *
  ...
  if (!chassis_error_mask_ && !chassis_.parking_brake() &&
      (chassis_.throttle_percentage() == 0.0) && (chassis_.brake_percentage() != 0.0)) {
