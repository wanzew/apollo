...
void Globalrpt6a::Parse(const std::uint8_t* bytes, int32_t length, ChassisDetail* chassis) const {
  chassis->mutable_gem()->mutable_global_rpt_6a()->set_pacmod_status(pacmod_status(bytes, length));
...
// 'physical_unit': ''}
Global_rpt_6a::Pacmod_statusType Globalrpt6a::pacmod_status(const std::uint8_t* bytes,
                                                            int32_t             length) const {
  Byte    t0(bytes + 0);
  int32_t x = t0.get_byte(0, 1);

  Global_rpt_6a::Pacmod_statusType ret = static_cast<Global_rpt_6a::Pacmod_statusType>(x);
  return ret;
}
...
// 'physical_unit': ''}
Global_rpt_6a::Override_statusType Globalrpt6a::override_status(const std::uint8_t* bytes,
                                                                int32_t             length) const {
  Byte    t0(bytes + 0);
  int32_t x = t0.get_byte(1, 1);

  Global_rpt_6a::Override_statusType ret = static_cast<Global_rpt_6a::Override_statusType>(x);
  return ret;
}
...
bool Globalrpt6a::veh_can_timeout(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// 'type': 'bool', 'order': 'motorola', 'physical_unit': ''}
bool Globalrpt6a::str_can_timeout(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
Global_rpt_6a::Brk_can_timeoutType Globalrpt6a::brk_can_timeout(const std::uint8_t* bytes,
                                                                int32_t             length) const {
  Byte    t0(bytes + 0);
  int32_t x = t0.get_byte(4, 1);

  Global_rpt_6a::Brk_can_timeoutType ret = static_cast<Global_rpt_6a::Brk_can_timeoutType>(x);
  return ret;
}
...
// 'type': 'bool', 'order': 'motorola', 'physical_unit': ''}
bool Globalrpt6a::usr_can_timeout(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 0);
...
// ''}
int Globalrpt6a::usr_can_read_errors(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 6);
