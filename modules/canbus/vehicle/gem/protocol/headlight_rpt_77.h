...
#ifndef MODULES_CANBUS_VEHICLE_GEM_PROTOCOL_HEADLIGHT_RPT_77_H_
#define MODULES_CANBUS_VEHICLE_GEM_PROTOCOL_HEADLIGHT_RPT_77_H_
...
class Headlightrpt77
 ...
 private:
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Headlight_rpt_77::Commanded_valueType commanded_value(const std::uint8_t* bytes,
                                                        const int32_t       length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_GEM_PROTOCOL_HEADLIGHT_RPT_77_H_
