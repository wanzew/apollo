...
TEST_F(Brakemotorrpt372Test, reset) {
  ...
  EXPECT_DOUBLE_EQ(chassis_detail.gem().brake_motor_rpt_3_72().torque_output(), 16909.060000000001);
  EXPECT_DOUBLE_EQ(chassis_detail.gem().brake_motor_rpt_3_72().torque_input(), 286397.20400000003);
}
