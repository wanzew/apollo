...
class Status310 : public ::apollo::drivers::canbus::ProtocolData<::apollo::canbus::ChassisDetail> {
 public:
 ...
 private:
  ...
  Status_310::LongitudeaccvalidType longitudeaccvalid(const std::uint8_t* bytes,
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Status_310::VehdynyawratevalidType vehdynyawratevalid(const std::uint8_t* bytes,
                                                        const int32_t       length) const;
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Status_310::LongitudedrivingmodeType longitudedrivingmode(const std::uint8_t* bytes,
                                                            const int32_t       length) const;
  ...
  // 'physical_unit': ''}
  Status_310::EngspdvalidType engspdvalid(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Status_310::AccepedaloverrideType accepedaloverride(const std::uint8_t* bytes,
                                                      const int32_t       length) const;
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Status_310::EpbswtpositionvalidType epbswtpositionvalid(const std::uint8_t* bytes,
                                                          const int32_t       length) const;
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Status_310::EpbstsType epbsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Status_310::Eps_interferdetdvalidType eps_interferdetdvalid(const std::uint8_t* bytes,
                                                              const int32_t       length) const;
  ...
  // 'physical_unit': ''}
  Status_310::Eps_handsdetnstsvalidType eps_handsdetnstsvalid(const std::uint8_t* bytes,
                                                              const int32_t       length) const;
  ...
  // 'physical_unit': ''}
  Status_310::SteerwheelanglesignType steerwheelanglesign(const std::uint8_t* bytes,
                                                          const int32_t       length) const;
  ...
  // 'physical_unit': ''}
  Status_310::SteerwheelspdsignType steerwheelspdsign(const std::uint8_t* bytes,
                                                      const int32_t       length) const;
  ...
  // 'physical_unit': ''}
  Status_310::RldoorstsType rldoorsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::RrdoorstsType rrdoorsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::LowbeamstsType lowbeamsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::HighbeamstsType highbeamsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::Bcm_availstsType bcm_availsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::BrakelmpstsType brakelmpsts(const std::uint8_t* bytes, const int32_t length) const;
};
