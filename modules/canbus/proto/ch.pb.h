...
class Ecu_status_2_516 final :
 ...
 public:
  ...
  int32_t battery_capacity() const;
  void set_battery_capacity(int32_t value);
  private:
  int32_t _internal_battery_capacity() const;
  void _internal_set_battery_capacity(int32_t value);
  public:
...
inline int32_t Ecu_status_2_516::_internal_battery_soc() const {
  return _impl_.battery_soc_;
}
inline int32_t Ecu_status_2_516::battery_soc() const {
  // @@protoc_insertion_point(field_get:apollo.canbus.Ecu_status_2_516.battery_soc)
  return _internal_battery_soc();
}
inline void Ecu_status_2_516::_internal_set_battery_soc(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.battery_soc_ = value;
}
inline void Ecu_status_2_516::set_battery_soc(int32_t value) {
...
inline void Ecu_status_2_516::clear_battery_capacity() {
  _impl_.battery_capacity_ = 0;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline int32_t Ecu_status_2_516::_internal_battery_capacity() const {
  return _impl_.battery_capacity_;
}
inline int32_t Ecu_status_2_516::battery_capacity() const {
  // @@protoc_insertion_point(field_get:apollo.canbus.Ecu_status_2_516.battery_capacity)
  return _internal_battery_capacity();
}
inline void Ecu_status_2_516::_internal_set_battery_capacity(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.battery_capacity_ = value;
}
inline void Ecu_status_2_516::set_battery_capacity(int32_t value) {
