...
PROTOBUF_CONSTEXPR Lane::Lane(
  ...
  , /*decltype(_impl_.self_reverse_lane_id_)*/{}
...
const uint32_t TableStruct_modules_2fmap_2fproto_2fmap_5flane_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::hdmap::Lane, _impl_.self_reverse_lane_id_),
  0,
  1,
  2,
  3,
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 34, 62, -1, sizeof(::apollo::hdmap::Lane)},
};
...
const ::_pbi::DescriptorTable descriptor_table_modules_2fmap_2fproto_2fmap_5flane_2eproto = {
    false, false, 1781, descriptor_table_protodef_modules_2fmap_2fproto_2fmap_5flane_2eproto,
...
void Lane::clear_self_reverse_lane_id() {
  _impl_.self_reverse_lane_id_.Clear();
}
...
Lane::Lane(const Lane& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.self_reverse_lane_id_){from._impl_.self_reverse_lane_id_}
    , decltype(_impl_.id_){nullptr}
    , decltype(_impl_.central_curve_){nullptr}
    , decltype(_impl_.left_boundary_){nullptr}
    , decltype(_impl_.right_boundary_){nullptr}
...
inline void Lane::SharedCtor(
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.self_reverse_lane_id_){arena}
    , decltype(_impl_.id_){nullptr}
    , decltype(_impl_.central_curve_){nullptr}
    , decltype(_impl_.left_boundary_){nullptr}
    , decltype(_impl_.right_boundary_){nullptr}
...
inline void Lane::SharedDtor() {
  ...
  _impl_.self_reverse_lane_id_.~RepeatedPtrField();
...
uint8_t* Lane::_InternalSerialize(
  ...
  // repeated .apollo.hdmap.Id self_reverse_lane_id = 22;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_self_reverse_lane_id_size()); i < n; i++) {
    const auto& repfield = this->_internal_self_reverse_lane_id(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
...
// @@protoc_insertion_point(message_byte_size_start:apollo.hdmap.Lane)
  ...
  for (const auto& msg : this->_impl_.self_reverse_lane_id_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.hdmap.Lane)
  ...
  _impl_.self_reverse_lane_id_.MergeFrom(from._impl_.self_reverse_lane_id_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
...
void Lane::InternalSwap(Lane* other) {
  ...
  _impl_.self_reverse_lane_id_.InternalSwap(&other->_impl_.self_reverse_lane_id_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
