...
class SpeedBump final :
 ...
 public:
  ...
  ~SpeedBump() override;
  explicit PROTOBUF_CONSTEXPR SpeedBump(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  SpeedBump* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline ::apollo::hdmap::Curve* SpeedBump::add_position() {
  ::apollo::hdmap::Curve* _add = _internal_add_position();
