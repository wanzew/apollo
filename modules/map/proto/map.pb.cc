...
const uint32_t TableStruct_modules_2fmap_2fproto_2fmap_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::hdmap::Map, _impl_.pnc_junction_),
  PROTOBUF_FIELD_OFFSET(::apollo::hdmap::Map, _impl_.rsu_),
  0,
  ~0u,
  ~0u,
  ~0u,
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 38, 58, -1, sizeof(::apollo::hdmap::Map)},
};
...
const char descriptor_table_protodef_modules_2fmap_2fproto_2fmap_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_modules_2fmap_2fproto_2fmap_2eproto_deps[13] = {
...
const ::_pbi::DescriptorTable descriptor_table_modules_2fmap_2fproto_2fmap_2eproto = {
    false, false, 1387, descriptor_table_protodef_modules_2fmap_2fproto_2fmap_2eproto,
    "modules/map/proto/map.proto",
    &descriptor_table_modules_2fmap_2fproto_2fmap_2eproto_once, descriptor_table_modules_2fmap_2fproto_2fmap_2eproto_deps, 13, 3,
...
Map::Map(const Map& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.rsu_){from._impl_.rsu_}
    , decltype(_impl_.header_){nullptr}};
...
uint8_t* Map::_InternalSerialize(
  ...
  // repeated .apollo.hdmap.PNCJunction pnc_junction = 13;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_pnc_junction_size()); i < n; i++) {
    const auto& repfield = this->_internal_pnc_junction(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
  ...
  // repeated .apollo.hdmap.RSU rsu = 14;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_rsu_size()); i < n; i++) {
    const auto& repfield = this->_internal_rsu(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
...
// @@protoc_insertion_point(message_byte_size_start:apollo.hdmap.Map)
  ...
  for (const auto& msg : this->_impl_.pnc_junction_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
  ...
  for (const auto& msg : this->_impl_.rsu_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.hdmap.Map)
  ...
  _impl_.rsu_.MergeFrom(from._impl_.rsu_);
  if (from._internal_has_header()) {
...
void Map::InternalSwap(Map* other) {
  ...
  _impl_.rsu_.InternalSwap(&other->_impl_.rsu_);
