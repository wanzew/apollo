...
inline ::apollo::hdmap::PNCJunction* Map::add_pnc_junction() {
  ::apollo::hdmap::PNCJunction* _add = _internal_add_pnc_junction();
...
inline ::apollo::hdmap::RSU* Map::mutable_rsu(int index) {
  ...
  return _impl_.rsu_.Mutable(index);
}
...
inline ::apollo::hdmap::RSU* Map::_internal_add_rsu() {
  return _impl_.rsu_.Add();
}
inline ::apollo::hdmap::RSU* Map::add_rsu() {
  ::apollo::hdmap::RSU* _add = _internal_add_rsu();
