...
class ClearArea final :
 ...
 public:
  ...
  ~ClearArea() override;
  explicit PROTOBUF_CONSTEXPR ClearArea(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ClearArea* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
