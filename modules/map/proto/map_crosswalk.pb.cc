...
static ::_pb::Metadata file_level_metadata_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto = nullptr;

const uint32_t TableStruct_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::apollo::hdmap::Crosswalk, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::apollo::hdmap::Crosswalk, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::apollo::hdmap::Crosswalk, _impl_.id_),
  PROTOBUF_FIELD_OFFSET(::apollo::hdmap::Crosswalk, _impl_.polygon_),
  PROTOBUF_FIELD_OFFSET(::apollo::hdmap::Crosswalk, _impl_.overlap_id_),
  0,
  1,
  ~0u,
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::apollo::hdmap::Crosswalk)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::apollo::hdmap::_Crosswalk_default_instance_._instance,
};
...
const char descriptor_table_protodef_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "p.Id"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto_deps[2] = {
  &::descriptor_table_modules_2fmap_2fproto_2fmap_5fgeometry_2eproto,
  &::descriptor_table_modules_2fmap_2fproto_2fmap_5fid_2eproto,
};
static ::_pbi::once_flag descriptor_table_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto = {
    false, false, 244, descriptor_table_protodef_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto,
    "modules/map/proto/map_crosswalk.proto",
    &descriptor_table_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto_once, descriptor_table_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto_deps, 2, 1,
    schemas, file_default_instances, TableStruct_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto::offsets,
    file_level_metadata_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto, file_level_enum_descriptors_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto,
    file_level_service_descriptors_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto_getter() {
  return &descriptor_table_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto(&descriptor_table_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto);
namespace apollo {
namespace hdmap {
...
class Crosswalk::_Internal {
 public:
  using HasBits = decltype(std::declval<Crosswalk>()._impl_._has_bits_);
...
void Crosswalk::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<Crosswalk *>(to)->MergeFrom(
      static_cast<const Crosswalk &>(from));
}
...
void Crosswalk::InternalSwap(Crosswalk* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Crosswalk, _impl_.polygon_)
      + sizeof(Crosswalk::_impl_.polygon_)
      - PROTOBUF_FIELD_OFFSET(Crosswalk, _impl_.id_)>(
...
::PROTOBUF_NAMESPACE_ID::Metadata Crosswalk::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto_getter, &descriptor_table_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto_once,
      file_level_metadata_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::apollo::hdmap::Crosswalk*
Arena::CreateMaybeMessage< ::apollo::hdmap::Crosswalk >(Arena* arena) {
