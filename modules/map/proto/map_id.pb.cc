...
static ::_pb::Metadata file_level_metadata_modules_2fmap_2fproto_2fmap_5fid_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_modules_2fmap_2fproto_2fmap_5fid_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_modules_2fmap_2fproto_2fmap_5fid_2eproto = nullptr;

const uint32_t TableStruct_modules_2fmap_2fproto_2fmap_5fid_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::apollo::hdmap::Id, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::apollo::hdmap::Id, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::apollo::hdmap::Id, _impl_.id_),
  0,
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 7, -1, sizeof(::apollo::hdmap::Id)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::apollo::hdmap::_Id_default_instance_._instance,
};
...
const char descriptor_table_protodef_modules_2fmap_2fproto_2fmap_5fid_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ".hdmap\"\020\n\002Id\022\n\n\002id\030\001 \001(\t"
  ;
static ::_pbi::once_flag descriptor_table_modules_2fmap_2fproto_2fmap_5fid_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_modules_2fmap_2fproto_2fmap_5fid_2eproto = {
    false, false, 64, descriptor_table_protodef_modules_2fmap_2fproto_2fmap_5fid_2eproto,
    "modules/map/proto/map_id.proto",
    &descriptor_table_modules_2fmap_2fproto_2fmap_5fid_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_modules_2fmap_2fproto_2fmap_5fid_2eproto::offsets,
    file_level_metadata_modules_2fmap_2fproto_2fmap_5fid_2eproto, file_level_enum_descriptors_modules_2fmap_2fproto_2fmap_5fid_2eproto,
    file_level_service_descriptors_modules_2fmap_2fproto_2fmap_5fid_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_modules_2fmap_2fproto_2fmap_5fid_2eproto_getter() {
  return &descriptor_table_modules_2fmap_2fproto_2fmap_5fid_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_modules_2fmap_2fproto_2fmap_5fid_2eproto(&descriptor_table_modules_2fmap_2fproto_2fmap_5fid_2eproto);
namespace apollo {
namespace hdmap {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "apollo.hdmap.Id.id");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::Metadata Id::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_modules_2fmap_2fproto_2fmap_5fid_2eproto_getter, &descriptor_table_modules_2fmap_2fproto_2fmap_5fid_2eproto_once,
      file_level_metadata_modules_2fmap_2fproto_2fmap_5fid_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::apollo::hdmap::Id*
Arena::CreateMaybeMessage< ::apollo::hdmap::Id >(Arena* arena) {
