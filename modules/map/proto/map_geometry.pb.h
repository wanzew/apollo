...
class LineSegment final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR LineSegment(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  LineSegment* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class CurveSegment final :
 ...
 public:
  ...
  ~CurveSegment() override;
  explicit PROTOBUF_CONSTEXPR CurveSegment(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  CurveSegment* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::apollo::common::PointENU* release_start_position();
  ...
  PROTOBUF_NODISCARD ::apollo::hdmap::LineSegment* release_line_segment();
...
inline ::apollo::common::PointENU* Polygon::add_point() {
  ::apollo::common::PointENU* _add = _internal_add_point();
...
inline void CurveSegment::set_has_line_segment() {
  _impl_._oneof_case_[0] = kLineSegment;
}
...
inline ::apollo::hdmap::LineSegment* CurveSegment::release_line_segment() {
  ...
  if (_internal_has_line_segment()) {
    clear_has_curve_type();
    ::apollo::hdmap::LineSegment* temp = _impl_.curve_type_.line_segment_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.curve_type_.line_segment_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::apollo::hdmap::LineSegment* CurveSegment::_internal_mutable_line_segment() {
  if (!_internal_has_line_segment()) {
    clear_curve_type();
    set_has_line_segment();
    _impl_.curve_type_.line_segment_ = CreateMaybeMessage< ::apollo::hdmap::LineSegment >(GetArenaForAllocation());
  }
  return _impl_.curve_type_.line_segment_;
}
inline ::apollo::hdmap::LineSegment* CurveSegment::mutable_line_segment() {
  ::apollo::hdmap::LineSegment* _msg = _internal_mutable_line_segment();
...
inline const ::apollo::common::PointENU& CurveSegment::_internal_start_position() const {
  const ::apollo::common::PointENU* p = _impl_.start_position_;
...
inline ::apollo::common::PointENU* CurveSegment::release_start_position() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::apollo::common::PointENU* temp = _impl_.start_position_;
...
inline ::apollo::common::PointENU* CurveSegment::mutable_start_position() {
  ::apollo::common::PointENU* _msg = _internal_mutable_start_position();
...
inline CurveSegment::CurveTypeCase CurveSegment::curve_type_case() const {
  return CurveSegment::CurveTypeCase(_impl_._oneof_case_[0]);
}
// -------------------------------------------------------------------
...
inline ::apollo::hdmap::CurveSegment* Curve::add_segment() {
  ::apollo::hdmap::CurveSegment* _add = _internal_add_segment();
