...
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_modules_2fmap_2fproto_2fmap_5fjunction_2eproto = nullptr;
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::apollo::hdmap::Junction)},
};
...
const ::_pbi::DescriptorTable descriptor_table_modules_2fmap_2fproto_2fmap_5fjunction_2eproto = {
    false, false, 242, descriptor_table_protodef_modules_2fmap_2fproto_2fmap_5fjunction_2eproto,
...
void Junction::InternalSwap(Junction* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Junction, _impl_.polygon_)
      + sizeof(Junction::_impl_.polygon_)
