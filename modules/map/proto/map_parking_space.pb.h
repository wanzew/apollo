...
class ParkingSpace final :
 ...
 public:
  ...
  ~ParkingSpace() override;
  explicit PROTOBUF_CONSTEXPR ParkingSpace(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ParkingSpace* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class ParkingLot final :
 ...
 public:
  ...
  ~ParkingLot() override;
  explicit PROTOBUF_CONSTEXPR ParkingLot(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ParkingLot* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
