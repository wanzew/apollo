...
class LanesXmlParser {
 ...
 private:
  ...
  static Status ParseSingleSideRoadSampleAssociates(const tinyxml2::XMLElement& xml_node,
                                                    bool                        bleft,
                                                    PbLane*                     lane);
  static Status ParseLeftRoadSampleAssociates(const tinyxml2::XMLElement& xml_node, PbLane* lane);
  static Status ParseRightRoadSampleAssociates(const tinyxml2::XMLElement& xml_node, PbLane* lane);
