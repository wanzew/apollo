...
DEFINE_double(max_len_from_navigation_line,
              250.0,
              "max navigation path length from navigation line");

DEFINE_double(min_len_for_navigation_lane, 150.0, "min generated navigation lane length");

DEFINE_double(max_len_for_navigation_lane, 250.0, "max generated navigation lane length");

DEFINE_double(ratio_navigation_lane_len_to_speed, 8.0, "navigation lane length to adv speed ratio");

DEFINE_double(max_distance_to_navigation_line,
              15.0,
              "max distance to navigation line in navigation mode");

DEFINE_double(min_view_range_to_use_lane_marker, 0.5, "min view range to use lane_marker");
