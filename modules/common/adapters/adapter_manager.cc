...
void AdapterManager::Init(const AdapterManagerConfig& configs) {
  ...
  for (const auto& config : configs.config()) {
    switch (config.type()) {
      case AdapterConfig::POINT_CLOUD: EnablePointCloud(FLAGS_pointcloud_topic, config); break;
      case AdapterConfig::POINT_CLOUD_RAW:
        EnablePointCloudRaw0(FLAGS_pointcloud_raw_topic, config);
        break;
      case AdapterConfig::VELODYNE_RAW: EnableVelodyneRaw0(FLAGS_velodyne_raw_topic, config); break;
      ...
      case AdapterConfig::VLP16_POINT_CLOUD:
        ...
        break;
      case AdapterConfig::GPS: EnableGps(FLAGS_gps_topic, config); break;
      case AdapterConfig::IMU: EnableImu(FLAGS_imu_topic, config); break;
      case AdapterConfig::RAW_IMU: EnableRawImu(FLAGS_raw_imu_topic, config); break;
      case AdapterConfig::CHASSIS: EnableChassis(FLAGS_chassis_topic, config); break;
      ...
      case AdapterConfig::PERCEPTION_LANE_MASK:
        EnablePerceptionLaneMask(FLAGS_perception_lane_mask_segmentation_topic, config);
        break;
      case AdapterConfig::TRAFFIC_LIGHT_DETECTION:
        EnableTrafficLightDetection(FLAGS_traffic_light_detection_topic, config);
        break;
      case AdapterConfig::PAD: EnablePad(FLAGS_pad_topic, config); break;
      ...
      case AdapterConfig::MONITOR: EnableMonitor(FLAGS_monitor_topic, config); break;
      ...
      case AdapterConfig::RELATIVE_ODOMETRY:
        ...
        break;
      case AdapterConfig::INS_STAT: EnableInsStat(FLAGS_ins_stat_topic, config); break;
      case AdapterConfig::INS_STATUS: EnableInsStatus(FLAGS_ins_status_topic, config); break;
      case AdapterConfig::GNSS_STATUS: EnableGnssStatus(FLAGS_gnss_status_topic, config); break;
      case AdapterConfig::SYSTEM_STATUS:
        EnableSystemStatus(FLAGS_system_status_topic, config);
        break;
      case AdapterConfig::STATIC_INFO: EnableStaticInfo(FLAGS_static_info_topic, config); break;
      case AdapterConfig::MOBILEYE: EnableMobileye(FLAGS_mobileye_topic, config); break;
      case AdapterConfig::DELPHIESR: EnableDelphiESR(FLAGS_delphi_esr_topic, config); break;
      case AdapterConfig::CONTI_RADAR: EnableContiRadar(FLAGS_conti_radar_topic, config); break;
      ...
      case AdapterConfig::COMPRESSED_IMAGE:
        ...
        break;
      case AdapterConfig::IMAGE_FRONT: EnableImageFront(FLAGS_image_front_topic, config); break;
      case AdapterConfig::IMAGE_SHORT: EnableImageShort(FLAGS_image_short_topic, config); break;
      case AdapterConfig::IMAGE_LONG: EnableImageLong(FLAGS_image_long_topic, config); break;
      case AdapterConfig::DRIVE_EVENT: EnableDriveEvent(FLAGS_drive_event_topic, config); break;
      case AdapterConfig::GNSS_RTK_OBS: EnableGnssRtkObs(FLAGS_gnss_rtk_obs_topic, config); break;
      case AdapterConfig::GNSS_RTK_EPH: EnableGnssRtkEph(FLAGS_gnss_rtk_eph_topic, config); break;
      ...
      case AdapterConfig::LOCALIZATION_MSF_STATUS:
        ...
        break;
      case AdapterConfig::RELATIVE_MAP: EnableRelativeMap(FLAGS_relative_map_topic, config); break;
      case AdapterConfig::NAVIGATION: EnableNavigation(FLAGS_navigation_topic, config); break;
      case AdapterConfig::VOICE_DETECTION_REQUEST:
        EnableVoiceDetectionRequest(FLAGS_voice_detection_request_topic, config);
        break;
      case AdapterConfig::VOICE_DETECTION_RESPONSE:
        EnableVoiceDetectionResponse(FLAGS_voice_detection_response_topic, config);
        break;
      // For pandora.
      ...
      case AdapterConfig::PANDORA_CAMERA_FRONT_COLOR:
        EnablePandoraCameraFrontColor(FLAGS_pandora_camera_front_color_topic, config);
        break;
      case AdapterConfig::PANDORA_CAMERA_RIGHT_GRAY:
        EnablePandoraCameraRightGray(FLAGS_pandora_camera_right_gray_topic, config);
        break;
      case AdapterConfig::PANDORA_CAMERA_LEFT_GRAY:
        EnablePandoraCameraLeftGray(FLAGS_pandora_camera_left_gray_topic, config);
        break;
      case AdapterConfig::PANDORA_CAMERA_FRONT_GRAY:
        EnablePandoraCameraFrontGray(FLAGS_pandora_camera_front_gray_topic, config);
        break;
      case AdapterConfig::PANDORA_CAMERA_BACK_GRAY:
        EnablePandoraCameraBackGray(FLAGS_pandora_camera_back_gray_topic, config);
        break;
      case AdapterConfig::GUARDIAN: EnableGuardian(FLAGS_guardian_topic, config);
      ...
      case AdapterConfig::STREAM_STATUS:
        ...
        break;
      case AdapterConfig::GNSS_HEADING: EnableGnssHeading(FLAGS_heading_topic, config); break;
      case AdapterConfig::RTCM_DATA: EnableRtcmData(FLAGS_rtcm_data_topic, config); break;
      default: AERROR << "Unknown adapter config type!"; break;
    }
  }
}
