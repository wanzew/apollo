...
DEFINE_bool(enable_adapter_dump,
            false,
...
DEFINE_string(audio_detection_topic, "/apollo/audio_detection", "audio detection topic name");
DEFINE_string(chassis_topic, "/apollo/canbus/chassis", "chassis topic name");
DEFINE_string(chassis_detail_topic, "/apollo/canbus/chassis_detail", "chassis detail topic name");
DEFINE_string(localization_topic, "/apollo/localization/pose", "localization topic name");
DEFINE_string(planning_learning_data_topic,
...
DEFINE_string(planning_pad_topic, "/apollo/planning/pad", "planning pad topic name");
...
DEFINE_string(control_command_topic, "/apollo/control", "control command topic name");
DEFINE_string(control_preprocessor_topic,
              "/apollo/control/preprocessor",
              "control preprocessor topic name");
DEFINE_string(control_local_view_topic,
              "/apollo/control/localview",
              "control local view topic name");
DEFINE_string(control_core_command_topic,
              "/apollo/control/controlcore",
...
DEFINE_string(pointcloud_raw_topic,
...
DEFINE_string(lidar_128_topic, "/apollo/sensor/lidar128/PointCloud2", "128 beam lidar topic name");
DEFINE_string(prediction_topic, "/apollo/prediction", "prediction topic name");
DEFINE_string(prediction_container_topic,
              "/apollo/prediction_container",
              "prediction container submodule topic name");
DEFINE_string(perception_obstacle_topic,
              "/apollo/perception/obstacles",
              "perception obstacle topic name");
DEFINE_string(drive_event_topic, "/apollo/drive_event", "drive event topic name");
...
DEFINE_string(routing_response_topic, "/apollo/routing_response", "routing response topic name");
DEFINE_string(routing_response_history_topic,
              "/apollo/routing_response_history",
              "routing response history topic name");
DEFINE_string(relative_odometry_topic,
              "/apollo/calibration/relative_odometry",
              "relative odometry topic name");
DEFINE_string(ins_stat_topic, "/apollo/sensor/gnss/ins_stat", "ins stat topic name");
DEFINE_string(ins_status_topic, "/apollo/sensor/gnss/ins_status", "ins status topic name");
DEFINE_string(gnss_status_topic, "/apollo/sensor/gnss/gnss_status", "gnss status topic name");
DEFINE_string(system_status_topic, "/apollo/monitor/system_status", "System status topic name");
DEFINE_string(static_info_topic, "/apollo/monitor/static_info", "Static info topic name");
DEFINE_string(mobileye_topic, "/apollo/sensor/mobileye", "mobileye topic name");
DEFINE_string(smartereye_obstacles_topic,
              "/apollo/sensor/smartereye/obstacles",
              "smartereye obstacles topic name");
DEFINE_string(smartereye_lanemark_topic,
              "/apollo/sensor/smartereye/lanemark",
              "smartereye lanemark topic name");
DEFINE_string(smartereye_image_topic,
              "/apollo/sensor/smartereye/image",
              "smartereye image topic name");
DEFINE_string(delphi_esr_topic, "/apollo/sensor/delphi_esr", "delphi esr radar topic name");
DEFINE_string(conti_radar_topic, "/apollo/sensor/conti_radar", "continental radar topic name");
DEFINE_string(racobit_radar_topic, "/apollo/sensor/racobit_radar", "racobit radar topic name");
DEFINE_string(ultrasonic_radar_topic,
              "/apollo/sensor/ultrasonic_radar",
              "ultrasonic esr radar topic name");
DEFINE_string(front_radar_topic, "/apollo/sensor/radar/front", "front radar topic name");
DEFINE_string(rear_radar_topic, "/apollo/sensor/radar/rear", "rear radar topic name");
// TODO(Authors): Change the topic name
DEFINE_string(compressed_image_topic, "camera/image_raw", "CompressedImage topic name");
DEFINE_string(image_front_topic,
...
DEFINE_string(image_long_topic,
              "/apollo/sensor/camera/traffic/image_long",
              "long camera image topic name");
DEFINE_string(image_usb_cam_topic,
              "/apollo/sensor/camera/image_usb_cam",
              "USB camera image topic name");
DEFINE_string(camera_image_long_topic,
              "/apollo/sensor/camera/image_long",
              "long camera image topic name");
DEFINE_string(camera_image_short_topic,
              "/apollo/sensor/camera/image_short",
              "short camera image topic name");
DEFINE_string(camera_front_6mm_topic,
              "/apollo/sensor/camera/front_6mm/image",
...
DEFINE_string(camera_rear_6mm_video_compressed_topic,
              ...
              "front 6mm camera video compressed topic name");
DEFINE_string(gnss_rtk_obs_topic, "/apollo/sensor/gnss/rtk_obs", "Gnss rtk observation topic name");
DEFINE_string(gnss_rtk_eph_topic, "/apollo/sensor/gnss/rtk_eph", "Gnss rtk ephemeris topic name");
DEFINE_string(gnss_best_pose_topic, "/apollo/sensor/gnss/best_pose", "Gnss rtk best gnss pose");
...
DEFINE_string(localization_ndt_topic,
              "/apollo/localization/ndt_lidar",
              "NDT localization lidar measurement topic name");
DEFINE_string(localization_sins_pva_topic,
              "/apollo/localization/msf_sins_pva",
              "Localization sins pva topic name");
DEFINE_string(localization_msf_status,
...
DEFINE_string(audio_capture_topic, "/apollo/hmi/audio_capture", "HMI audio capture topic name.");
...
DEFINE_string(v2x_internal_obstacle_topic,
              "/apollo/v2x/obu/internal/obstacles",
              "v2x internal obstacles topic name");
DEFINE_string(v2x_obstacle_topic, "/apollo/v2x/obstacles", "v2x obstacles topic name");
DEFINE_string(v2x_traffic_light_topic, "/apollo/v2x/traffic_light", "v2x traffic light topic name");
...
DEFINE_string(storytelling_topic, "/apollo/storytelling", "Storytelling topic.");
...
DEFINE_string(gnss_raw_data_topic, "/apollo/sensor/gnss/raw_data", "gnss raw data topic name");
DEFINE_string(stream_status_topic,
              "/apollo/sensor/gnss/stream_status",
              "gnss stream status topic name");
DEFINE_string(heading_topic, "/apollo/sensor/gnss/heading", "gnss heading topic name");
DEFINE_string(rtcm_data_topic, "/apollo/sensor/gnss/rtcm_data", "gnss rtcm data topic name");
DEFINE_string(tf_topic, "/tf", "Transform topic.");
DEFINE_string(tf_static_topic, "/tf_static", "Transform static topic.");
DEFINE_string(recorder_status_topic, "/apollo/data/recorder/status", "Recorder status topic.");
DEFINE_string(latency_recording_topic,
              "/apollo/common/latency_records",
              "Latency recording topic.");
DEFINE_string(latency_reporting_topic,
