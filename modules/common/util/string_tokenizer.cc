...
StringTokenizer::StringTokenizer(const std::string& s, const std::string& delims) {
  s_      = s;
  delims_ = delims;
...
std::vector<std::string> StringTokenizer::Split(const std::string& str, const std::string& delims) {
