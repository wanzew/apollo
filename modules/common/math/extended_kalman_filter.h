...
class ExtendedKalmanFilter {
 public:
   ...
   */
  ExtendedKalmanFilter(const Eigen::Matrix<T, XN, 1>& x, const Eigen::Matrix<T, XN, XN>& P)
      : ExtendedKalmanFilter() {
   ...
   */
  void SetTransitionModel(std::function<Eigen::Matrix<T, XN, 1>(const Eigen::Matrix<T, XN, 1>&,
   ...
   */
  void SetObservationModel(std::function<Eigen::Matrix<T, ZN, 1>(const Eigen::Matrix<T, XN, 1>&)> h,
...
template <typename T, unsigned int XN, unsigned int ZN, unsigned int UN>
inline void ExtendedKalmanFilter<T, XN, ZN, UN>::Predict(const Eigen::Matrix<T, UN, 1>& u) {
  x_ = f_(x_, u);
...
template <typename T, unsigned int XN, unsigned int ZN, unsigned int UN>
inline void ExtendedKalmanFilter<T, XN, ZN, UN>::Correct(const Eigen::Matrix<T, ZN, 1>& z) {
  y_ = z - h_(x_);
