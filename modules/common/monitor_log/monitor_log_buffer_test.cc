...
TEST_F(MonitorBufferTest, PrintLog) {
  ...
  }
  {
    ...
    testing::internal::CaptureStderr();
    buffer_->PrintLog();
    EXPECT_NE(std::string::npos, testing::internal::GetCapturedStderr().find("INFO_msg"));
  }
  {
    buffer_->ERROR("ERROR_msg");
    testing::internal::CaptureStderr();
    buffer_->PrintLog();
    EXPECT_NE(std::string::npos, testing::internal::GetCapturedStderr().find("ERROR_msg"));
  }
  {
    buffer_->WARN("WARN_msg");
    testing::internal::CaptureStderr();
    buffer_->PrintLog();
    EXPECT_NE(std::string::npos, testing::internal::GetCapturedStderr().find("WARN_msg"));
  }
  {
