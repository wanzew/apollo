...
constexpr MonitorMessageItem_MessageSource MonitorMessageItem_MessageSource_MessageSource_MAX = MonitorMessageItem_MessageSource_GNSS;
...
class MonitorMessageItem final :
 ...
 public:
  ...
  ~MonitorMessageItem() override;
  explicit PROTOBUF_CONSTEXPR MonitorMessageItem(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  MonitorMessageItem* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class MonitorMessage final :
 ...
 public:
  ...
  ~MonitorMessage() override;
  explicit PROTOBUF_CONSTEXPR MonitorMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  MonitorMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline ::apollo::common::monitor::MonitorMessageItem_MessageSource MonitorMessageItem::_internal_source() const {
  return static_cast< ::apollo::common::monitor::MonitorMessageItem_MessageSource >(_impl_.source_);
}
...
void MonitorMessageItem::set_msg(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
inline ::apollo::common::monitor::MonitorMessageItem_LogLevel MonitorMessageItem::_internal_log_level() const {
  return static_cast< ::apollo::common::monitor::MonitorMessageItem_LogLevel >(_impl_.log_level_);
}
...
inline ::apollo::common::monitor::MonitorMessageItem* MonitorMessage::add_item() {
  ::apollo::common::monitor::MonitorMessageItem* _add = _internal_add_item();
