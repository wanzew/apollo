...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 21, -1, sizeof(::apollo::common::VehicleState)},
};
...
const ::_pbi::DescriptorTable descriptor_table_modules_2fcommon_2fvehicle_5fstate_2fproto_2fvehicle_5fstate_2eproto = {
    false, false, 555, descriptor_table_protodef_modules_2fcommon_2fvehicle_5fstate_2fproto_2fvehicle_5fstate_2eproto,
...
VehicleState::VehicleState(const VehicleState& from)
  ...
  ::memcpy(&_impl_.x_, &from._impl_.x_,
    ...
    reinterpret_cast<char*>(&_impl_.x_)) + sizeof(_impl_.driving_mode_));
...
// @@protoc_insertion_point(message_clear_start:apollo.common.VehicleState)
  ...
  if (cached_has_bits & 0x00007f00u) {
    ::memset(&_impl_.heading_, 0, static_cast<size_t>(
        ...
        reinterpret_cast<char*>(&_impl_.heading_)) + sizeof(_impl_.driving_mode_));
  }
...
void VehicleState::InternalSwap(VehicleState* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(VehicleState, _impl_.driving_mode_)
      + sizeof(VehicleState::_impl_.driving_mode_)
