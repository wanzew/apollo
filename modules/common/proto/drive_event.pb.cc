...
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_modules_2fcommon_2fproto_2fdrive_5fevent_2eproto = nullptr;
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::apollo::common::DriveEvent)},
};
...
const ::_pbi::DescriptorTable descriptor_table_modules_2fcommon_2fproto_2fdrive_5fevent_2eproto = {
    false, false, 242, descriptor_table_protodef_modules_2fcommon_2fproto_2fdrive_5fevent_2eproto,
    "modules/common/proto/drive_event.proto",
...
void DriveEvent::InternalSwap(DriveEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(DriveEvent, _impl_.location_)
      + sizeof(DriveEvent::_impl_.location_)
