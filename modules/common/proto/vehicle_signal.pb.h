...
class VehicleSignal final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR VehicleSignal(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  VehicleSignal* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline ::apollo::common::VehicleSignal_TurnSignal VehicleSignal::_internal_turn_signal() const {
  return static_cast< ::apollo::common::VehicleSignal_TurnSignal >(_impl_.turn_signal_);
}
