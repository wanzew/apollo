...
bool LaneSequencePredictor::Predict(const ADCTrajectoryContainer* adc_trajectory_container,
                                    Obstacle*                     obstacle,
  ...
  for (int i = 0; i < num_lane_sequence; ++i) {
    ...
    if (is_about_to_stop) {
      ...
      DrawLaneSequenceTrajectoryPoints(*obstacle, sequence, FLAGS_prediction_trajectory_time_length,
...
void LaneSequencePredictor::DrawLaneSequenceTrajectoryPoints(const Obstacle&     obstacle,
