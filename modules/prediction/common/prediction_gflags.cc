...
DEFINE_double(prediction_trajectory_time_length,
              8.0,
              "Time length of predicted trajectory (in seconds)");
DEFINE_double(prediction_trajectory_time_resolution,
              0.1,
              "Time resolution of predicted trajectory (in seconds");
DEFINE_double(min_prediction_trajectory_spatial_length,
              100.0,
              "Minimal spatial length of predicted trajectory");
DEFINE_bool(enable_trajectory_validation_check,
            false,
            "If check the validity of prediction trajectory.");
DEFINE_bool(enable_tracking_adaptation, false, "If enable prediction tracking adaptation");

DEFINE_double(vehicle_max_linear_acc, 4.0, "Upper bound of vehicle linear acceleration");
DEFINE_double(vehicle_min_linear_acc, -4.0, "Lower bound of vehicle linear deceleration");
DEFINE_double(vehicle_max_speed, 35.0, "Max speed of vehicle");

// Tracking Adaptation
DEFINE_double(max_tracking_time, 0.5, "Max tracking time for disappear obstacles");
DEFINE_double(max_tracking_dist, 3.0, "Max tracking distance for disappear obstacles");

// Map
DEFINE_double(lane_search_radius, 3.0, "Search radius for a candidate lane");
DEFINE_double(lane_search_radius_in_junction, 15.0, "Search radius for a candidate lane");
DEFINE_double(junction_search_radius, 1.0, "Search radius for a junction");
DEFINE_double(pedestrian_nearby_lane_search_radius,
              5.0,
              "Radius to determine if pedestrian-like obstacle is near lane.");
DEFINE_int32(road_graph_max_search_horizon, 20, "Maximal search depth for building road graph");
DEFINE_double(surrounding_lane_search_radius, 3.0, "Search radius for surrounding lanes.");

// Semantic Map
DEFINE_double(base_image_half_range, 100.0, "The half range of base image.");
DEFINE_bool(enable_draw_adc_trajectory, true, "If draw adc trajectory in semantic map");
DEFINE_bool(img_show_semantic_map, false, "If show the image of semantic map.");

// Scenario
DEFINE_double(junction_distance_threshold,
              10.0,
              "Distance threshold "
              "to junction to consider as junction scenario");
DEFINE_bool(enable_all_junction, false, "If consider all junction with junction_mlp_model.");
DEFINE_bool(enable_all_pedestrian_caution_in_front,
            false,
            "If true, then all pedestrian in front of ADC are marked caution.");
DEFINE_bool(enable_rank_caution_obstacles, true, "Rank the caution-level obstacles.");
DEFINE_bool(enable_rank_interactive_obstacles, true, "Rank the interactive obstacles.");
DEFINE_int32(caution_obs_max_nums, 6, "The max number of caution-level obstacles");
DEFINE_double(caution_distance_threshold, 60.0, "Distance threshold for caution obstacles");
DEFINE_double(caution_search_distance_ahead,
              50.0,
              "The distance ahead to search caution-level obstacles");
DEFINE_double(caution_search_distance_backward,
              50.0,
              "The distance backward to search caution-level obstacles");
DEFINE_double(caution_search_distance_backward_for_merge,
              60.0,
              "The distance backward to search caution-lebel obstacles "
              "in the case of merging");
DEFINE_double(caution_search_distance_backward_for_overlap,
              30.0,
              "The distance backward to search caution-lebel obstacles "
              "in the case of overlap");
DEFINE_double(caution_pedestrian_approach_time,
              3.0,
              "The time for a pedestrian to approach adc trajectory");
DEFINE_int32(interactive_obs_max_nums, 6, "The max number of interactive obstacles");
DEFINE_double(interaction_distance_threshold, 60.0, "Distance threshold for interactive obstacles");
DEFINE_double(interaction_search_distance_ahead,
              50.0,
              "The distance ahead to search interactive obstacles");
DEFINE_double(interaction_search_distance_backward,
              50.0,
...
DEFINE_double(interaction_search_distance_backward_for_merge,
              ...
              "The distance backward to search interactive obstacles "
              "in the case of merging");
DEFINE_double(interaction_search_distance_backward_for_overlap,
              30.0,
              "The distance backward to search interactive obstacles "
              "in the case of overlap");
...
DEFINE_double(back_dist_ignore_ped, -2.0, "Backward distance to ignore pedestrians.");
DEFINE_uint64(cruise_historical_frame_length,
              5,
...
DEFINE_double(max_angle_diff_to_adjust_velocity,
              M_PI / 6.0,
...
DEFINE_double(go_approach_rate,
              0.995,
              "The rate to approach to the reference line of going straight");
DEFINE_double(cutin_approach_rate, 0.95, "The rate to approach to the reference line of cutin");

DEFINE_int32(min_still_obstacle_history_length, 4, "Min # historical frames for still obstacles");
DEFINE_int32(max_still_obstacle_history_length, 10, "Min # historical frames for still obstacles");
DEFINE_double(still_obstacle_speed_threshold, 0.99, "Speed threshold for still obstacles");
DEFINE_double(still_pedestrian_speed_threshold, 0.2, "Speed threshold for still pedestrians");
DEFINE_double(still_unknown_speed_threshold, 0.5, "Speed threshold for still unknown obstacles");
DEFINE_double(still_obstacle_position_std, 0.5, "Position standard deviation for still obstacles");
DEFINE_double(still_pedestrian_position_std,
              0.5,
              "Position standard deviation for still pedestrians");
DEFINE_double(still_unknown_position_std,
              0.5,
              "Position standard deviation for still unknown obstacles");
DEFINE_double(slow_obstacle_speed_threshold, 2.0, "Speed threshold for slow obstacles");
...
DEFINE_double(max_lane_angle_diff, M_PI / 3.0, "Max angle difference for a candidate lane");
DEFINE_int32(max_num_current_lane_in_junction, 3, "Max number to search current lanes");
DEFINE_int32(max_num_nearby_lane_in_junction, 2, "Max number to search nearby lanes");
DEFINE_double(max_lane_angle_diff_in_junction,
              M_PI / 4.0,
...
DEFINE_string(torch_vehicle_semantic_lstm_cpu_file,
...
DEFINE_int32(max_num_obstacles, 300, "maximal number of obstacles stored in obstacles container.");
DEFINE_double(valid_position_diff_threshold, 0.5, "threshold of valid position difference");
DEFINE_double(valid_position_diff_rate_threshold,
              0.075,
              "threshold of valid position difference rate");
DEFINE_double(split_rate, 0.5, "obstacle split rate for adjusting velocity");
DEFINE_double(rnn_min_lane_relatice_s, 5.0, "Minimal relative s for RNN model.");
DEFINE_bool(adjust_velocity_by_obstacle_heading, false, "Use obstacle heading for velocity.");
DEFINE_bool(adjust_velocity_by_position_shift, false, "adjust velocity heading to lane heading");
DEFINE_bool(adjust_vehicle_heading_by_lane, true, "adjust vehicle heading by lane");
DEFINE_double(heading_filter_param, 0.98, "heading filter parameter");
DEFINE_uint64(max_num_lane_point, 20, "The maximal number of lane points to store");
DEFINE_double(distance_threshold_to_junction_exit, 1.0, "Threshold of distance to junction exit");
DEFINE_double(angle_threshold_to_junction_exit, M_PI * 0.25, "Threshold of angle to junction exit");
DEFINE_uint32(sample_size_for_average_lane_curvature,
              10,
              "The sample size to compute average lane curvature");

// Validation checker
DEFINE_double(centripetal_acc_coeff, 0.5, "Coefficient of centripetal acceleration probability");

// Junction Scenario
DEFINE_uint32(junction_historical_frame_length,
              5,
              "The number of historical frames of the obstacle"
              "that the junction model will look at.");
DEFINE_double(junction_exit_lane_threshold,
              0.1,
              "If a lane extends out of the junction by this value,"
              "consider it as an exit_lane.");
DEFINE_double(distance_beyond_junction,
              0.5,
              "If the obstacle is in junction more than this threshold,"
              "consider it in junction.");
DEFINE_double(defualt_junction_range, 10.0, "Default value for the range of a junction.");
DEFINE_double(distance_to_slow_down_at_stop_sign, 80.0, "The distance to slow down at stop sign");

// Evaluator
DEFINE_double(time_to_center_if_not_reach,
              10.0,
              "Default value of time to lane center of not reach.");
DEFINE_double(default_s_if_no_obstacle_in_lane_sequence,
              1000.0,
              "The default s value if no obstacle in the lane sequence.");
DEFINE_double(default_l_if_no_obstacle_in_lane_sequence,
              10.0,
...
// Obstacle trajectory
DEFINE_bool(enable_cruise_regression, false, "If enable using regression in cruise model");
DEFINE_double(lane_sequence_threshold_cruise,
              0.5,
              "Threshold for trimming lane sequence trajectories in cruise");
DEFINE_double(lane_sequence_threshold_junction,
              0.5,
...
DEFINE_bool(enable_lane_sequence_acc, false, "If use acceleration in lane sequence.");
DEFINE_bool(enable_trim_prediction_trajectory,
            true,
            "If trim the prediction trajectory to avoid crossing"
            "protected adc planning trajectory.");
DEFINE_double(adc_trajectory_search_length,
              10.0,
...
DEFINE_double(default_lateral_approach_speed,
              0.5,
              "Default lateral speed approaching to center of lane");
DEFINE_double(centripedal_acc_threshold, 2.0, "Threshold of centripedal acceleration.");

// move sequence prediction
DEFINE_double(time_upper_bound_to_lane_center,
              6.0,
              "Upper bound of time to get to the lane center");
DEFINE_double(time_lower_bound_to_lane_center,
              1.0,
              "Lower bound of time to get to the lane center");
DEFINE_double(sample_time_gap, 0.5, "Gap of time to sample time to get to the lane center");
DEFINE_double(cost_alpha, 100.0, "The coefficient of lateral acceleration in cost function");
DEFINE_double(default_time_to_lat_end_state, 5.0, "The default time to lane center");
DEFINE_double(turning_curvature_lower_bound, 0.02, "The curvature lower bound of turning lane");
DEFINE_double(turning_curvature_upper_bound, 0.14, "The curvature upper bound of turning lane");
DEFINE_double(speed_at_lower_curvature,
              8.5,
              "The speed at turning lane with lower bound curvature");
DEFINE_double(speed_at_upper_curvature,
              3.0,
              "The speed at turning lane with upper bound curvature");
DEFINE_double(cost_function_alpha,
              0.25,
              ...
              "and vice versa.");
DEFINE_double(cost_function_sigma,
              5.0,
...
DEFINE_bool(use_bell_curve_for_cost_function,
            false,
            "Whether to use bell curve for the cost function or not.");

// interaction predictor
DEFINE_bool(enable_interactive_tag, true, "Whether to set interactive tag for obstacles.");
DEFINE_double(collision_cost_time_resolution,
              1.0,
              "The time resolution used to compute the collision cost");
DEFINE_double(longitudinal_acceleration_cost_weight,
              0.2,
              "The weight of longitudinal acceleration cost");
DEFINE_double(centripedal_acceleration_cost_weight,
              0.1,
              "The weight of the cost related to centripedal acceleration");
DEFINE_double(collision_cost_weight, 1.0, "The weight of the cost related to collision");
DEFINE_double(collision_cost_exp_coefficient,
              1.0,
              "The coefficient in the collision exponential cost function");
DEFINE_double(likelihood_exp_coefficient,
              1.0,
              "The coefficient in the likelihood exponential function");

DEFINE_double(lane_distance_threshold,
              3.0,
              "The threshold for distance to ego/neighbor lane "
              "in feature extraction");

DEFINE_double(lane_angle_difference_threshold,
              M_PI * 0.25,
              "The threshold for distance to ego/neighbor lane "
              "in feature extraction");

// Trajectory evaluation
DEFINE_double(distance_threshold_on_lane, 1.5, "The threshold of distance in on-lane situation");
