...
// System gflags
DEFINE_string(prediction_module_name, "prediction", "Default prediciton module name");
...
DEFINE_double(min_prediction_length, 20.0, "Minimal length of prediction trajectory");
...
DEFINE_double(still_obstacle_speed_threshold, 2.0, "Speed threshold for still obstacles");
DEFINE_double(still_pedestrian_speed_threshold, 0.5, "Speed threshold for still pedestrians");
DEFINE_double(still_obstacle_position_std, 1.0, "Position standard deviation for still obstacles");
...
DEFINE_double(max_lane_angle_diff, M_PI / 2.0, "Max angle difference for a candiate lane");
DEFINE_int32(max_num_current_lane_in_junction, 1, "Max number to search current lanes");
DEFINE_int32(max_num_nearby_lane_in_junction, 0, "Max number to search nearby lanes");
...
DEFINE_int32(max_num_obstacles, 100, "maximal number of obstacles stored in obstacles container.");
...
DEFINE_uint32(max_num_lane_point, 20, "The maximal number of lane points to store");

// Validation checker
DEFINE_double(centripetal_acc_coeff, 0.5, "Coefficient of centripetal acceleration probability");

// Obstacle trajectory
DEFINE_double(lane_sequence_threshold, 0.5, "Threshold for trimming lane sequence trajectories");
...
DEFINE_double(sample_time_gap, 0.2, "Gap of time to sample time to get to the lane center");
