...
void FeatureOutput::Insert(const Feature& feature) { features_.add_feature()->CopyFrom(feature); }
...
void FeatureOutput::Write() {
  ...
  std::string file_name = ::apollo::common::util::StrCat(FLAGS_prediction_data_file_prefix, ".",
