...
class MessageProcess {
 public:
  ...
  static void ContainerProcess(const std::shared_ptr<ContainerManager>& container_manager,
                               const perception::PerceptionObstacles&   perception_obstacles,
                               ScenarioManager*                         scenario_manger);

  static void OnPerception(const perception::PerceptionObstacles&   perception_obstacles,
  ...
  static void OnLocalization(ContainerManager*                         container_manager,
  ...
  static void ProcessOfflineData(const PredictionConf&                    prediction_conf,
                                 const std::shared_ptr<ContainerManager>& container_manager,
                                 EvaluatorManager*                        evaluator_manager,
                                 PredictorManager*                        predictor_manager,
                                 ScenarioManager*                         scenario_manager,
