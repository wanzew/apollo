...
static ::_pb::Metadata file_level_metadata_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto[12];
...
const uint32_t TableStruct_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  1,
  2,
  PROTOBUF_FIELD_OFFSET(::apollo::prediction::Conv1dParameter, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::apollo::prediction::Conv1dParameter, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::apollo::prediction::Conv1dParameter, _impl_.shape_),
  PROTOBUF_FIELD_OFFSET(::apollo::prediction::Conv1dParameter, _impl_.use_bias_),
  PROTOBUF_FIELD_OFFSET(::apollo::prediction::Conv1dParameter, _impl_.kernel_),
  PROTOBUF_FIELD_OFFSET(::apollo::prediction::Conv1dParameter, _impl_.bias_),
  PROTOBUF_FIELD_OFFSET(::apollo::prediction::Conv1dParameter, _impl_.stride_),
  ~0u,
  2,
  0,
  1,
  3,
  PROTOBUF_FIELD_OFFSET(::apollo::prediction::MaxPool1dParameter, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::apollo::prediction::MaxPool1dParameter, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::apollo::prediction::MaxPool1dParameter, _impl_.kernel_size_),
  PROTOBUF_FIELD_OFFSET(::apollo::prediction::MaxPool1dParameter, _impl_.stride_),
  0,
  1,
  PROTOBUF_FIELD_OFFSET(::apollo::prediction::AvgPool1dParameter, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::apollo::prediction::AvgPool1dParameter, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::apollo::prediction::AvgPool1dParameter, _impl_.kernel_size_),
  PROTOBUF_FIELD_OFFSET(::apollo::prediction::AvgPool1dParameter, _impl_.stride_),
  0,
  1,
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 36, 47, -1, sizeof(::apollo::prediction::Conv1dParameter)},
  { 52, 60, -1, sizeof(::apollo::prediction::MaxPool1dParameter)},
  { 62, 70, -1, sizeof(::apollo::prediction::AvgPool1dParameter)},
  { 72, 87, -1, sizeof(::apollo::prediction::BatchNormalizationParameter)},
  { 96, 124, -1, sizeof(::apollo::prediction::LSTMParameter)},
  { 146, 153, -1, sizeof(::apollo::prediction::ActivationParameter)},
  { 154, -1, -1, sizeof(::apollo::prediction::FlattenParameter)},
  { 160, 167, -1, sizeof(::apollo::prediction::ConcatenateParameter)},
  { 168, 188, -1, sizeof(::apollo::prediction::LayerParameter)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::apollo::prediction::_Conv1dParameter_default_instance_._instance,
  &::apollo::prediction::_MaxPool1dParameter_default_instance_._instance,
  &::apollo::prediction::_AvgPool1dParameter_default_instance_._instance,
...
const ::_pbi::DescriptorTable descriptor_table_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto = {
    false, false, 2741, descriptor_table_protodef_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto,
    "modules/prediction/proto/network_layers.proto",
    &descriptor_table_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto_once, nullptr, 0, 12,
...
Conv1dParameter::Conv1dParameter(const Conv1dParameter& from)
  ...
  if (from._internal_has_kernel()) {
    _impl_.kernel_ = new ::apollo::prediction::TensorParameter(*from._impl_.kernel_);
  }
  if (from._internal_has_bias()) {
    _impl_.bias_ = new ::apollo::prediction::TensorParameter(*from._impl_.bias_);
  }
...
::PROTOBUF_NAMESPACE_ID::Metadata FlattenParameter::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto_getter, &descriptor_table_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto_once,
      file_level_metadata_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto[9]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata ConcatenateParameter::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto_getter, &descriptor_table_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto_once,
      file_level_metadata_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto[10]);
}
...
void LayerParameter::set_allocated_conv1d(::apollo::prediction::Conv1dParameter* conv1d) {
  ...
  if (conv1d) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(conv1d);
    if (message_arena != submessage_arena) {
...
void LayerParameter::set_allocated_maxpool1d(::apollo::prediction::MaxPool1dParameter* maxpool1d) {
  ...
  if (maxpool1d) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(maxpool1d);
    if (message_arena != submessage_arena) {
...
void LayerParameter::set_allocated_avgpool1d(::apollo::prediction::AvgPool1dParameter* avgpool1d) {
  ...
  if (avgpool1d) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(avgpool1d);
    if (message_arena != submessage_arena) {
...
uint8_t* LayerParameter::_InternalSerialize(
  ...
  switch (oneof_layers_case()) {
    ...
    case kConv1D: {
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(11, _Internal::conv1d(this),
          _Internal::conv1d(this).GetCachedSize(), target, stream);
      break;
    }
    case kMaxpool1D: {
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(12, _Internal::maxpool1d(this),
          _Internal::maxpool1d(this).GetCachedSize(), target, stream);
      break;
    }
    case kAvgpool1D: {
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(13, _Internal::avgpool1d(this),
          _Internal::avgpool1d(this).GetCachedSize(), target, stream);
      break;
    }
    default: ;
  }
...
::PROTOBUF_NAMESPACE_ID::Metadata LayerParameter::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto_getter, &descriptor_table_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto_once,
      file_level_metadata_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto[11]);
}
...
template<> PROTOBUF_NOINLINE ::apollo::prediction::Conv1dParameter*
Arena::CreateMaybeMessage< ::apollo::prediction::Conv1dParameter >(Arena* arena) {
  return Arena::CreateMessageInternal< ::apollo::prediction::Conv1dParameter >(arena);
}
template<> PROTOBUF_NOINLINE ::apollo::prediction::MaxPool1dParameter*
Arena::CreateMaybeMessage< ::apollo::prediction::MaxPool1dParameter >(Arena* arena) {
  return Arena::CreateMessageInternal< ::apollo::prediction::MaxPool1dParameter >(arena);
}
template<> PROTOBUF_NOINLINE ::apollo::prediction::AvgPool1dParameter*
Arena::CreateMaybeMessage< ::apollo::prediction::AvgPool1dParameter >(Arena* arena) {
