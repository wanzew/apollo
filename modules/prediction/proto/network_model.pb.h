...
class VerificationSample final :
 ...
 public:
  ...
  ~VerificationSample() override;
  explicit PROTOBUF_CONSTEXPR VerificationSample(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  VerificationSample* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class NetParameter final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::Performance* release_performance();
...
inline ::apollo::prediction::TensorParameter* VerificationSample::add_features() {
  ::apollo::prediction::TensorParameter* _add = _internal_add_features();
...
inline float Performance::_internal_accuracy(int index) const {
  return _impl_.accuracy_.Get(index);
}
...
inline void Performance::set_accuracy(int index, float value) {
  _impl_.accuracy_.Set(index, value);
...
inline int32_t NetParameter::_internal_id() const {
  return _impl_.id_;
}
inline int32_t NetParameter::id() const {
  // @@protoc_insertion_point(field_get:apollo.prediction.NetParameter.id)
  return _internal_id();
}
inline void NetParameter::_internal_set_id(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.id_ = value;
}
inline void NetParameter::set_id(int32_t value) {
...
inline ::apollo::prediction::LayerParameter* NetParameter::add_layers() {
  ::apollo::prediction::LayerParameter* _add = _internal_add_layers();
...
inline int NetParameter::_internal_verification_samples_size() const {
  return _impl_.verification_samples_.size();
}
...
inline ::apollo::prediction::VerificationSample* NetParameter::mutable_verification_samples(int index) {
  ...
  return _impl_.verification_samples_.Mutable(index);
}
...
inline ::apollo::prediction::VerificationSample* NetParameter::_internal_add_verification_samples() {
  return _impl_.verification_samples_.Add();
}
inline ::apollo::prediction::VerificationSample* NetParameter::add_verification_samples() {
  ::apollo::prediction::VerificationSample* _add = _internal_add_verification_samples();
...
inline const ::apollo::prediction::Performance& NetParameter::_internal_performance() const {
  const ::apollo::prediction::Performance* p = _impl_.performance_;
...
inline ::apollo::prediction::Performance* NetParameter::release_performance() {
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::apollo::prediction::Performance* temp = _impl_.performance_;
...
inline ::apollo::prediction::Performance* NetParameter::_internal_mutable_performance() {
  ...
  if (_impl_.performance_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::prediction::Performance>(GetArenaForAllocation());
    _impl_.performance_ = p;
  }
  return _impl_.performance_;
}
inline ::apollo::prediction::Performance* NetParameter::mutable_performance() {
  ::apollo::prediction::Performance* _msg = _internal_mutable_performance();
