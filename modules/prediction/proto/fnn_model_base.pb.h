...
class Layer final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::Matrix* release_layer_input_weight();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::Vector* release_layer_bias();
...
inline ::apollo::prediction::Vector* Matrix::add_rows() {
  ::apollo::prediction::Vector* _add = _internal_add_rows();
...
inline const ::apollo::prediction::Matrix& Layer::_internal_layer_input_weight() const {
  const ::apollo::prediction::Matrix* p = _impl_.layer_input_weight_;
...
inline ::apollo::prediction::Matrix* Layer::release_layer_input_weight() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::apollo::prediction::Matrix* temp = _impl_.layer_input_weight_;
...
inline ::apollo::prediction::Matrix* Layer::_internal_mutable_layer_input_weight() {
  ...
  if (_impl_.layer_input_weight_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::prediction::Matrix>(GetArenaForAllocation());
...
inline ::apollo::prediction::Matrix* Layer::mutable_layer_input_weight() {
  ::apollo::prediction::Matrix* _msg = _internal_mutable_layer_input_weight();
...
inline const ::apollo::prediction::Vector& Layer::_internal_layer_bias() const {
  const ::apollo::prediction::Vector* p = _impl_.layer_bias_;
...
inline ::apollo::prediction::Vector* Layer::release_layer_bias() {
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::apollo::prediction::Vector* temp = _impl_.layer_bias_;
...
inline ::apollo::prediction::Vector* Layer::mutable_layer_bias() {
  ::apollo::prediction::Vector* _msg = _internal_mutable_layer_bias();
...
inline ::apollo::prediction::Layer_ActivationFunc Layer::_internal_layer_activation_func() const {
  return static_cast< ::apollo::prediction::Layer_ActivationFunc >(_impl_.layer_activation_func_);
}
