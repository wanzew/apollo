...
class DenseParameter final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_weights();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_bias();
...
class Conv1dParameter final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_kernel();
...
class BatchNormalizationParameter final :
 ...
 public:
  ...
  ~BatchNormalizationParameter() override;
  explicit PROTOBUF_CONSTEXPR BatchNormalizationParameter(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  BatchNormalizationParameter* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_mu();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_sigma();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_gamma();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_beta();
...
class LSTMParameter final :
 ...
 public:
  ...
  ~LSTMParameter() override;
  explicit PROTOBUF_CONSTEXPR LSTMParameter(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  LSTMParameter* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_recurrent_activation(ArgT0&& arg0, ArgT... args);
  std::string* mutable_recurrent_activation();
  PROTOBUF_NODISCARD std::string* release_recurrent_activation();
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_recurrent_activation(const std::string& value);
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_weights_input();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_weights_forget();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_weights_cell();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_weights_output();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_bias_input();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_bias_forget();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_bias_cell();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_bias_output();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_recurrent_weights_input();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_recurrent_weights_forget();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_recurrent_weights_cell();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::TensorParameter* release_recurrent_weights_output();
  ...
  int32_t implementation() const;
  void set_implementation(int32_t value);
  private:
  int32_t _internal_implementation() const;
  void _internal_set_implementation(int32_t value);
  public:
...
class FlattenParameter final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:apollo.prediction.FlattenParameter) */ {
 public:
  ...
  inline void CopyFrom(const FlattenParameter& from) {
...
class ConcatenateParameter final :
 ...
 public:
  ...
  ~ConcatenateParameter() override;
  explicit PROTOBUF_CONSTEXPR ConcatenateParameter(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ConcatenateParameter* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class LayerParameter final :
 ...
 public:
  ...
  int32_t order_number() const;
  void set_order_number(int32_t value);
  private:
  int32_t _internal_order_number() const;
  void _internal_set_order_number(int32_t value);
  public:
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::InputParameter* release_input();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::ActivationParameter* release_activation();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::DenseParameter* release_dense();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::BatchNormalizationParameter* release_batch_normalization();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::LSTMParameter* release_lstm();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::FlattenParameter* release_flatten();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::ConcatenateParameter* release_concatenate();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::Conv1dParameter* release_conv1d();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::MaxPool1dParameter* release_maxpool1d();
  ...
  PROTOBUF_NODISCARD ::apollo::prediction::AvgPool1dParameter* release_avgpool1d();
 ...
 private:
  ...
  struct Impl_ {
    ...
    int32_t order_number_;
    union OneofLayersUnion {
      constexpr OneofLayersUnion() : _constinit_{} {}
...
inline const ::apollo::prediction::TensorParameter& DenseParameter::_internal_weights() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.weights_;
...
inline ::apollo::prediction::TensorParameter* DenseParameter::release_weights() {
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::apollo::prediction::TensorParameter* temp = _impl_.weights_;
...
inline ::apollo::prediction::TensorParameter* DenseParameter::_internal_mutable_weights() {
  ...
  if (_impl_.weights_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::prediction::TensorParameter>(GetArenaForAllocation());
    _impl_.weights_ = p;
  }
  return _impl_.weights_;
}
inline ::apollo::prediction::TensorParameter* DenseParameter::mutable_weights() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_weights();
...
inline const ::apollo::prediction::TensorParameter& DenseParameter::_internal_bias() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.bias_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline ::apollo::prediction::TensorParameter* DenseParameter::release_bias() {
  _impl_._has_bits_[0] &= ~0x00000004u;
  ::apollo::prediction::TensorParameter* temp = _impl_.bias_;
...
inline ::apollo::prediction::TensorParameter* DenseParameter::mutable_bias() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_bias();
...
inline const ::apollo::prediction::TensorParameter& Conv1dParameter::_internal_kernel() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.kernel_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline ::apollo::prediction::TensorParameter* Conv1dParameter::release_kernel() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::apollo::prediction::TensorParameter* temp = _impl_.kernel_;
...
inline ::apollo::prediction::TensorParameter* Conv1dParameter::mutable_kernel() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_kernel();
...
inline int32_t BatchNormalizationParameter::_internal_axis() const {
  return _impl_.axis_;
}
inline int32_t BatchNormalizationParameter::axis() const {
  // @@protoc_insertion_point(field_get:apollo.prediction.BatchNormalizationParameter.axis)
  return _internal_axis();
}
inline void BatchNormalizationParameter::_internal_set_axis(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.axis_ = value;
}
inline void BatchNormalizationParameter::set_axis(int32_t value) {
...
inline bool BatchNormalizationParameter::_internal_has_mu() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.mu_ != nullptr);
  return value;
}
...
inline void BatchNormalizationParameter::unsafe_arena_set_allocated_mu(
    ::apollo::prediction::TensorParameter* mu) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.mu_);
  }
  _impl_.mu_ = mu;
  if (mu) {
    _impl_._has_bits_[0] |= 0x00000001u;
...
inline ::apollo::prediction::TensorParameter* BatchNormalizationParameter::release_mu() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::apollo::prediction::TensorParameter* temp = _impl_.mu_;
  _impl_.mu_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::apollo::prediction::TensorParameter* BatchNormalizationParameter::mutable_mu() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_mu();
...
inline void BatchNormalizationParameter::set_allocated_mu(::apollo::prediction::TensorParameter* mu) {
  ...
  if (mu) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(mu);
    if (message_arena != submessage_arena) {
...
inline const ::apollo::prediction::TensorParameter& BatchNormalizationParameter::_internal_sigma() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.sigma_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline void BatchNormalizationParameter::unsafe_arena_set_allocated_sigma(
    ::apollo::prediction::TensorParameter* sigma) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.sigma_);
  }
  _impl_.sigma_ = sigma;
  if (sigma) {
    _impl_._has_bits_[0] |= 0x00000002u;
...
inline ::apollo::prediction::TensorParameter* BatchNormalizationParameter::release_sigma() {
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::apollo::prediction::TensorParameter* temp = _impl_.sigma_;
...
inline ::apollo::prediction::TensorParameter* BatchNormalizationParameter::mutable_sigma() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_sigma();
...
inline void BatchNormalizationParameter::set_allocated_sigma(::apollo::prediction::TensorParameter* sigma) {
  ...
  if (sigma) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(sigma);
    if (message_arena != submessage_arena) {
...
inline const ::apollo::prediction::TensorParameter& BatchNormalizationParameter::_internal_gamma() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.gamma_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline ::apollo::prediction::TensorParameter* BatchNormalizationParameter::release_gamma() {
  _impl_._has_bits_[0] &= ~0x00000004u;
  ::apollo::prediction::TensorParameter* temp = _impl_.gamma_;
...
inline ::apollo::prediction::TensorParameter* BatchNormalizationParameter::mutable_gamma() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_gamma();
...
inline void BatchNormalizationParameter::set_allocated_gamma(::apollo::prediction::TensorParameter* gamma) {
  ...
  if (gamma) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(gamma);
    if (message_arena != submessage_arena) {
...
inline bool BatchNormalizationParameter::_internal_has_beta() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.beta_ != nullptr);
  return value;
}
...
inline void BatchNormalizationParameter::clear_beta() {
  if (_impl_.beta_ != nullptr) _impl_.beta_->Clear();
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline const ::apollo::prediction::TensorParameter& BatchNormalizationParameter::_internal_beta() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.beta_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline void BatchNormalizationParameter::unsafe_arena_set_allocated_beta(
    ::apollo::prediction::TensorParameter* beta) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.beta_);
  }
  _impl_.beta_ = beta;
  if (beta) {
    _impl_._has_bits_[0] |= 0x00000008u;
...
inline ::apollo::prediction::TensorParameter* BatchNormalizationParameter::release_beta() {
  _impl_._has_bits_[0] &= ~0x00000008u;
  ::apollo::prediction::TensorParameter* temp = _impl_.beta_;
...
inline ::apollo::prediction::TensorParameter* BatchNormalizationParameter::mutable_beta() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_beta();
...
inline void BatchNormalizationParameter::set_allocated_beta(::apollo::prediction::TensorParameter* beta) {
  ...
  if (beta) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(beta);
    if (message_arena != submessage_arena) {
...
inline int32_t LSTMParameter::_internal_units() const {
  return _impl_.units_;
}
inline int32_t LSTMParameter::units() const {
  // @@protoc_insertion_point(field_get:apollo.prediction.LSTMParameter.units)
  return _internal_units();
}
inline void LSTMParameter::_internal_set_units(int32_t value) {
  _impl_._has_bits_[0] |= 0x00004000u;
  _impl_.units_ = value;
}
inline void LSTMParameter::set_units(int32_t value) {
  _internal_set_units(value);
...
inline void LSTMParameter::_internal_set_return_sequences(bool value) {
  _impl_._has_bits_[0] |= 0x00008000u;
  _impl_.return_sequences_ = value;
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LSTMParameter::set_activation(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.activation_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void LSTMParameter::clear_recurrent_activation() {
  _impl_.recurrent_activation_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000002u;
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LSTMParameter::set_recurrent_activation(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.recurrent_activation_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* LSTMParameter::mutable_recurrent_activation() {
  std::string* _s = _internal_mutable_recurrent_activation();
...
inline const std::string& LSTMParameter::_internal_recurrent_activation() const {
  return _impl_.recurrent_activation_.Get();
}
inline void LSTMParameter::_internal_set_recurrent_activation(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.recurrent_activation_.Set(value, GetArenaForAllocation());
}
inline std::string* LSTMParameter::_internal_mutable_recurrent_activation() {
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.recurrent_activation_.Mutable(GetArenaForAllocation());
}
inline std::string* LSTMParameter::release_recurrent_activation() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* p = _impl_.recurrent_activation_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.recurrent_activation_.IsDefault()) {
...
inline void LSTMParameter::set_allocated_recurrent_activation(std::string* recurrent_activation) {
  ...
  _impl_.recurrent_activation_.SetAllocated(recurrent_activation, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.recurrent_activation_.IsDefault()) {
    _impl_.recurrent_activation_.Set("", GetArenaForAllocation());
  }
...
inline bool LSTMParameter::_internal_unit_forget_bias() const {
  return _impl_.unit_forget_bias_;
}
...
inline void LSTMParameter::_internal_set_unit_forget_bias(bool value) {
  _impl_._has_bits_[0] |= 0x00200000u;
  _impl_.unit_forget_bias_ = value;
}
...
inline void LSTMParameter::clear_implementation() {
  _impl_.implementation_ = 0;
  _impl_._has_bits_[0] &= ~0x00100000u;
}
inline int32_t LSTMParameter::_internal_implementation() const {
  return _impl_.implementation_;
}
inline int32_t LSTMParameter::implementation() const {
  // @@protoc_insertion_point(field_get:apollo.prediction.LSTMParameter.implementation)
  return _internal_implementation();
}
inline void LSTMParameter::_internal_set_implementation(int32_t value) {
  _impl_._has_bits_[0] |= 0x00100000u;
  _impl_.implementation_ = value;
}
inline void LSTMParameter::set_implementation(int32_t value) {
...
inline bool LSTMParameter::_internal_has_weights_input() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.weights_input_ != nullptr);
  return value;
}
...
inline void LSTMParameter::clear_weights_input() {
  if (_impl_.weights_input_ != nullptr) _impl_.weights_input_->Clear();
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline const ::apollo::prediction::TensorParameter& LSTMParameter::_internal_weights_input() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.weights_input_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline void LSTMParameter::unsafe_arena_set_allocated_weights_input(
    ::apollo::prediction::TensorParameter* weights_input) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.weights_input_);
  }
  _impl_.weights_input_ = weights_input;
  if (weights_input) {
    _impl_._has_bits_[0] |= 0x00000004u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000004u;
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::release_weights_input() {
  _impl_._has_bits_[0] &= ~0x00000004u;
  ::apollo::prediction::TensorParameter* temp = _impl_.weights_input_;
  _impl_.weights_input_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::_internal_mutable_weights_input() {
  _impl_._has_bits_[0] |= 0x00000004u;
  if (_impl_.weights_input_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::prediction::TensorParameter>(GetArenaForAllocation());
    _impl_.weights_input_ = p;
  }
  return _impl_.weights_input_;
}
inline ::apollo::prediction::TensorParameter* LSTMParameter::mutable_weights_input() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_weights_input();
...
inline void LSTMParameter::set_allocated_weights_input(::apollo::prediction::TensorParameter* weights_input) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.weights_input_;
  }
  if (weights_input) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(weights_input);
    if (message_arena != submessage_arena) {
...
inline bool LSTMParameter::_internal_has_weights_forget() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.weights_forget_ != nullptr);
  return value;
}
...
inline void LSTMParameter::clear_weights_forget() {
  if (_impl_.weights_forget_ != nullptr) _impl_.weights_forget_->Clear();
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline const ::apollo::prediction::TensorParameter& LSTMParameter::_internal_weights_forget() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.weights_forget_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline void LSTMParameter::unsafe_arena_set_allocated_weights_forget(
    ::apollo::prediction::TensorParameter* weights_forget) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.weights_forget_);
  }
  _impl_.weights_forget_ = weights_forget;
  if (weights_forget) {
    _impl_._has_bits_[0] |= 0x00000008u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000008u;
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::release_weights_forget() {
  _impl_._has_bits_[0] &= ~0x00000008u;
  ::apollo::prediction::TensorParameter* temp = _impl_.weights_forget_;
  _impl_.weights_forget_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::_internal_mutable_weights_forget() {
  _impl_._has_bits_[0] |= 0x00000008u;
  if (_impl_.weights_forget_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::prediction::TensorParameter>(GetArenaForAllocation());
    _impl_.weights_forget_ = p;
  }
  return _impl_.weights_forget_;
}
inline ::apollo::prediction::TensorParameter* LSTMParameter::mutable_weights_forget() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_weights_forget();
...
inline void LSTMParameter::set_allocated_weights_forget(::apollo::prediction::TensorParameter* weights_forget) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.weights_forget_;
  }
  if (weights_forget) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(weights_forget);
    if (message_arena != submessage_arena) {
...
inline bool LSTMParameter::_internal_has_weights_cell() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.weights_cell_ != nullptr);
  return value;
}
...
inline void LSTMParameter::clear_weights_cell() {
  if (_impl_.weights_cell_ != nullptr) _impl_.weights_cell_->Clear();
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline const ::apollo::prediction::TensorParameter& LSTMParameter::_internal_weights_cell() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.weights_cell_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline void LSTMParameter::unsafe_arena_set_allocated_weights_cell(
    ::apollo::prediction::TensorParameter* weights_cell) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.weights_cell_);
  }
  _impl_.weights_cell_ = weights_cell;
  if (weights_cell) {
    _impl_._has_bits_[0] |= 0x00000010u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000010u;
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::release_weights_cell() {
  _impl_._has_bits_[0] &= ~0x00000010u;
  ::apollo::prediction::TensorParameter* temp = _impl_.weights_cell_;
  _impl_.weights_cell_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::_internal_mutable_weights_cell() {
  _impl_._has_bits_[0] |= 0x00000010u;
  if (_impl_.weights_cell_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::prediction::TensorParameter>(GetArenaForAllocation());
    _impl_.weights_cell_ = p;
  }
  return _impl_.weights_cell_;
}
inline ::apollo::prediction::TensorParameter* LSTMParameter::mutable_weights_cell() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_weights_cell();
...
inline void LSTMParameter::set_allocated_weights_cell(::apollo::prediction::TensorParameter* weights_cell) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.weights_cell_;
  }
  if (weights_cell) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(weights_cell);
    if (message_arena != submessage_arena) {
...
inline bool LSTMParameter::_internal_has_weights_output() const {
  bool value = (_impl_._has_bits_[0] & 0x00000020u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.weights_output_ != nullptr);
  return value;
}
...
inline void LSTMParameter::clear_weights_output() {
  if (_impl_.weights_output_ != nullptr) _impl_.weights_output_->Clear();
  _impl_._has_bits_[0] &= ~0x00000020u;
}
inline const ::apollo::prediction::TensorParameter& LSTMParameter::_internal_weights_output() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.weights_output_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline void LSTMParameter::unsafe_arena_set_allocated_weights_output(
    ::apollo::prediction::TensorParameter* weights_output) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.weights_output_);
  }
  _impl_.weights_output_ = weights_output;
  if (weights_output) {
    _impl_._has_bits_[0] |= 0x00000020u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000020u;
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::release_weights_output() {
  _impl_._has_bits_[0] &= ~0x00000020u;
  ::apollo::prediction::TensorParameter* temp = _impl_.weights_output_;
  _impl_.weights_output_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::_internal_mutable_weights_output() {
  _impl_._has_bits_[0] |= 0x00000020u;
  if (_impl_.weights_output_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::prediction::TensorParameter>(GetArenaForAllocation());
    _impl_.weights_output_ = p;
  }
  return _impl_.weights_output_;
}
inline ::apollo::prediction::TensorParameter* LSTMParameter::mutable_weights_output() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_weights_output();
...
inline void LSTMParameter::set_allocated_weights_output(::apollo::prediction::TensorParameter* weights_output) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.weights_output_;
  }
  if (weights_output) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(weights_output);
    if (message_arena != submessage_arena) {
...
inline void LSTMParameter::clear_bias_input() {
  if (_impl_.bias_input_ != nullptr) _impl_.bias_input_->Clear();
  _impl_._has_bits_[0] &= ~0x00000040u;
}
inline const ::apollo::prediction::TensorParameter& LSTMParameter::_internal_bias_input() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.bias_input_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline void LSTMParameter::unsafe_arena_set_allocated_bias_input(
    ::apollo::prediction::TensorParameter* bias_input) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.bias_input_);
  }
  _impl_.bias_input_ = bias_input;
  if (bias_input) {
    _impl_._has_bits_[0] |= 0x00000040u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000040u;
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::release_bias_input() {
  _impl_._has_bits_[0] &= ~0x00000040u;
  ::apollo::prediction::TensorParameter* temp = _impl_.bias_input_;
...
inline void LSTMParameter::set_allocated_bias_input(::apollo::prediction::TensorParameter* bias_input) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.bias_input_;
  }
  if (bias_input) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(bias_input);
    if (message_arena != submessage_arena) {
...
inline bool LSTMParameter::_internal_has_bias_forget() const {
  bool value = (_impl_._has_bits_[0] & 0x00000080u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.bias_forget_ != nullptr);
  return value;
}
...
inline void LSTMParameter::clear_bias_forget() {
  if (_impl_.bias_forget_ != nullptr) _impl_.bias_forget_->Clear();
  _impl_._has_bits_[0] &= ~0x00000080u;
}
inline const ::apollo::prediction::TensorParameter& LSTMParameter::_internal_bias_forget() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.bias_forget_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline void LSTMParameter::unsafe_arena_set_allocated_bias_forget(
    ::apollo::prediction::TensorParameter* bias_forget) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.bias_forget_);
  }
  _impl_.bias_forget_ = bias_forget;
  if (bias_forget) {
    _impl_._has_bits_[0] |= 0x00000080u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000080u;
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::release_bias_forget() {
  _impl_._has_bits_[0] &= ~0x00000080u;
  ::apollo::prediction::TensorParameter* temp = _impl_.bias_forget_;
  _impl_.bias_forget_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::_internal_mutable_bias_forget() {
  _impl_._has_bits_[0] |= 0x00000080u;
  if (_impl_.bias_forget_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::prediction::TensorParameter>(GetArenaForAllocation());
    _impl_.bias_forget_ = p;
  }
  return _impl_.bias_forget_;
}
inline ::apollo::prediction::TensorParameter* LSTMParameter::mutable_bias_forget() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_bias_forget();
...
inline void LSTMParameter::set_allocated_bias_forget(::apollo::prediction::TensorParameter* bias_forget) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.bias_forget_;
  }
  if (bias_forget) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(bias_forget);
    if (message_arena != submessage_arena) {
...
inline bool LSTMParameter::_internal_has_bias_cell() const {
  bool value = (_impl_._has_bits_[0] & 0x00000100u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.bias_cell_ != nullptr);
  return value;
}
...
inline void LSTMParameter::clear_bias_cell() {
  if (_impl_.bias_cell_ != nullptr) _impl_.bias_cell_->Clear();
  _impl_._has_bits_[0] &= ~0x00000100u;
}
inline const ::apollo::prediction::TensorParameter& LSTMParameter::_internal_bias_cell() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.bias_cell_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline void LSTMParameter::unsafe_arena_set_allocated_bias_cell(
    ::apollo::prediction::TensorParameter* bias_cell) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.bias_cell_);
  }
  _impl_.bias_cell_ = bias_cell;
  if (bias_cell) {
    _impl_._has_bits_[0] |= 0x00000100u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000100u;
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::release_bias_cell() {
  _impl_._has_bits_[0] &= ~0x00000100u;
  ::apollo::prediction::TensorParameter* temp = _impl_.bias_cell_;
  _impl_.bias_cell_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::_internal_mutable_bias_cell() {
  _impl_._has_bits_[0] |= 0x00000100u;
  if (_impl_.bias_cell_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::prediction::TensorParameter>(GetArenaForAllocation());
    _impl_.bias_cell_ = p;
  }
  return _impl_.bias_cell_;
}
inline ::apollo::prediction::TensorParameter* LSTMParameter::mutable_bias_cell() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_bias_cell();
...
inline void LSTMParameter::set_allocated_bias_cell(::apollo::prediction::TensorParameter* bias_cell) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.bias_cell_;
  }
  if (bias_cell) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(bias_cell);
    if (message_arena != submessage_arena) {
...
inline void LSTMParameter::clear_bias_output() {
  if (_impl_.bias_output_ != nullptr) _impl_.bias_output_->Clear();
  _impl_._has_bits_[0] &= ~0x00000200u;
}
inline const ::apollo::prediction::TensorParameter& LSTMParameter::_internal_bias_output() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.bias_output_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline void LSTMParameter::unsafe_arena_set_allocated_bias_output(
    ::apollo::prediction::TensorParameter* bias_output) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.bias_output_);
  }
  _impl_.bias_output_ = bias_output;
  if (bias_output) {
    _impl_._has_bits_[0] |= 0x00000200u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000200u;
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::release_bias_output() {
  _impl_._has_bits_[0] &= ~0x00000200u;
  ::apollo::prediction::TensorParameter* temp = _impl_.bias_output_;
...
inline void LSTMParameter::set_allocated_bias_output(::apollo::prediction::TensorParameter* bias_output) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.bias_output_;
  }
  if (bias_output) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(bias_output);
    if (message_arena != submessage_arena) {
...
inline bool LSTMParameter::_internal_has_recurrent_weights_input() const {
  ...
  PROTOBUF_ASSUME(!value || _impl_.recurrent_weights_input_ != nullptr);
  return value;
}
...
inline void LSTMParameter::clear_recurrent_weights_input() {
  if (_impl_.recurrent_weights_input_ != nullptr) _impl_.recurrent_weights_input_->Clear();
  _impl_._has_bits_[0] &= ~0x00000400u;
}
inline const ::apollo::prediction::TensorParameter& LSTMParameter::_internal_recurrent_weights_input() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.recurrent_weights_input_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline void LSTMParameter::unsafe_arena_set_allocated_recurrent_weights_input(
    ::apollo::prediction::TensorParameter* recurrent_weights_input) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.recurrent_weights_input_);
  }
  _impl_.recurrent_weights_input_ = recurrent_weights_input;
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::release_recurrent_weights_input() {
  _impl_._has_bits_[0] &= ~0x00000400u;
  ::apollo::prediction::TensorParameter* temp = _impl_.recurrent_weights_input_;
  _impl_.recurrent_weights_input_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::_internal_mutable_recurrent_weights_input() {
  _impl_._has_bits_[0] |= 0x00000400u;
  if (_impl_.recurrent_weights_input_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::prediction::TensorParameter>(GetArenaForAllocation());
    _impl_.recurrent_weights_input_ = p;
  }
  return _impl_.recurrent_weights_input_;
}
inline ::apollo::prediction::TensorParameter* LSTMParameter::mutable_recurrent_weights_input() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_recurrent_weights_input();
...
inline void LSTMParameter::set_allocated_recurrent_weights_input(::apollo::prediction::TensorParameter* recurrent_weights_input) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.recurrent_weights_input_;
  }
  if (recurrent_weights_input) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(recurrent_weights_input);
    if (message_arena != submessage_arena) {
...
inline bool LSTMParameter::_internal_has_recurrent_weights_forget() const {
  ...
  PROTOBUF_ASSUME(!value || _impl_.recurrent_weights_forget_ != nullptr);
  return value;
}
...
inline void LSTMParameter::clear_recurrent_weights_forget() {
  if (_impl_.recurrent_weights_forget_ != nullptr) _impl_.recurrent_weights_forget_->Clear();
  _impl_._has_bits_[0] &= ~0x00000800u;
}
inline const ::apollo::prediction::TensorParameter& LSTMParameter::_internal_recurrent_weights_forget() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.recurrent_weights_forget_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline void LSTMParameter::unsafe_arena_set_allocated_recurrent_weights_forget(
    ::apollo::prediction::TensorParameter* recurrent_weights_forget) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.recurrent_weights_forget_);
  }
  _impl_.recurrent_weights_forget_ = recurrent_weights_forget;
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::release_recurrent_weights_forget() {
  _impl_._has_bits_[0] &= ~0x00000800u;
  ::apollo::prediction::TensorParameter* temp = _impl_.recurrent_weights_forget_;
  _impl_.recurrent_weights_forget_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::_internal_mutable_recurrent_weights_forget() {
  _impl_._has_bits_[0] |= 0x00000800u;
  if (_impl_.recurrent_weights_forget_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::prediction::TensorParameter>(GetArenaForAllocation());
    _impl_.recurrent_weights_forget_ = p;
  }
  return _impl_.recurrent_weights_forget_;
}
inline ::apollo::prediction::TensorParameter* LSTMParameter::mutable_recurrent_weights_forget() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_recurrent_weights_forget();
...
inline void LSTMParameter::set_allocated_recurrent_weights_forget(::apollo::prediction::TensorParameter* recurrent_weights_forget) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.recurrent_weights_forget_;
  }
  if (recurrent_weights_forget) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(recurrent_weights_forget);
    if (message_arena != submessage_arena) {
...
inline bool LSTMParameter::_internal_has_recurrent_weights_cell() const {
  ...
  PROTOBUF_ASSUME(!value || _impl_.recurrent_weights_cell_ != nullptr);
  return value;
}
...
inline void LSTMParameter::clear_recurrent_weights_cell() {
  if (_impl_.recurrent_weights_cell_ != nullptr) _impl_.recurrent_weights_cell_->Clear();
  _impl_._has_bits_[0] &= ~0x00001000u;
}
inline const ::apollo::prediction::TensorParameter& LSTMParameter::_internal_recurrent_weights_cell() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.recurrent_weights_cell_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline void LSTMParameter::unsafe_arena_set_allocated_recurrent_weights_cell(
    ::apollo::prediction::TensorParameter* recurrent_weights_cell) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.recurrent_weights_cell_);
  }
  _impl_.recurrent_weights_cell_ = recurrent_weights_cell;
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::release_recurrent_weights_cell() {
  _impl_._has_bits_[0] &= ~0x00001000u;
  ::apollo::prediction::TensorParameter* temp = _impl_.recurrent_weights_cell_;
  _impl_.recurrent_weights_cell_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::_internal_mutable_recurrent_weights_cell() {
  _impl_._has_bits_[0] |= 0x00001000u;
  if (_impl_.recurrent_weights_cell_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::prediction::TensorParameter>(GetArenaForAllocation());
    _impl_.recurrent_weights_cell_ = p;
  }
  return _impl_.recurrent_weights_cell_;
}
inline ::apollo::prediction::TensorParameter* LSTMParameter::mutable_recurrent_weights_cell() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_recurrent_weights_cell();
...
inline void LSTMParameter::set_allocated_recurrent_weights_cell(::apollo::prediction::TensorParameter* recurrent_weights_cell) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.recurrent_weights_cell_;
  }
  if (recurrent_weights_cell) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(recurrent_weights_cell);
    if (message_arena != submessage_arena) {
...
inline bool LSTMParameter::_internal_has_recurrent_weights_output() const {
  ...
  PROTOBUF_ASSUME(!value || _impl_.recurrent_weights_output_ != nullptr);
  return value;
}
...
inline void LSTMParameter::clear_recurrent_weights_output() {
  if (_impl_.recurrent_weights_output_ != nullptr) _impl_.recurrent_weights_output_->Clear();
  _impl_._has_bits_[0] &= ~0x00002000u;
}
inline const ::apollo::prediction::TensorParameter& LSTMParameter::_internal_recurrent_weights_output() const {
  const ::apollo::prediction::TensorParameter* p = _impl_.recurrent_weights_output_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::prediction::TensorParameter&>(
      ::apollo::prediction::_TensorParameter_default_instance_);
}
...
inline void LSTMParameter::unsafe_arena_set_allocated_recurrent_weights_output(
    ::apollo::prediction::TensorParameter* recurrent_weights_output) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.recurrent_weights_output_);
  }
  _impl_.recurrent_weights_output_ = recurrent_weights_output;
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::release_recurrent_weights_output() {
  _impl_._has_bits_[0] &= ~0x00002000u;
  ::apollo::prediction::TensorParameter* temp = _impl_.recurrent_weights_output_;
  _impl_.recurrent_weights_output_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::apollo::prediction::TensorParameter* LSTMParameter::_internal_mutable_recurrent_weights_output() {
  _impl_._has_bits_[0] |= 0x00002000u;
  if (_impl_.recurrent_weights_output_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::prediction::TensorParameter>(GetArenaForAllocation());
    _impl_.recurrent_weights_output_ = p;
  }
  return _impl_.recurrent_weights_output_;
}
inline ::apollo::prediction::TensorParameter* LSTMParameter::mutable_recurrent_weights_output() {
  ::apollo::prediction::TensorParameter* _msg = _internal_mutable_recurrent_weights_output();
...
inline void LSTMParameter::set_allocated_recurrent_weights_output(::apollo::prediction::TensorParameter* recurrent_weights_output) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.recurrent_weights_output_;
  }
  if (recurrent_weights_output) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(recurrent_weights_output);
    if (message_arena != submessage_arena) {
...
inline int32_t ConcatenateParameter::_internal_axis() const {
  return _impl_.axis_;
}
inline int32_t ConcatenateParameter::axis() const {
  // @@protoc_insertion_point(field_get:apollo.prediction.ConcatenateParameter.axis)
  return _internal_axis();
}
inline void ConcatenateParameter::_internal_set_axis(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.axis_ = value;
}
inline void ConcatenateParameter::set_axis(int32_t value) {
  _internal_set_axis(value);
...
inline int32_t LayerParameter::_internal_order_number() const {
  return _impl_.order_number_;
}
inline int32_t LayerParameter::order_number() const {
  // @@protoc_insertion_point(field_get:apollo.prediction.LayerParameter.order_number)
  return _internal_order_number();
}
inline void LayerParameter::_internal_set_order_number(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.order_number_ = value;
}
inline void LayerParameter::set_order_number(int32_t value) {
...
inline ::apollo::prediction::InputParameter* LayerParameter::release_input() {
  ...
  if (_internal_has_input()) {
    clear_has_oneof_layers();
    ::apollo::prediction::InputParameter* temp = _impl_.oneof_layers_.input_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.oneof_layers_.input_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::apollo::prediction::InputParameter* LayerParameter::_internal_mutable_input() {
  if (!_internal_has_input()) {
    clear_oneof_layers();
    set_has_input();
    _impl_.oneof_layers_.input_ = CreateMaybeMessage< ::apollo::prediction::InputParameter >(GetArenaForAllocation());
  }
  return _impl_.oneof_layers_.input_;
}
inline ::apollo::prediction::InputParameter* LayerParameter::mutable_input() {
  ::apollo::prediction::InputParameter* _msg = _internal_mutable_input();
...
inline void LayerParameter::set_has_activation() {
  _impl_._oneof_case_[0] = kActivation;
}
...
inline ::apollo::prediction::ActivationParameter* LayerParameter::release_activation() {
  ...
  if (_internal_has_activation()) {
    clear_has_oneof_layers();
    ::apollo::prediction::ActivationParameter* temp = _impl_.oneof_layers_.activation_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.oneof_layers_.activation_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::apollo::prediction::ActivationParameter* LayerParameter::_internal_mutable_activation() {
  if (!_internal_has_activation()) {
    clear_oneof_layers();
    set_has_activation();
    _impl_.oneof_layers_.activation_ = CreateMaybeMessage< ::apollo::prediction::ActivationParameter >(GetArenaForAllocation());
  }
  return _impl_.oneof_layers_.activation_;
}
inline ::apollo::prediction::ActivationParameter* LayerParameter::mutable_activation() {
  ::apollo::prediction::ActivationParameter* _msg = _internal_mutable_activation();
...
inline ::apollo::prediction::DenseParameter* LayerParameter::release_dense() {
  ...
  if (_internal_has_dense()) {
    clear_has_oneof_layers();
    ::apollo::prediction::DenseParameter* temp = _impl_.oneof_layers_.dense_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.oneof_layers_.dense_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::apollo::prediction::DenseParameter* LayerParameter::_internal_mutable_dense() {
  if (!_internal_has_dense()) {
    clear_oneof_layers();
    set_has_dense();
    _impl_.oneof_layers_.dense_ = CreateMaybeMessage< ::apollo::prediction::DenseParameter >(GetArenaForAllocation());
  }
  return _impl_.oneof_layers_.dense_;
}
inline ::apollo::prediction::DenseParameter* LayerParameter::mutable_dense() {
  ::apollo::prediction::DenseParameter* _msg = _internal_mutable_dense();
...
inline void LayerParameter::set_has_batch_normalization() {
  _impl_._oneof_case_[0] = kBatchNormalization;
}
...
inline ::apollo::prediction::BatchNormalizationParameter* LayerParameter::release_batch_normalization() {
  ...
  if (_internal_has_batch_normalization()) {
    clear_has_oneof_layers();
    ::apollo::prediction::BatchNormalizationParameter* temp = _impl_.oneof_layers_.batch_normalization_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.oneof_layers_.batch_normalization_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::apollo::prediction::BatchNormalizationParameter* LayerParameter::_internal_mutable_batch_normalization() {
  if (!_internal_has_batch_normalization()) {
    clear_oneof_layers();
    set_has_batch_normalization();
    _impl_.oneof_layers_.batch_normalization_ = CreateMaybeMessage< ::apollo::prediction::BatchNormalizationParameter >(GetArenaForAllocation());
  }
  return _impl_.oneof_layers_.batch_normalization_;
}
inline ::apollo::prediction::BatchNormalizationParameter* LayerParameter::mutable_batch_normalization() {
  ::apollo::prediction::BatchNormalizationParameter* _msg = _internal_mutable_batch_normalization();
...
inline ::apollo::prediction::LSTMParameter* LayerParameter::release_lstm() {
  ...
  if (_internal_has_lstm()) {
    clear_has_oneof_layers();
    ::apollo::prediction::LSTMParameter* temp = _impl_.oneof_layers_.lstm_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.oneof_layers_.lstm_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::apollo::prediction::LSTMParameter* LayerParameter::_internal_mutable_lstm() {
  if (!_internal_has_lstm()) {
    clear_oneof_layers();
    set_has_lstm();
    _impl_.oneof_layers_.lstm_ = CreateMaybeMessage< ::apollo::prediction::LSTMParameter >(GetArenaForAllocation());
  }
  return _impl_.oneof_layers_.lstm_;
}
inline ::apollo::prediction::LSTMParameter* LayerParameter::mutable_lstm() {
  ::apollo::prediction::LSTMParameter* _msg = _internal_mutable_lstm();
...
inline ::apollo::prediction::FlattenParameter* LayerParameter::release_flatten() {
  ...
  if (_internal_has_flatten()) {
    clear_has_oneof_layers();
    ::apollo::prediction::FlattenParameter* temp = _impl_.oneof_layers_.flatten_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.oneof_layers_.flatten_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::apollo::prediction::FlattenParameter* LayerParameter::_internal_mutable_flatten() {
  if (!_internal_has_flatten()) {
    clear_oneof_layers();
    set_has_flatten();
    _impl_.oneof_layers_.flatten_ = CreateMaybeMessage< ::apollo::prediction::FlattenParameter >(GetArenaForAllocation());
  }
  return _impl_.oneof_layers_.flatten_;
}
inline ::apollo::prediction::FlattenParameter* LayerParameter::mutable_flatten() {
  ::apollo::prediction::FlattenParameter* _msg = _internal_mutable_flatten();
...
inline void LayerParameter::set_has_concatenate() {
  _impl_._oneof_case_[0] = kConcatenate;
}
...
inline ::apollo::prediction::ConcatenateParameter* LayerParameter::release_concatenate() {
  ...
  if (_internal_has_concatenate()) {
    clear_has_oneof_layers();
    ::apollo::prediction::ConcatenateParameter* temp = _impl_.oneof_layers_.concatenate_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.oneof_layers_.concatenate_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::apollo::prediction::ConcatenateParameter* LayerParameter::_internal_mutable_concatenate() {
  if (!_internal_has_concatenate()) {
    clear_oneof_layers();
    set_has_concatenate();
    _impl_.oneof_layers_.concatenate_ = CreateMaybeMessage< ::apollo::prediction::ConcatenateParameter >(GetArenaForAllocation());
  }
  return _impl_.oneof_layers_.concatenate_;
}
inline ::apollo::prediction::ConcatenateParameter* LayerParameter::mutable_concatenate() {
  ::apollo::prediction::ConcatenateParameter* _msg = _internal_mutable_concatenate();
...
inline void LayerParameter::set_has_conv1d() {
  _impl_._oneof_case_[0] = kConv1D;
}
inline void LayerParameter::clear_conv1d() {
  if (_internal_has_conv1d()) {
    if (GetArenaForAllocation() == nullptr) {
      delete _impl_.oneof_layers_.conv1d_;
    }
    clear_has_oneof_layers();
  }
}
inline ::apollo::prediction::Conv1dParameter* LayerParameter::release_conv1d() {
  ...
  if (_internal_has_conv1d()) {
    clear_has_oneof_layers();
    ::apollo::prediction::Conv1dParameter* temp = _impl_.oneof_layers_.conv1d_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.oneof_layers_.conv1d_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline void LayerParameter::unsafe_arena_set_allocated_conv1d(::apollo::prediction::Conv1dParameter* conv1d) {
  ...
  if (conv1d) {
    set_has_conv1d();
    _impl_.oneof_layers_.conv1d_ = conv1d;
  }
...
inline ::apollo::prediction::Conv1dParameter* LayerParameter::_internal_mutable_conv1d() {
  if (!_internal_has_conv1d()) {
    clear_oneof_layers();
    set_has_conv1d();
    _impl_.oneof_layers_.conv1d_ = CreateMaybeMessage< ::apollo::prediction::Conv1dParameter >(GetArenaForAllocation());
  }
  return _impl_.oneof_layers_.conv1d_;
}
inline ::apollo::prediction::Conv1dParameter* LayerParameter::mutable_conv1d() {
  ::apollo::prediction::Conv1dParameter* _msg = _internal_mutable_conv1d();
...
inline void LayerParameter::set_has_maxpool1d() {
  _impl_._oneof_case_[0] = kMaxpool1D;
}
inline void LayerParameter::clear_maxpool1d() {
  if (_internal_has_maxpool1d()) {
    if (GetArenaForAllocation() == nullptr) {
      delete _impl_.oneof_layers_.maxpool1d_;
    }
    clear_has_oneof_layers();
  }
}
inline ::apollo::prediction::MaxPool1dParameter* LayerParameter::release_maxpool1d() {
  ...
  if (_internal_has_maxpool1d()) {
    clear_has_oneof_layers();
    ::apollo::prediction::MaxPool1dParameter* temp = _impl_.oneof_layers_.maxpool1d_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.oneof_layers_.maxpool1d_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline const ::apollo::prediction::MaxPool1dParameter& LayerParameter::_internal_maxpool1d() const {
  return _internal_has_maxpool1d()
      ? *_impl_.oneof_layers_.maxpool1d_
...
inline void LayerParameter::unsafe_arena_set_allocated_maxpool1d(::apollo::prediction::MaxPool1dParameter* maxpool1d) {
  ...
  if (maxpool1d) {
    set_has_maxpool1d();
    _impl_.oneof_layers_.maxpool1d_ = maxpool1d;
  }
...
inline ::apollo::prediction::MaxPool1dParameter* LayerParameter::_internal_mutable_maxpool1d() {
  if (!_internal_has_maxpool1d()) {
    clear_oneof_layers();
    set_has_maxpool1d();
    _impl_.oneof_layers_.maxpool1d_ = CreateMaybeMessage< ::apollo::prediction::MaxPool1dParameter >(GetArenaForAllocation());
  }
  return _impl_.oneof_layers_.maxpool1d_;
}
inline ::apollo::prediction::MaxPool1dParameter* LayerParameter::mutable_maxpool1d() {
  ::apollo::prediction::MaxPool1dParameter* _msg = _internal_mutable_maxpool1d();
...
inline void LayerParameter::set_has_avgpool1d() {
  _impl_._oneof_case_[0] = kAvgpool1D;
}
inline void LayerParameter::clear_avgpool1d() {
  if (_internal_has_avgpool1d()) {
    if (GetArenaForAllocation() == nullptr) {
      delete _impl_.oneof_layers_.avgpool1d_;
    }
    clear_has_oneof_layers();
  }
}
inline ::apollo::prediction::AvgPool1dParameter* LayerParameter::release_avgpool1d() {
  ...
  if (_internal_has_avgpool1d()) {
    clear_has_oneof_layers();
    ::apollo::prediction::AvgPool1dParameter* temp = _impl_.oneof_layers_.avgpool1d_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.oneof_layers_.avgpool1d_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline const ::apollo::prediction::AvgPool1dParameter& LayerParameter::_internal_avgpool1d() const {
  return _internal_has_avgpool1d()
      ? *_impl_.oneof_layers_.avgpool1d_
...
inline void LayerParameter::unsafe_arena_set_allocated_avgpool1d(::apollo::prediction::AvgPool1dParameter* avgpool1d) {
  ...
  if (avgpool1d) {
    set_has_avgpool1d();
    _impl_.oneof_layers_.avgpool1d_ = avgpool1d;
  }
...
inline ::apollo::prediction::AvgPool1dParameter* LayerParameter::_internal_mutable_avgpool1d() {
  if (!_internal_has_avgpool1d()) {
    clear_oneof_layers();
    set_has_avgpool1d();
    _impl_.oneof_layers_.avgpool1d_ = CreateMaybeMessage< ::apollo::prediction::AvgPool1dParameter >(GetArenaForAllocation());
  }
  return _impl_.oneof_layers_.avgpool1d_;
}
inline ::apollo::prediction::AvgPool1dParameter* LayerParameter::mutable_avgpool1d() {
  ::apollo::prediction::AvgPool1dParameter* _msg = _internal_mutable_avgpool1d();
...
inline LayerParameter::OneofLayersCase LayerParameter::oneof_layers_case() const {
  return LayerParameter::OneofLayersCase(_impl_._oneof_case_[0]);
}
#ifdef __GNUC__
