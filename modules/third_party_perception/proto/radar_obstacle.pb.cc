...
const char descriptor_table_protodef_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "roto\032#modules/common/proto/geometry.prot"
  "o\"\357\002\n\rRadarObstacle\022\n\n\002id\030\001 \001(\005\0221\n\021relat"
  "ive_position\030\002 \001(\0132\026.apollo.common.Point"
  "3D\0221\n\021relative_velocity\030\003 \001(\0132\026.apollo.c"
  "ommon.Point3D\022\013\n\003rcs\030\004 \001(\001\022\017\n\007movable\030\005 "
  "\001(\010\022\r\n\005width\030\006 \001(\001\022\016\n\006length\030\007 \001(\001\022\016\n\006he"
  "ight\030\010 \001(\001\022\r\n\005theta\030\t \001(\001\0221\n\021absolute_po"
  "sition\030\n \001(\0132\026.apollo.common.Point3D\0221\n\021"
  "absolute_velocity\030\013 \001(\0132\026.apollo.common."
  "Point3D\022\r\n\005count\030\014 \001(\005\022\033\n\023moving_frames_"
  "count\030\r \001(\005\"\247\002\n\016RadarObstacles\022X\n\016radar_"
  "obstacle\030\001 \003(\0132@.apollo.third_party_perc"
  "eption.RadarObstacles.RadarObstacleEntry"
  "\022%\n\006header\030\002 \001(\0132\025.apollo.common.Header\022"
  "0\n\nerror_code\030\003 \001(\0162\030.apollo.common.Erro"
  "rCode:\002OK\032b\n\022RadarObstacleEntry\022\013\n\003key\030\001"
  " \001(\005\022;\n\005value\030\002 \001(\0132,.apollo.third_party"
  "_perception.RadarObstacle:\0028\001"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto = {
    false, false, 869, descriptor_table_protodef_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto,
...
class RadarObstacle::_Internal {
 public:
  ...
  static const ::apollo::common::Point3D& relative_position(const RadarObstacle* msg);
  static void set_has_relative_position(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  static const ::apollo::common::Point3D& relative_velocity(const RadarObstacle* msg);
  ...
  static const ::apollo::common::Point3D& absolute_position(const RadarObstacle* msg);
  static void set_has_absolute_position(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
  static const ::apollo::common::Point3D& absolute_velocity(const RadarObstacle* msg);
...
RadarObstacle::RadarObstacle(const RadarObstacle& from)
  ...
  if (from._internal_has_relative_position()) {
    _impl_.relative_position_ = new ::apollo::common::Point3D(*from._impl_.relative_position_);
  }
  if (from._internal_has_relative_velocity()) {
    _impl_.relative_velocity_ = new ::apollo::common::Point3D(*from._impl_.relative_velocity_);
  }
  if (from._internal_has_absolute_position()) {
    _impl_.absolute_position_ = new ::apollo::common::Point3D(*from._impl_.absolute_position_);
  }
  if (from._internal_has_absolute_velocity()) {
    _impl_.absolute_velocity_ = new ::apollo::common::Point3D(*from._impl_.absolute_velocity_);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.third_party_perception.RadarObstacle)
  ...
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      _internal_mutable_relative_position()->::apollo::common::Point3D::MergeFrom(from._internal_relative_position());
    }
    if (cached_has_bits & 0x00000002u) {
      _internal_mutable_relative_velocity()->::apollo::common::Point3D::MergeFrom(from._internal_relative_velocity());
    }
    if (cached_has_bits & 0x00000004u) {
      _internal_mutable_absolute_position()->::apollo::common::Point3D::MergeFrom(from._internal_absolute_position());
    }
    if (cached_has_bits & 0x00000008u) {
      _internal_mutable_absolute_velocity()->::apollo::common::Point3D::MergeFrom(from._internal_absolute_velocity());
    }
    if (cached_has_bits & 0x00000010u) {
