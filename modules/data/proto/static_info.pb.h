...
constexpr VehicleInfo_Brand VehicleInfo_Brand_Brand_MAX = VehicleInfo_Brand_LEXUS;
...
class VehicleInfo final :
 ...
 public:
  ...
  static constexpr Brand LEXUS =
    VehicleInfo_Brand_LEXUS;
  ...
  static constexpr Model RX450H =
    VehicleInfo_Model_RX450H;
...
class EnvironmentInfo final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  PROTOBUF_DEPRECATED void set_map_name(ArgT0&& arg0, ArgT... args);
  PROTOBUF_DEPRECATED std::string* mutable_map_name();
  PROTOBUF_NODISCARD PROTOBUF_DEPRECATED std::string* release_map_name();
...
class SoftwareInfo final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  PROTOBUF_DEPRECATED void set_docker_image(ArgT0&& arg0, ArgT... args);
  PROTOBUF_DEPRECATED std::string* mutable_docker_image();
  PROTOBUF_NODISCARD PROTOBUF_DEPRECATED std::string* release_docker_image();
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  PROTOBUF_DEPRECATED void set_mode(ArgT0&& arg0, ArgT... args);
  PROTOBUF_DEPRECATED std::string* mutable_mode();
  PROTOBUF_NODISCARD PROTOBUF_DEPRECATED std::string* release_mode();
