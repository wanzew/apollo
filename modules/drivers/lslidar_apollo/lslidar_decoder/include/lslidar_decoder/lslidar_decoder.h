...
static const int FIRINGS_PER_PACKET = FIRINGS_PER_BLOCK * BLOCKS_PER_PACKET;
...
static const double COS_SCAN_ALTITUDE[16] = {
    std::cos(SCAN_ALTITUDE[0]),  std::cos(SCAN_ALTITUDE[1]),  std::cos(SCAN_ALTITUDE[2]),
    std::cos(SCAN_ALTITUDE[3]),  std::cos(SCAN_ALTITUDE[4]),  std::cos(SCAN_ALTITUDE[5]),
    std::cos(SCAN_ALTITUDE[6]),  std::cos(SCAN_ALTITUDE[7]),  std::cos(SCAN_ALTITUDE[8]),
    std::cos(SCAN_ALTITUDE[9]),  std::cos(SCAN_ALTITUDE[10]), std::cos(SCAN_ALTITUDE[11]),
    std::cos(SCAN_ALTITUDE[12]), std::cos(SCAN_ALTITUDE[13]), std::cos(SCAN_ALTITUDE[14]),
    std::cos(SCAN_ALTITUDE[15]),
};

static const double SIN_SCAN_ALTITUDE[16] = {
    std::sin(SCAN_ALTITUDE[0]),  std::sin(SCAN_ALTITUDE[1]),  std::sin(SCAN_ALTITUDE[2]),
    std::sin(SCAN_ALTITUDE[3]),  std::sin(SCAN_ALTITUDE[4]),  std::sin(SCAN_ALTITUDE[5]),
    std::sin(SCAN_ALTITUDE[6]),  std::sin(SCAN_ALTITUDE[7]),  std::sin(SCAN_ALTITUDE[8]),
    std::sin(SCAN_ALTITUDE[9]),  std::sin(SCAN_ALTITUDE[10]), std::sin(SCAN_ALTITUDE[11]),
    std::sin(SCAN_ALTITUDE[12]), std::sin(SCAN_ALTITUDE[13]), std::sin(SCAN_ALTITUDE[14]),
    std::sin(SCAN_ALTITUDE[15]),
};
