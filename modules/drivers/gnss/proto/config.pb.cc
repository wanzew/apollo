...
PROTOBUF_CONSTEXPR Config::Config(
  ...
  , /*decltype(_impl_.gpsbin_folder_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
static ::_pb::Metadata file_level_metadata_modules_2fdrivers_2fgnss_2fproto_2fconfig_2eproto[9];
...
const uint32_t TableStruct_modules_2fdrivers_2fgnss_2fproto_2fconfig_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::drivers::gnss::config::TF, _impl_.enable_),
  0,
  1,
  2,
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::drivers::gnss::config::Config, _impl_.gpsbin_folder_),
...
const ::_pbi::DescriptorTable descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fconfig_2eproto = {
    false, false, 1849, descriptor_table_protodef_modules_2fdrivers_2fgnss_2fproto_2fconfig_2eproto,
...
Config::Config(const Config& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.gpsbin_folder_){}
    , decltype(_impl_.data_){nullptr}
    , decltype(_impl_.command_){nullptr}
    , decltype(_impl_.rtk_from_){nullptr}
    , decltype(_impl_.rtk_to_){nullptr}
  ...
  _impl_.gpsbin_folder_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.gpsbin_folder_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_gpsbin_folder()) {
    _impl_.gpsbin_folder_.Set(from._internal_gpsbin_folder(), 
      GetArenaForAllocation());
  }
...
// @@protoc_insertion_point(message_clear_start:apollo.drivers.gnss.config.Config)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _impl_.gpsbin_folder_.ClearNonDefaultToEmpty();
    }
    if (cached_has_bits & 0x00000008u) {
    ...
    switch (tag >> 3) {
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 114)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "apollo.drivers.gnss.config.Config.gpsbin_folder");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.drivers.gnss.config.Config)
  ...
  if (cached_has_bits & 0x00000300u) {
    ...
    if (cached_has_bits & 0x00000200u) {
      _impl_.imu_type_ = from._impl_.imu_type_;
    }
    _impl_._has_bits_[0] |= cached_has_bits;
  }
  switch (from.device_config_case()) {
...
void Config::InternalSwap(Config* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.gpsbin_folder_, lhs_arena,
      &other->_impl_.gpsbin_folder_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
