...
template<> ::apollo::drivers::gnss::config::NewtonM2Config* Arena::CreateMaybeMessage<::apollo::drivers::gnss::config::NewtonM2Config>(Arena*);
...
constexpr Stream_Format Stream_Format_Format_MAX = Stream_Format_NEWTONM2_BINARY;
...
constexpr ImuType ImuType_MAX = UM442;
...
class Stream final :
 ...
 public:
  ...
  static constexpr Format NEWTONM2_TEXT =
    Stream_Format_NEWTONM2_TEXT;
  static constexpr Format NEWTONM2_BINARY =
...
class NewtonM2Config final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:apollo.drivers.gnss.config.NewtonM2Config) */ {
 public:
  inline NewtonM2Config() : NewtonM2Config(nullptr) {}
  ~NewtonM2Config() override;
  explicit PROTOBUF_CONSTEXPR NewtonM2Config(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  NewtonM2Config(const NewtonM2Config& from);
  NewtonM2Config(NewtonM2Config&& from) noexcept
    : NewtonM2Config() {
    *this = ::std::move(from);
  }
  ...
  inline NewtonM2Config& operator=(NewtonM2Config&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  friend void swap(NewtonM2Config& a, NewtonM2Config& b) {
    a.Swap(&b);
  }
  inline void Swap(NewtonM2Config* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(NewtonM2Config* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  NewtonM2Config* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<NewtonM2Config>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "apollo.drivers.gnss.config.NewtonM2Config";
  }
  protected:
  explicit NewtonM2Config(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class Config final :
 ...
 public:
  ...
  private:
  bool _internal_has_newtonm2_config() const;
  public:
  void clear_newtonm2_config();
  const ::apollo::drivers::gnss::config::NewtonM2Config& newtonm2_config() const;
  PROTOBUF_NODISCARD ::apollo::drivers::gnss::config::NewtonM2Config* release_newtonm2_config();
  ::apollo::drivers::gnss::config::NewtonM2Config* mutable_newtonm2_config();
  void set_allocated_newtonm2_config(::apollo::drivers::gnss::config::NewtonM2Config* newtonm2_config);
  private:
  const ::apollo::drivers::gnss::config::NewtonM2Config& _internal_newtonm2_config() const;
  ::apollo::drivers::gnss::config::NewtonM2Config* _internal_mutable_newtonm2_config();
  public:
  void unsafe_arena_set_allocated_newtonm2_config(
      ::apollo::drivers::gnss::config::NewtonM2Config* newtonm2_config);
  ::apollo::drivers::gnss::config::NewtonM2Config* unsafe_arena_release_newtonm2_config();
 ...
 private:
  ...
  struct Impl_ {
    ...
    union DeviceConfigUnion {
      ...
      ::apollo::drivers::gnss::config::NewtonM2Config* newtonm2_config_;
    } device_config_;
    uint32_t _oneof_case_[1];
...
// optional int32 imu_orientation = 1 [default = 5];
inline bool NewtonM2Config::_internal_has_imu_orientation() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
...
inline int32_t NewtonM2Config::_internal_imu_orientation() const {
  return _impl_.imu_orientation_;
}
inline int32_t NewtonM2Config::imu_orientation() const {
  // @@protoc_insertion_point(field_get:apollo.drivers.gnss.config.NewtonM2Config.imu_orientation)
  return _internal_imu_orientation();
}
inline void NewtonM2Config::_internal_set_imu_orientation(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.imu_orientation_ = value;
}
inline void NewtonM2Config::set_imu_orientation(int32_t value) {
  _internal_set_imu_orientation(value);
  // @@protoc_insertion_point(field_set:apollo.drivers.gnss.config.NewtonM2Config.imu_orientation)
}
...
// .apollo.drivers.gnss.config.NewtonM2Config newtonm2_config = 15;
inline bool Config::_internal_has_newtonm2_config() const {
  return device_config_case() == kNewtonm2Config;
}
inline bool Config::has_newtonm2_config() const {
  return _internal_has_newtonm2_config();
}
inline void Config::set_has_newtonm2_config() {
  _impl_._oneof_case_[0] = kNewtonm2Config;
}
...
inline ::apollo::drivers::gnss::config::NewtonM2Config* Config::release_newtonm2_config() {
  // @@protoc_insertion_point(field_release:apollo.drivers.gnss.config.Config.newtonm2_config)
  if (_internal_has_newtonm2_config()) {
    clear_has_device_config();
    ::apollo::drivers::gnss::config::NewtonM2Config* temp = _impl_.device_config_.newtonm2_config_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.device_config_.newtonm2_config_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::apollo::drivers::gnss::config::NewtonM2Config& Config::_internal_newtonm2_config() const {
  return _internal_has_newtonm2_config()
      ? *_impl_.device_config_.newtonm2_config_
      : reinterpret_cast< ::apollo::drivers::gnss::config::NewtonM2Config&>(::apollo::drivers::gnss::config::_NewtonM2Config_default_instance_);
}
inline const ::apollo::drivers::gnss::config::NewtonM2Config& Config::newtonm2_config() const {
  // @@protoc_insertion_point(field_get:apollo.drivers.gnss.config.Config.newtonm2_config)
  return _internal_newtonm2_config();
}
inline ::apollo::drivers::gnss::config::NewtonM2Config* Config::unsafe_arena_release_newtonm2_config() {
  // @@protoc_insertion_point(field_unsafe_arena_release:apollo.drivers.gnss.config.Config.newtonm2_config)
  if (_internal_has_newtonm2_config()) {
    clear_has_device_config();
    ::apollo::drivers::gnss::config::NewtonM2Config* temp = _impl_.device_config_.newtonm2_config_;
    _impl_.device_config_.newtonm2_config_ = nullptr;
...
inline void Config::unsafe_arena_set_allocated_newtonm2_config(::apollo::drivers::gnss::config::NewtonM2Config* newtonm2_config) {
  clear_device_config();
  if (newtonm2_config) {
    set_has_newtonm2_config();
    _impl_.device_config_.newtonm2_config_ = newtonm2_config;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.drivers.gnss.config.Config.newtonm2_config)
}
inline ::apollo::drivers::gnss::config::NewtonM2Config* Config::_internal_mutable_newtonm2_config() {
  if (!_internal_has_newtonm2_config()) {
    clear_device_config();
    set_has_newtonm2_config();
    _impl_.device_config_.newtonm2_config_ = CreateMaybeMessage< ::apollo::drivers::gnss::config::NewtonM2Config >(GetArenaForAllocation());
  }
  return _impl_.device_config_.newtonm2_config_;
}
inline ::apollo::drivers::gnss::config::NewtonM2Config* Config::mutable_newtonm2_config() {
  ::apollo::drivers::gnss::config::NewtonM2Config* _msg = _internal_mutable_newtonm2_config();
  // @@protoc_insertion_point(field_mutable:apollo.drivers.gnss.config.Config.newtonm2_config)
  return _msg;
}
