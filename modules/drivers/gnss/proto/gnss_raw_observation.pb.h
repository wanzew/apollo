...
inline uint32_t GlonassOrbit::_internal_sat_prn() const {
  return _impl_.sat_prn_;
}
inline uint32_t GlonassOrbit::sat_prn() const {
  // @@protoc_insertion_point(field_get:apollo.drivers.gnss.GlonassOrbit.sat_prn)
  return _internal_sat_prn();
}
inline void GlonassOrbit::_internal_set_sat_prn(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00100000u;
  _impl_.sat_prn_ = value;
}
inline void GlonassOrbit::set_sat_prn(uint32_t value) {
  _internal_set_sat_prn(value);
