...
class InsStat final :
 ...
 public:
  ...
  ~InsStat() override;
  explicit PROTOBUF_CONSTEXPR InsStat(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  InsStat* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void set_pos_type(uint32_t value);
  private:
  uint32_t _internal_pos_type() const;
  void _internal_set_pos_type(uint32_t value);
  public:
...
class Ins final :
 ...
 public:
  ...
  ~Ins() override;
  explicit PROTOBUF_CONSTEXPR Ins(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  Ins* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline void InsStat::clear_ins_status() {
  _impl_.ins_status_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t InsStat::_internal_ins_status() const {
  return _impl_.ins_status_;
}
inline uint32_t InsStat::ins_status() const {
  // @@protoc_insertion_point(field_get:apollo.drivers.gnss.InsStat.ins_status)
  return _internal_ins_status();
}
inline void InsStat::_internal_set_ins_status(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.ins_status_ = value;
}
inline void InsStat::set_ins_status(uint32_t value) {
...
inline uint32_t InsStat::_internal_pos_type() const {
  return _impl_.pos_type_;
}
inline uint32_t InsStat::pos_type() const {
  // @@protoc_insertion_point(field_get:apollo.drivers.gnss.InsStat.pos_type)
  return _internal_pos_type();
}
inline void InsStat::_internal_set_pos_type(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.pos_type_ = value;
}
inline void InsStat::set_pos_type(uint32_t value) {
...
inline ::apollo::drivers::gnss::Ins_Type Ins::_internal_type() const {
  return static_cast< ::apollo::drivers::gnss::Ins_Type >(_impl_.type_);
}
...
inline int Ins::_internal_euler_angles_covariance_size() const {
  return _impl_.euler_angles_covariance_.size();
}
...
inline float Ins::_internal_euler_angles_covariance(int index) const {
  return _impl_.euler_angles_covariance_.Get(index);
}
...
inline void Ins::set_euler_angles_covariance(int index, float value) {
  _impl_.euler_angles_covariance_.Set(index, value);
...
inline void Ins::_internal_add_euler_angles_covariance(float value) {
  _impl_.euler_angles_covariance_.Add(value);
}
...
Ins::_internal_euler_angles_covariance() const {
  return _impl_.euler_angles_covariance_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< float >&
...
inline int Ins::_internal_linear_velocity_covariance_size() const {
  return _impl_.linear_velocity_covariance_.size();
}
...
inline float Ins::_internal_linear_velocity_covariance(int index) const {
  return _impl_.linear_velocity_covariance_.Get(index);
}
...
inline void Ins::set_linear_velocity_covariance(int index, float value) {
  _impl_.linear_velocity_covariance_.Set(index, value);
...
inline void Ins::_internal_add_linear_velocity_covariance(float value) {
  _impl_.linear_velocity_covariance_.Add(value);
}
...
Ins::_internal_linear_velocity_covariance() const {
  return _impl_.linear_velocity_covariance_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< float >&
