...
static const float SEQ_TDURATION =
...
static const float HDL32_CHANNEL_TDURATION =
    1.152f;  // [µs] From Application Note: HDL-32E Packet Structure and Timing Defition
static const float HDL32_SEQ_TDURATION =
    46.080f;  // [µs] Sequence is a set of laser firings including recharging
...
POINT_CLOUD_REGISTER_POINT_STRUCT(velodyne_rawdata::PointXYZIRB,
                                  (float, x, x)(float, y, y)(float, z, z)(
                                      float, intensity, intensity)(uint16_t, ring, ring)(uint16_t,
                                                                                         block,
                                                                                         block))
