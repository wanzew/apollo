...
std::string UltrasonicRadarCanbus::Name() const { return FLAGS_canbus_driver_name; }

apollo::common::Status UltrasonicRadarCanbus::Init() {
  AdapterManager::Init(FLAGS_adapter_config_filename);
  AINFO << "The adapter manager is successfully initialized.";
  if (!::apollo::common::util::GetProtoFromFile(FLAGS_sensor_conf_file, &ultrasonic_radar_conf_)) {
