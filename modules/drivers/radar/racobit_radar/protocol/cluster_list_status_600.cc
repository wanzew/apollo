...
void ClusterListStatus600::Parse(const std::uint8_t* bytes,
                                 int32_t             length,
...
int ClusterListStatus600::near(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes);
...
int ClusterListStatus600::meas_counter(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 2);
  int32_t x = t0.get_byte(0, 8);
...
int ClusterListStatus600::interface_version(const std::uint8_t* bytes, int32_t length) const {
  Byte    t0(bytes + 4);
