...
#ifndef MODULES_DRIVERS_RADAR_RACOBIT_RADAR_PROTOCOL_OBJECT_GENERAL_INFO_60B_H_
#define MODULES_DRIVERS_RADAR_RACOBIT_RADAR_PROTOCOL_OBJECT_GENERAL_INFO_60B_H_
...
class ObjectGeneralInfo60B : public apollo::drivers::canbus::ProtocolData<RacobitRadar> {
 public:
