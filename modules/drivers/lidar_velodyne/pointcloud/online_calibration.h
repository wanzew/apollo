...
#ifndef MODULES_DRIVERS_LIDAR_VELODYNE_POINTCLOUD_ONLINE_CALIBRATION_H_
#define MODULES_DRIVERS_LIDAR_VELODYNE_POINTCLOUD_ONLINE_CALIBRATION_H_
...
class OnlineCalibration {
 ...
 private:
  inline int16_t ToInt16(uint8_t* value) { return *(reinterpret_cast<int16_t*>(value)); }
...
#endif  // MODULES_DRIVERS_LIDAR_VELODYNE_POINTCLOUD_ONLINE_CALIBRATION_H_
