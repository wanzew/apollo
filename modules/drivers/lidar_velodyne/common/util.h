...
#ifndef MODULES_DRIVERS_LIDAR_VELODYNE_COMMON_UTIL_H_
#define MODULES_DRIVERS_LIDAR_VELODYNE_COMMON_UTIL_H_
...
#endif  // MODULES_DRIVERS_LIDAR_VELODYNE_COMMON_UTIL_H_
