...
void Image::set_frame_id(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
inline std::string* Image::release_encoding() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* p = _impl_.encoding_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline uint32_t CompressedImage::_internal_frame_type() const {
  return _impl_.frame_type_;
}
inline uint32_t CompressedImage::frame_type() const {
  // @@protoc_insertion_point(field_get:apollo.drivers.CompressedImage.frame_type)
  return _internal_frame_type();
}
inline void CompressedImage::_internal_set_frame_type(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000020u;
  _impl_.frame_type_ = value;
}
inline void CompressedImage::set_frame_type(uint32_t value) {
