...
class VelodyneParser {
 public:
   ...
   */
  virtual void generate_pointcloud(velodyne_msgs::VelodyneScanUnified::ConstPtr scan_msg,
 ...
 protected:
   ...
   *
   */
  virtual void unpack(const velodyne_msgs::VelodynePacket& pkt, VPointCloud& pc) = 0;
...
class Velodyne64Parser : public VelodyneParser {
 public:
  ...
  void generate_pointcloud(velodyne_msgs::VelodyneScanUnified::ConstPtr scan_msg,
