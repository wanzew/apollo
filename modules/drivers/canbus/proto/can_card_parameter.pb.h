...
class CANCardParameter final :
 ...
 public:
  ...
  void set_num_ports(uint32_t value);
  private:
  uint32_t _internal_num_ports() const;
  void _internal_set_num_ports(uint32_t value);
  public:
...
inline ::apollo::drivers::canbus::CANCardParameter_CANInterface CANCardParameter::_internal_interface() const {
  return static_cast< ::apollo::drivers::canbus::CANCardParameter_CANInterface >(_impl_.interface_);
}
...
inline uint32_t CANCardParameter::_internal_num_ports() const {
  return _impl_.num_ports_;
}
inline uint32_t CANCardParameter::num_ports() const {
  // @@protoc_insertion_point(field_get:apollo.drivers.canbus.CANCardParameter.num_ports)
  return _internal_num_ports();
}
inline void CANCardParameter::_internal_set_num_ports(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.num_ports_ = value;
}
inline void CANCardParameter::set_num_ports(uint32_t value) {
