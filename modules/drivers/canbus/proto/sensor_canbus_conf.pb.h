...
class SensorCanbusConf final :
 ...
 public:
  ...
  ~SensorCanbusConf() override;
  explicit PROTOBUF_CONSTEXPR SensorCanbusConf(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  SensorCanbusConf* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
