...
class AudioDetection final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR AudioDetection(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  AudioDetection* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
