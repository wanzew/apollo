...
class SMARTPAINTER_SHARED_EXPORT ObstaclePainter {
 public:
  ...
  static bool paintObstacle(void*          _obstacleParam,
 ...
 protected:
  static void paintRectBorder(unsigned char*   _imageData,
                              OutputObstacles& _rectBorder,
                              int              _width,
                              int              _height,
                              bool             isWarn);
  static void drawObsFrame(unsigned char*   _imageData,
                           OutputObstacles& _rectBorder,
                           int              _width,
                           int              _height,
                           int              _offsetX,
  ...
  static void drawObsInfo(unsigned char*      _imageData,
                          OutputObstacles&    _rectBorder,
                          int                 _width,
                          int                 _height,
