...
enum ProtocolUnitFormat { FixedProtocolUnitFormat, LongProtocolUnitFormat };

// only apply for Fixed format;
enum ProtocolUnitType { HeartBeatReq, HeartBeatResp, HeartBeatCon };
...
inline int maxDataUnitSize() { return SATP_MAX_PROTOCOL_UNIT_LEN - sizeof(ProtocolUnitHead); }
