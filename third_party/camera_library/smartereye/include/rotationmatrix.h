...
struct RotationMatrix {
  ...
  //[tempZ]     [ m[6],     m[7],       m[8] ]      [   1  ]
  // in: (assume: one of real3DX, real3DY, real3DZ is available -> get k -> get
  // all of real3DX, real3DY, real3DZ） real3DX / tempX = real3DY / tempY =
  // real3DZ / tempZ = k; final: (assume: real3DX', real3DY', real3DZ' are 3D
  // information with car center bias as origin, Translation Matrix is bias
  // matrix)
  //[real3DX']      [real3DX]
