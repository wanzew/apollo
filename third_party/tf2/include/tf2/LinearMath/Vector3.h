...
#  endif
 ...
 public:
  ...
  // (&m_floats[0])[i];	} TF2SIMD_FORCE_INLINE const tf2Scalar& operator[](int
  // i) const { return (&m_floats[0])[i]; }
...
class tf2Vector4 : public Vector3 {
 public:
  ...
  TF2SIMD_FORCE_INLINE tf2Vector4 absolute4() const {
    return tf2Vector4(tf2Fabs(m_floats[0]), tf2Fabs(m_floats[1]), tf2Fabs(m_floats[2]),
                      tf2Fabs(m_floats[3]));
  }
  ...
  TF2SIMD_FORCE_INLINE int maxAxis4() const {
    ...
    if (m_floats[3] > maxVal) { maxIndex = 3; }
  ...
  TF2SIMD_FORCE_INLINE int minAxis4() const {
    ...
    if (m_floats[3] < minVal) { minIndex = 3; }
  ...
  */
  ...
  setValue(const tf2Scalar& x, const tf2Scalar& y, const tf2Scalar& z, const tf2Scalar& w) {
    m_floats[0] = x;
    m_floats[1] = y;
    m_floats[2] = z;
    m_floats[3] = w;
